...
*/
for (var e = "2.79.1", t = {}, i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", s = 0; s < i.length; s++) t[i.charCodeAt(s)] = s;
...
class h {
  constructor(e) {
    this.version = 3, this.file = e.file, this.sources = e.sources, this.sourcesContent = e.sourcesContent, this.names = e.names, this.mappings = function(e) {
      for (var t = 0, i = 0, s = 0, n = 0, a = "", o = 0; o < e.length; o++) {
        var l = e[o];
        if (o > 0 && (a += ";"), 0 !== l.length) {
          for (var h = 0, c = [], u = 0, d = l; u < d.length; u++) {
            var p = d[u],
              f = r(p[0] - h);
            h = p[0], p.length > 1 && (f += r(p[1] - t) + r(p[2] - i) + r(p[3] - s), t = p[1], i = p[2], s = p[3]), 5 === p.length && (f += r(p[4] - n), n = p[4]), c.push(f)
          }
          a += c.join(",")
        }
      }
...
class x {
  ...
  overwrite(e, t, i, s) {
    ...
    this._split(e), this._split(t), !0 === s && (y.storeName || (console.warn("The final argument to magicString.overwrite(...) should be an options object. See https://github.com/rich-harris/magic-string"), y.storeName = !0), s = {
      storeName: !0
    });
    ...
    if (a) {
      ...
      const s = new o(e, t, "").edit(i, n);
      l.next = s, s.previous = l
    }
    return this
  }
  prepend(e) {
  ...
  lastLine() {
    ...
    do {
      if (i.outro.length > 0) {
        if (e = i.outro.lastIndexOf(g), -1 !== e) return i.outro.substr(e + 1) + t;
        t = i.outro + t
      }
      if (i.content.length > 0) {
        if (e = i.content.lastIndexOf(g), -1 !== e) return i.content.substr(e + 1) + t;
        t = i.content + t
      }
      if (i.intro.length > 0) {
        if (e = i.intro.lastIndexOf(g), -1 !== e) return i.intro.substr(e + 1) + t;
        t = i.intro + t
      }
    } while (i = i.previous);
  ...
  replace(e, t) {
    function i(e, i) {
      return "string" == typeof t ? t.replace(/\$(\$|&|\d+)/g, ((t, i) => {
        if ("$" === i) return "$";
        if ("&" === i) return e[0];
...
class b {
  ...
  addSource(e) {
    if (e instanceof x) return this.addSource({
      content: e,
      filename: e.filename,
  ...
  generateDecodedMap(e = {}) {
    ...
    return this.intro && i.advance(this.intro), this.sources.forEach(((e, s) => {
      ...
      file: e.file ? e.file.split(/[/\\]/).pop() : null,
      sources: this.uniqueSources.map((t => e.file ? u(e.file, t.filename) : t.filename)),
...
function T(e, t) {
  const i = e.split(I).filter(Boolean),
...
const ie = Object.freeze(Object.create(null)),
  se = Object.freeze({}),
  ne = Object.freeze([]);
...
function de(e, t, i, s) {
  ...
  if (i && n.endsWith(".js") && (n = n.slice(0, -3)), s) {
    if ("" === n) return "../" + _(t);
    if (ue.test(n)) return n.split("/").concat(["..", _(t)]).join("/")
  }
...
function be(e) {
  ...
  return {
    code: me.MISSING_IMPLICIT_DEPENDANT,
    message: `Module "${he(e.id)}" that should be implicitly loaded before ${oe(t)} is not included in the module graph. Either it was not imported by an included module or only via a tree-shaken dynamic import, or no imported bindings were used and it had otherwise no side-effects.`
  }
}
...
function ve(e, t, i) {
  ...
  return {
    code: me.UNEXPECTED_NAMED_IMPORT,
    id: e,
...
var we = new Set(["await", "break", "case", "catch", "class", "const", "continue", "debugger", "default", "delete", "do", "else", "enum", "eval", "export", "extends", "false", "finally", "for", "function", "if", "implements", "import", "in", "instanceof", "interface", "let", "NaN", "new", "null", "package", "private", "protected", "public", "return", "static", "super", "switch", "this", "throw", "true", "try", "typeof", "undefined", "var", "void", "while", "with", "yield"]);
const Ce = /[^$_a-zA-Z0-9]/g,
  _e = e => (e => /\d/.test(e[0]))(e) || we.has(e) || "arguments" === e;

function Ne(e) {
  return e = e.replace(/-(\w)/g, ((e, t) => t.toUpperCase())).replace(Ce, "_"), _e(e) && (e = `_${e}`), e || "_"
}
class $e {
  constructor(e, t, i, s, n) {
    this.options = e, this.id = t, this.renormalizeRenderPath = n, this.declarations = new Map, this.defaultVariableName = "", this.dynamicImporters = [], this.execIndex = 1 / 0, this.exportedVariables = new Map, this.importers = [], this.mostCommonSuggestion = 0, this.nameSuggestions = new Map, this.namespaceVariableName = "", this.reexported = !1, this.renderPath = void 0, this.used = !1, this.variableName = "", this.suggestedVariableName = Ne(t.split(/[\\/]/).pop());
    const {
      importers: r,
      dynamicImporters: a
    } = this, o = this.info = {
      ast: null,
      code: null,
      dynamicallyImportedIdResolutions: ne,
      dynamicallyImportedIds: ne,
      get dynamicImporters() {
        return a.sort()
      },
      hasDefaultExport: null,
      get hasModuleSideEffects() {
        return Pe("Accessing ModuleInfo.hasModuleSideEffects from plugins is deprecated. Please use ModuleInfo.moduleSideEffects instead.", !1, e), o.moduleSideEffects
      },
      id: t,
      implicitlyLoadedAfterOneOf: ne,
      implicitlyLoadedBefore: ne,
      importedIdResolutions: ne,
      importedIds: ne,
      get importers() {
        return r.sort()
      },
  ...
  warnUnusedImports() {
    ...
    this.options.onwarn({
      ...
      message: `${oe(e,["is","are"])} imported from external module "${this.id}" but never used in ${oe(i.map((e=>he(e))))}.`,
      names: e,
      source: this.id,
      sources: i
    })
...
const Te = {
    ...
    MemberExpression() {},
    ObjectPattern(e, t) {
      for (const i of t.properties) "RestElement" === i.type ? Te.RestElement(e, i) : Te[i.value.type](e, i.value)
    },
    RestElement(e, t) {
...
const Le = new class extends K {
  ...
  He = {
    value: {
      hasEffectsWhenCalled({
        ...
        const i = e[1];
        return e.length < 2 || "symbol" == typeof i.getLiteralValueAtPath(V, G, {
          deoptimizeCache() {}
  ...
  Xe = De({
    ...
    substring: Ge,
    sup: Ge,
    toLocaleLowerCase: Ge,
    toLocaleUpperCase: Ge,
    toLowerCase: Ge,
    toString: Ge,
    toUpperCase: Ge,
    trim: Ge,
...
et.Program = et.BlockStatement = et.StaticBlock = function(e, t, i) {
  ...
  for (var s = 0, n = e.declarations; s < n.length; s += 1) {
    i(n[s], t)
  }
  ...
  for (var s = 0, n = e.params; s < n.length; s += 1) {
    i(n[s], t, "Pattern")
  }
  ...
  for (var s = 0, n = e.quasis; s < n.length; s += 1) {
    i(n[s], t)
  }
...
function st(e, t, i = e.type) {
  ...
  for (; n && e.start >= n.end;) at(e, n, t.code), n = s[++t.annotationIndex];
  if (n && n.end <= e.end)
    for (et[i](e, t, st);
      (n = s[t.annotationIndex]) && n.end <= e.end;) ++t.annotationIndex, ht(e, n, !1)
}
const nt = /[^\s(]/g,
  rt = /\S/g;
...
class ut extends K {
  constructor(e, t, i) {
    super(), this.deoptimized = !1, this.esTreeNode = e, this.keys = ct[e.type] || function(e) {
      return ct[e.type] = Object.keys(e).filter((t => "object" == typeof e[t] && 95 !== t.charCodeAt(0))), ct[e.type]
  ...
  applyDeoptimizations() {
    ...
    for (const e of this.keys) {
      ...
      if (null !== t)
        if (Array.isArray(t))
          for (const e of t) null == e || e.deoptimizePath(B);
        else t.deoptimizePath(B)
    }
...
class pt extends K {
  ...
  hasEffectsOnInteractionAtPath(e, t, i) {
    ...
    if (2 === r) {
      if (!0 === this.description.mutatesSelfAsArray && (null === (s = t.thisArg) || void 0 === s ? void 0 : s.hasEffectsOnInteractionAtPath(z, Q, i))) return !0;
      if (this.description.callsArgs)
        for (const e of this.description.callsArgs)
          if (null === (n = t.args[e]) || void 0 === n ? void 0 : n.hasEffectsOnInteractionAtPath(V, Z, i)) return !0
    }
    return !1
  }
}
...
class Et extends K {
  ...
  deoptimizeAllProperties(e) {
    ...
    if (e ? this.hasUnknownDeoptimizedProperty = !0 : this.hasLostTrack = !0, !i) {
      for (const e of Object.values(this.propertiesAndGettersByKey).concat(Object.values(this.settersByKey)))
        for (const t of e) t.deoptimizePath(B);
  ...
  deoptimizeIntegerProperties() {
    if (!(this.hasLostTrack || this.hasUnknownDeoptimizedProperty || this.hasUnknownDeoptimizedInteger)) {
      ...
      for (const [e, t] of Object.entries(this.propertiesAndGettersByKey))
        if (xt.test(e))
          for (const e of t) e.deoptimizePath(B);
  ...
  deoptimizePath(e) {
    ...
    const i = e[0];
    if (1 === e.length) {
      if ("string" != typeof i) return i === L ? this.deoptimizeIntegerProperties() : this.deoptimizeAllProperties(i === D);
  ...
  deoptimizeThisOnInteractionAtPath(e, t, i) {
    var s;
    const [n, ...r] = t;
    if (this.hasLostTrack || (2 === e.type || t.length > 1) && (this.hasUnknownDeoptimizedProperty || "string" == typeof n && this.deoptimizedPaths[n])) return void e.thisArg.deoptimizePath(B);
  ...
  getLiteralValueAtPath(e, t, i) {
    ...
    return n ? n.getLiteralValueAtPath(e.slice(1), t, i) : this.prototypeExpression ? this.prototypeExpression.getLiteralValueAtPath(e, t, i) : 1 !== e.length ? W : void 0
  }
  getReturnExpressionWhenCalledAtPath(e, t, i, s) {
    if (0 === e.length) return X;
    const [n, ...r] = e, a = this.getMemberExpressionAndTrackDeopt(n, s);
    return a ? a.getReturnExpressionWhenCalledAtPath(r, t, i, s) : this.prototypeExpression ? this.prototypeExpression.getReturnExpressionWhenCalledAtPath(e, t, i, s) : X
  }
  hasEffectsOnInteractionAtPath(e, t, i) {
    const [s, ...n] = e;
  ...
  deoptimizeCachedEntities() {
    for (const e of Object.values(this.expressionsToBeDeoptimizedByKey))
      for (const t of e) t.deoptimizeCache();
    for (const e of this.thisParametersToBeDeoptimized) e.deoptimizePath(B)
  }
  deoptimizeCachedIntegerEntities() {
    for (const [e, t] of Object.entries(this.expressionsToBeDeoptimizedByKey))
      if (xt.test(e))
        for (const e of t) e.deoptimizeCache();
    for (const e of this.thisParametersToBeDeoptimized) e.deoptimizePath(z)
  }
  getMemberExpression(e) {
    if (this.hasLostTrack || this.hasUnknownDeoptimizedProperty || "string" != typeof e || this.hasUnknownDeoptimizedInteger && xt.test(e) || this.deoptimizedPaths[e]) return X;
...
const bt = e => "string" == typeof e && /^\d+$/.test(e),
...
class Dt extends ee {
  ...
  consolidateInitializers() {
    if (null !== this.additionalInitializers) {
      for (const e of this.additionalInitializers) e.deoptimizePath(B);
  ...
  deoptimizeThisOnInteractionAtPath(e, t, i) {
    if (this.isReassigned || !this.init) return e.thisArg.deoptimizePath(B);
  ...
  markInitializersForDeoptimization() {
    return null === this.additionalInitializers && (this.additionalInitializers = null === this.init ? [] : [this.init], this.init = X, this.isReassigned = !0), this.additionalInitializers
  }
}
...
class Bt {
  ...
  addDeclaration(e, t, i, s) {
    ...
    return r ? r.addDeclaration(e, i) : (r = new Dt(e.name, e, i || Le, t), this.variables.set(n, r)), r
  }
  contains(e) {
...
class Ft extends Bt {
  ...
  addAccessedDynamicImport(e) {
    (this.accessedDynamicImports || (this.accessedDynamicImports = new Set)).add(e), this.parent instanceof Ft && this.parent.addAccessedDynamicImport(e)
  }
  ...
  deconflict(e, t, i) {
    ...
    for (const [e, t] of this.variables)(t.included || t.alwaysRendered) && t.setRenderNames(null, Vt(e, s));
...
class zt extends Ft {
  constructor(e, t) {
    super(e), this.parameters = [], this.hasRest = !1, this.context = t, this.hoistedBodyVarScope = new Ft(this)
  }
...
class jt extends zt {
  ...
  updateReturnExpression() {
    if (1 === this.returnExpressions.length) this.returnExpression = this.returnExpressions[0];
      ...
      for (const e of this.returnExpressions) e.deoptimizePath(B)
    }
  }
}
...
const Gt = Symbol("Value Properties"),
  Ht = {
  ...
  Xt = {
    ...
    [Gt]: {
      hasEffectsWhenCalled: ({
        args: e
      }, t) => !e.length || e[0].hasEffectsOnInteractionAtPath(F, Q, t)
    }
  },
  Yt = {
    __proto__: null,
  ...
  ei = {
    ...
    applicationCache: qt,
    ApplicationCache: Yt,
    ApplicationCacheErrorEvent: Yt,
    atob: qt,
    Attr: Yt,
    Audio: Yt,
    AudioBuffer: Yt,
    AudioBufferSourceNode: Yt,
    AudioContext: Yt,
    AudioDestinationNode: Yt,
    AudioListener: Yt,
    AudioNode: Yt,
    AudioParam: Yt,
    AudioProcessingEvent: Yt,
    AudioScheduledSourceNode: Yt,
    AudioWorkletNode: Yt,
    BarProp: Yt,
    BaseAudioContext: Yt,
    BatteryManager: Yt,
    BeforeUnloadEvent: Yt,
    BiquadFilterNode: Yt,
    Blob: Yt,
    BlobEvent: Yt,
    blur: qt,
    BroadcastChannel: Yt,
    btoa: qt,
    ByteLengthQueuingStrategy: Yt,
    Cache: Yt,
    caches: qt,
    CacheStorage: Yt,
    cancelAnimationFrame: qt,
    cancelIdleCallback: qt,
    CanvasCaptureMediaStreamTrack: Yt,
    CanvasGradient: Yt,
    CanvasPattern: Yt,
    CanvasRenderingContext2D: Yt,
    ChannelMergerNode: Yt,
    ChannelSplitterNode: Yt,
    CharacterData: Yt,
    ...
    CompositionEvent: Yt,
    confirm: qt,
    ConstantSourceNode: Yt,
    ConvolverNode: Yt,
    CountQueuingStrategy: Yt,
    createImageBitmap: qt,
    Credential: Yt,
    CredentialsContainer: Yt,
    crypto: qt,
    Crypto: Yt,
    CryptoKey: Yt,
    CSS: Yt,
    ...
    CSSRule: Yt,
    CSSRuleList: Yt,
    CSSStyleDeclaration: Yt,
    CSSStyleRule: Yt,
    CSSStyleSheet: Yt,
    CSSSupportsRule: Yt,
    CustomElementRegistry: Yt,
    customElements: qt,
    CustomEvent: Yt,
    DataTransfer: Yt,
    DataTransferItem: Yt,
    DataTransferItemList: Yt,
    defaultstatus: qt,
    defaultStatus: qt,
    DelayNode: Yt,
    DeviceMotionEvent: Yt,
    DeviceOrientationEvent: Yt,
    devicePixelRatio: qt,
    dispatchEvent: qt,
    document: qt,
    Document: Yt,
    ...
    DOMError: Yt,
    DOMException: Yt,
    DOMImplementation: Yt,
    DOMMatrix: Yt,
    DOMMatrixReadOnly: Yt,
    DOMParser: Yt,
    DOMPoint: Yt,
    DOMPointReadOnly: Yt,
    DOMQuad: Yt,
    ...
    history: qt,
    History: Yt,
    HTMLAllCollection: Yt,
    HTMLAnchorElement: Yt,
    HTMLAreaElement: Yt,
    HTMLAudioElement: Yt,
    HTMLBaseElement: Yt,
    HTMLBodyElement: Yt,
    HTMLBRElement: Yt,
    HTMLButtonElement: Yt,
    HTMLCanvasElement: Yt,
    HTMLCollection: Yt,
    HTMLContentElement: Yt,
    HTMLDataElement: Yt,
    HTMLDataListElement: Yt,
    HTMLDetailsElement: Yt,
    HTMLDialogElement: Yt,
    HTMLDirectoryElement: Yt,
    HTMLDivElement: Yt,
    HTMLDListElement: Yt,
    HTMLDocument: Yt,
    HTMLElement: Yt,
    HTMLEmbedElement: Yt,
    HTMLFieldSetElement: Yt,
    HTMLFontElement: Yt,
    HTMLFormControlsCollection: Yt,
    HTMLFormElement: Yt,
    HTMLFrameElement: Yt,
    HTMLFrameSetElement: Yt,
    HTMLHeadElement: Yt,
    HTMLHeadingElement: Yt,
    HTMLHRElement: Yt,
    HTMLHtmlElement: Yt,
    HTMLIFrameElement: Yt,
    HTMLImageElement: Yt,
    HTMLInputElement: Yt,
    HTMLLabelElement: Yt,
    HTMLLegendElement: Yt,
    HTMLLIElement: Yt,
    HTMLLinkElement: Yt,
    HTMLMapElement: Yt,
    HTMLMarqueeElement: Yt,
    HTMLMediaElement: Yt,
    HTMLMenuElement: Yt,
    HTMLMetaElement: Yt,
    HTMLMeterElement: Yt,
    HTMLModElement: Yt,
    HTMLObjectElement: Yt,
    HTMLOListElement: Yt,
    HTMLOptGroupElement: Yt,
    HTMLOptionElement: Yt,
    HTMLOptionsCollection: Yt,
    HTMLOutputElement: Yt,
    HTMLParagraphElement: Yt,
    HTMLParamElement: Yt,
    HTMLPictureElement: Yt,
    HTMLPreElement: Yt,
    HTMLProgressElement: Yt,
    HTMLQuoteElement: Yt,
    HTMLScriptElement: Yt,
    HTMLSelectElement: Yt,
    HTMLShadowElement: Yt,
    HTMLSlotElement: Yt,
    HTMLSourceElement: Yt,
    HTMLSpanElement: Yt,
    HTMLStyleElement: Yt,
    HTMLTableCaptionElement: Yt,
    HTMLTableCellElement: Yt,
    HTMLTableColElement: Yt,
    HTMLTableElement: Yt,
    HTMLTableRowElement: Yt,
    HTMLTableSectionElement: Yt,
    HTMLTemplateElement: Yt,
    HTMLTextAreaElement: Yt,
    HTMLTimeElement: Yt,
    HTMLTitleElement: Yt,
    HTMLTrackElement: Yt,
    HTMLUListElement: Yt,
    HTMLUnknownElement: Yt,
    HTMLVideoElement: Yt,
    IDBCursor: Yt,
    IDBCursorWithValue: Yt,
    IDBDatabase: Yt,
    IDBFactory: Yt,
    IDBIndex: Yt,
    IDBKeyRange: Yt,
    ...
    IDBRequest: Yt,
    IDBTransaction: Yt,
    IDBVersionChangeEvent: Yt,
    IdleDeadline: Yt,
    IIRFilterNode: Yt,
    Image: Yt,
    ImageBitmap: Yt,
    ImageBitmapRenderingContext: Yt,
    ImageCapture: Yt,
    ImageData: Yt,
    indexedDB: qt,
    innerHeight: qt,
    innerWidth: qt,
    InputEvent: Yt,
    IntersectionObserver: Yt,
    IntersectionObserverEntry: Yt,
    isSecureContext: qt,
    KeyboardEvent: Yt,
    KeyframeEffect: Yt,
    length: qt,
    ...
    MediaDeviceInfo: Yt,
    MediaDevices: Yt,
    MediaElementAudioSourceNode: Yt,
    MediaEncryptedEvent: Yt,
    MediaError: Yt,
    MediaKeyMessageEvent: Yt,
    MediaKeySession: Yt,
    MediaKeyStatusMap: Yt,
    MediaKeySystemAccess: Yt,
    MediaList: Yt,
    MediaQueryList: Yt,
    MediaQueryListEvent: Yt,
    MediaRecorder: Yt,
    MediaSettingsRange: Yt,
    MediaSource: Yt,
    MediaStream: Yt,
    MediaStreamAudioDestinationNode: Yt,
    MediaStreamAudioSourceNode: Yt,
    MediaStreamEvent: Yt,
    MediaStreamTrack: Yt,
    MediaStreamTrackEvent: Yt,
    menubar: qt,
    MessageChannel: Yt,
    MessageEvent: Yt,
    MessagePort: Yt,
    MIDIAccess: Yt,
    MIDIConnectionEvent: Yt,
    MIDIInput: Yt,
    MIDIInputMap: Yt,
    MIDIMessageEvent: Yt,
    MIDIOutput: Yt,
    ...
    name: qt,
    NamedNodeMap: Yt,
    NavigationPreloadManager: Yt,
    navigator: qt,
    Navigator: Yt,
    NetworkInformation: Yt,
    Node: Yt,
    NodeFilter: qt,
    NodeIterator: Yt,
    NodeList: Yt,
    Notification: Yt,
    OfflineAudioCompletionEvent: Yt,
    OfflineAudioContext: Yt,
    ...
    PaymentAddress: Yt,
    PaymentRequest: Yt,
    PaymentRequestUpdateEvent: Yt,
    PaymentResponse: Yt,
    performance: qt,
    Performance: Yt,
    PerformanceEntry: Yt,
    PerformanceLongTaskTiming: Yt,
    PerformanceMark: Yt,
    PerformanceMeasure: Yt,
    PerformanceNavigation: Yt,
    PerformanceNavigationTiming: Yt,
    PerformanceObserver: Yt,
    PerformanceObserverEntryList: Yt,
    PerformancePaintTiming: Yt,
    PerformanceResourceTiming: Yt,
    PerformanceTiming: Yt,
    PeriodicWave: Yt,
    Permissions: Yt,
    PermissionStatus: Yt,
    personalbar: qt,
    PhotoCapabilities: Yt,
    Plugin: Yt,
    PluginArray: Yt,
    PointerEvent: Yt,
    PopStateEvent: Yt,
    postMessage: qt,
    Presentation: Yt,
    PresentationAvailability: Yt,
    PresentationConnection: Yt,
    PresentationConnectionAvailableEvent: Yt,
    PresentationConnectionCloseEvent: Yt,
    PresentationConnectionList: Yt,
    PresentationReceiver: Yt,
    PresentationRequest: Yt,
    print: qt,
    ProcessingInstruction: Yt,
    ProgressEvent: Yt,
    PromiseRejectionEvent: Yt,
    prompt: qt,
    PushManager: Yt,
    PushSubscription: Yt,
    PushSubscriptionOptions: Yt,
    queueMicrotask: qt,
    RadioNodeList: Yt,
    Range: Yt,
    ReadableStream: Yt,
    ...
    resizeBy: qt,
    ResizeObserver: Yt,
    ResizeObserverEntry: Yt,
    resizeTo: qt,
    Response: Yt,
    RTCCertificate: Yt,
    RTCDataChannel: Yt,
    RTCDataChannelEvent: Yt,
    RTCDtlsTransport: Yt,
    RTCIceCandidate: Yt,
    RTCIceTransport: Yt,
    RTCPeerConnection: Yt,
    RTCPeerConnectionIceEvent: Yt,
    RTCRtpReceiver: Yt,
    RTCRtpSender: Yt,
    RTCSctpTransport: Yt,
    RTCSessionDescription: Yt,
    RTCStatsReport: Yt,
    RTCTrackEvent: Yt,
    screen: qt,
    Screen: Yt,
    screenLeft: qt,
    ScreenOrientation: Yt,
    screenTop: qt,
    screenX: qt,
    screenY: qt,
    ScriptProcessorNode: Yt,
    scroll: qt,
    scrollbars: qt,
    scrollBy: qt,
    scrollTo: qt,
    scrollX: qt,
    scrollY: qt,
    SecurityPolicyViolationEvent: Yt,
    Selection: Yt,
    ServiceWorker: Yt,
    ServiceWorkerContainer: Yt,
    ServiceWorkerRegistration: Yt,
    sessionStorage: qt,
    ShadowRoot: Yt,
    SharedWorker: Yt,
    SourceBuffer: Yt,
    SourceBufferList: Yt,
    speechSynthesis: qt,
    SpeechSynthesisEvent: Yt,
    SpeechSynthesisUtterance: Yt,
    StaticRange: Yt,
    status: qt,
    statusbar: qt,
    StereoPannerNode: Yt,
    ...
    SVGAngle: Yt,
    SVGAnimatedAngle: Yt,
    SVGAnimatedBoolean: Yt,
    SVGAnimatedEnumeration: Yt,
    SVGAnimatedInteger: Yt,
    SVGAnimatedLength: Yt,
    SVGAnimatedLengthList: Yt,
    SVGAnimatedNumber: Yt,
    SVGAnimatedNumberList: Yt,
    SVGAnimatedPreserveAspectRatio: Yt,
    SVGAnimatedRect: Yt,
    SVGAnimatedString: Yt,
    SVGAnimatedTransformList: Yt,
    SVGAnimateElement: Yt,
    SVGAnimateMotionElement: Yt,
    SVGAnimateTransformElement: Yt,
    SVGAnimationElement: Yt,
    SVGCircleElement: Yt,
    SVGClipPathElement: Yt,
    SVGComponentTransferFunctionElement: Yt,
    SVGDefsElement: Yt,
    SVGDescElement: Yt,
    SVGDiscardElement: Yt,
    SVGElement: Yt,
    SVGEllipseElement: Yt,
    SVGFEBlendElement: Yt,
    SVGFEColorMatrixElement: Yt,
    SVGFEComponentTransferElement: Yt,
    SVGFECompositeElement: Yt,
    SVGFEConvolveMatrixElement: Yt,
    SVGFEDiffuseLightingElement: Yt,
    SVGFEDisplacementMapElement: Yt,
    SVGFEDistantLightElement: Yt,
    SVGFEDropShadowElement: Yt,
    SVGFEFloodElement: Yt,
    SVGFEFuncAElement: Yt,
    SVGFEFuncBElement: Yt,
    SVGFEFuncGElement: Yt,
    SVGFEFuncRElement: Yt,
    SVGFEGaussianBlurElement: Yt,
    SVGFEImageElement: Yt,
    SVGFEMergeElement: Yt,
    SVGFEMergeNodeElement: Yt,
    SVGFEMorphologyElement: Yt,
    SVGFEOffsetElement: Yt,
    SVGFEPointLightElement: Yt,
    SVGFESpecularLightingElement: Yt,
    SVGFESpotLightElement: Yt,
    SVGFETileElement: Yt,
    SVGFETurbulenceElement: Yt,
    SVGFilterElement: Yt,
    SVGForeignObjectElement: Yt,
    SVGGElement: Yt,
    SVGGeometryElement: Yt,
    SVGGradientElement: Yt,
    SVGGraphicsElement: Yt,
    SVGImageElement: Yt,
    SVGLength: Yt,
    SVGLengthList: Yt,
    SVGLinearGradientElement: Yt,
    SVGLineElement: Yt,
    SVGMarkerElement: Yt,
    SVGMaskElement: Yt,
    SVGMatrix: Yt,
    SVGMetadataElement: Yt,
    SVGMPathElement: Yt,
    SVGNumber: Yt,
    SVGNumberList: Yt,
    SVGPathElement: Yt,
    SVGPatternElement: Yt,
    SVGPoint: Yt,
    SVGPointList: Yt,
    SVGPolygonElement: Yt,
    SVGPolylineElement: Yt,
    SVGPreserveAspectRatio: Yt,
    SVGRadialGradientElement: Yt,
    SVGRect: Yt,
    SVGRectElement: Yt,
    SVGScriptElement: Yt,
    SVGSetElement: Yt,
    ...
    SVGSwitchElement: Yt,
    SVGSymbolElement: Yt,
    SVGTextContentElement: Yt,
    SVGTextElement: Yt,
    SVGTextPathElement: Yt,
    SVGTextPositioningElement: Yt,
    SVGTitleElement: Yt,
    SVGTransform: Yt,
    SVGTransformList: Yt,
    SVGTSpanElement: Yt,
    ...
    WaveShaperNode: Yt,
    WebAssembly: qt,
    WebGL2RenderingContext: Yt,
    WebGLActiveInfo: Yt,
    WebGLBuffer: Yt,
    WebGLContextEvent: Yt,
    WebGLFramebuffer: Yt,
    WebGLProgram: Yt,
    WebGLQuery: Yt,
    WebGLRenderbuffer: Yt,
    WebGLRenderingContext: Yt,
    WebGLSampler: Yt,
    WebGLShader: Yt,
    WebGLShaderPrecisionFormat: Yt,
    WebGLSync: Yt,
    WebGLTexture: Yt,
    WebGLTransformFeedback: Yt,
    WebGLUniformLocation: Yt,
    WebGLVertexArrayObject: Yt,
    WebSocket: Yt,
    WheelEvent: Yt,
    Window: Yt,
    Worker: Yt,
    ...
    XMLDocument: Yt,
    XMLHttpRequest: Yt,
    XMLHttpRequestEventTarget: Yt,
    XMLHttpRequestUpload: Yt,
    XMLSerializer: Yt,
    XPathEvaluator: Yt,
    XPathExpression: Yt,
    XPathResult: Yt,
...
for (const e of ["window", "global", "self", "globalThis"]) ei[e] = ei;
...
class ni extends ut {
  ...
  isPossibleTDZ() {
    ...
    if (!(this.variable instanceof Dt && this.variable.kind && this.variable.kind in si)) return this.isTDZAccess = !1;
    let e;
    return this.variable.declarations && 1 === this.variable.declarations.length && (e = this.variable.declarations[0]) && this.start < e.start && ri(this) === ri(e) ? this.isTDZAccess = !0 : this.variable.initReached ? this.isTDZAccess = !1 : this.isTDZAccess = !0
  }
  ...
  render(e, {
    ...
    if (this.variable) {
      ...
      r !== this.name && (e.overwrite(this.start, this.end, r, {
        contentOnly: !0,
        storeName: !0
      }), n && e.prependRight(this.start, `${this.name}: `)), "eval" === r && "CallExpression" === i && s && e.appendRight(this.start, "0, ")
    }
  }
  applyDeoptimizations() {
    this.deoptimized = !0, this.variable instanceof Dt && (this.variable.consolidateInitializers(), this.context.requestTreeshakingPass())
  }
...
function pi(e, t, i, s, n) {
  ...
  c && (l = i + di(t.original.slice(i, h.start))[1]);
  for (let i = 1; i <= e.length; i++) r = h, a = l, o = c, h = e[i], c = void 0 !== h && (!h.included || h.needsBoundaries), o || c ? (l = r.end + di(t.original.slice(r.end, void 0 === h ? s : h.start))[1], r.included ? o ? r.render(t, n, {
    end: l,
    start: a
  }) : r.render(t, n) : ai(r, t, a, l)) : r.render(t, n)
}
...
function fi(e, t, i, s) {
  ...
  for (let s = 0; s < e.length; s++) {
    for (a = e[s], void 0 !== r && (c = r.end + hi(t.original.slice(r.end, a.start), ",")), o = l = c + 1 + di(t.original.slice(c + 1, a.start))[1]; h = t.original.charCodeAt(o), 32 === h || 9 === h || 10 === h || 13 === h;) o++;
    void 0 !== r && n.push({
      contentEnd: l,
      end: o,
      node: r,
...
function mi(e, t, i) {
  for (;;) {
    const [s, n] = di(e.original.slice(t, i));
    if (-1 === s) break;
    e.remove(t + s, t += n)
  }
}
...
class bi extends ut {
  ...
  getReturnExpressionWhenCalledAtPath(e, t, i, s) {
    return e.length > 0 ? this.getObjectEntity().getReturnExpressionWhenCalledAtPath(e, t, i, s) : this.async ? (this.deoptimizedReturn || (this.deoptimizedReturn = !0, this.scope.getReturnExpression().deoptimizePath(B), this.context.requestTreeshakingPass()), X) : this.scope.getReturnExpression()
  }
  hasEffectsOnInteractionAtPath(e, t, i) {
    ...
    if (this.async) {
      ...
      if (t.hasEffectsOnInteractionAtPath(["then"], Z, i) || e && ("always" === e || t.hasEffectsOnInteractionAtPath(["then"], Y, i))) return !0
    }
...
bi.prototype.preventChildBlockScope = !0;
class vi extends bi {
  constructor() {
  ...
  include(e, t) {
    super.include(e, t);
    for (const i of this.params) i instanceof ni || i.include(e, t)
  }
  getObjectEntity() {
...
function Ii(e, t, i, s, n, r) {
  const {
    _: a,
    getPropertyAccess: o
  } = r.snippets;
  n.appendLeft(i, `,${a}${Si([e],r)},${a}${e.getName(o)}`), s && (n.prependRight(t, "("), n.appendLeft(i, ")"))
}
class Pi extends ut {
  addExportedVariables(e, t) {
  ...
  hasEffectsOnInteractionAtPath(e, t, i) {
    for (const e of this.properties)
      if (e.hasEffectsOnInteractionAtPath(V, t, i)) return !0;
    return !1
  }
  markDeclarationReached() {
...
class wi extends Dt {
  constructor(e) {
    super("this", null, null, e), this.deoptimizedPaths = [], this.entitiesToBeDeoptimized = new Set, this.thisDeoptimizationList = [], this.thisDeoptimizations = new H
  }
  addEntityToBeDeoptimized(e) {
    ...
    for (const {
      ...
      of this.thisDeoptimizationList) e.deoptimizeThisOnInteractionAtPath(t, i, G);
  ...
  deoptimizeThisOnInteractionAtPath(e, t) {
    ...
    if (!this.thisDeoptimizations.trackEntityAtPathAndGetIfTracked(t, e.type, e.thisArg)) {
      for (const i of this.entitiesToBeDeoptimized) i.deoptimizeThisOnInteractionAtPath(e, t, G);
...
class _i extends bi {
  ...
  hasEffectsOnInteractionAtPath(e, t, i) {
    ...
    if (2 === t.type) {
      ...
      i.replacedVariableInits.set(this.scope.thisVariable, t.withNew ? new Et(Object.create(null), St) : X);
      const {
        brokenFlow: s,
        ignore: n
      } = i;
  ...
  include(e, t) {
    ...
    for (const i of this.params) i instanceof ni && !s || i.include(e, t)
  }
  initialise() {
    var e;
  ...
  getObjectEntity() {
    return null !== this.objectEntity ? this.objectEntity : this.objectEntity = new Et([{
      key: "prototype",
      kind: "init",
      property: new Et([], St)
    }], St)
...
function $i(e, t, i) {
  if (i.arguments.length > 0)
    if (i.arguments[i.arguments.length - 1].included)
      ...
      } else e.remove(hi(e.original, "(", i.callee.end) + 1, i.end - 1)
    }
}
class Ti extends ut {
  deoptimizeThisOnInteractionAtPath() {}
...
function Oi(e) {
  return e.computed ? function(e) {
    if (e instanceof Ti) return String(e.value);
    return null
...
class Mi extends ut {
  ...
  initialise() {
    this.propertyKey = Oi(this), this.accessInteraction = {
      thisArg: this.object,
      type: 0
    }
  }
  ...
  applyDeoptimizations() {
    ...
    if (this.bound && e && !this.variable && !this.replacement) {
      ...
      this.object.deoptimizeThisOnInteractionAtPath(this.accessInteraction, [e], G), this.context.requestTreeshakingPass()
    }
  }
...
function Di(e, t, i) {
  ...
  if (!e.isNamespace || e instanceof te) return null;
  const s = t[0].key,
...
class Li extends ut {
  ...
  deoptimizeCache() {
    if (this.returnExpression !== X) {
      ...
      for (const e of this.expressionsToBeDeoptimized) e.deoptimizePath(B)
    }
  }
  deoptimizePath(e) {
  ...
  getReturnExpressionWhenCalledAtPath(e, t, i, s) {
    ...
    return this.returnExpression === X ? X : i.withTrackedEntityAtPath(e, n, (() => (this.deoptimizableDependentExpressions.push(s), n.getReturnExpressionWhenCalledAtPath(e, t, i, s))), X)
  }
  hasEffectsOnInteractionAtPath(e, t, i) {
    const {
      type: s
...
class Vi extends zt {
  addDeclaration(e, t, i, s) {
    ...
    return n ? (this.parent.addDeclaration(e, t, Le, s), n.addDeclaration(e, i), n) : this.parent.addDeclaration(e, t, i, s)
  }
}
class Bi extends Ft {
  constructor(e, t, i) {
...
class Fi extends ut {
  ...
  deoptimizeThisOnInteractionAtPath(e, t, i) {
    return 0 === e.type && "get" === this.kind && 0 === t.length ? this.value.deoptimizeThisOnInteractionAtPath({
      ...
      type: 2,
      withNew: !1
    }, V, i) : 1 === e.type && "set" === this.kind && 0 === t.length ? this.value.deoptimizeThisOnInteractionAtPath({
      args: e.args,
      thisArg: e.thisArg,
      type: 2,
      withNew: !1
    }, V, i) : void this.getAccessedValue().deoptimizeThisOnInteractionAtPath(e, t, i)
  }
  getLiteralValueAtPath(e, t, i) {
  ...
  hasEffectsOnInteractionAtPath(e, t, i) {
    return "get" === this.kind && 0 === t.type && 0 === e.length ? this.value.hasEffectsOnInteractionAtPath(V, {
      args: J,
      thisArg: t.thisArg,
      type: 2,
      withNew: !1
    }, i) : "set" === this.kind && 1 === t.type ? this.value.hasEffectsOnInteractionAtPath(V, {
      args: t.args,
      thisArg: t.thisArg,
      type: 2,
      withNew: !1
...
class Ui extends ut {
  ...
  initialise() {
    ...
    for (const e of this.body.body)
      if (e instanceof zi && "constructor" === e.kind) return void(this.classConstructor = e);
    this.classConstructor = null
  }
  applyDeoptimizations() {
    this.deoptimized = !0;
    for (const e of this.body.body) e.static || e instanceof zi && "constructor" === e.kind || e.deoptimizePath(B);
    this.context.requestTreeshakingPass()
  }
  getObjectEntity() {
    ...
    for (const i of this.body.body) {
      ...
      let a;
      if (i.computed) {
        const e = i.key.getLiteralValueAtPath(V, G, this);
        if ("symbol" == typeof e) {
          s.push({
            key: M,
            kind: r,
        ...
        a = String(e)
      } else a = i.key instanceof ni ? i.key.name : String(i.key.value);
      s.push({
        key: a,
        kind: r,
        property: i
    ...
    return e.unshift({
      key: "prototype",
      kind: "init",
      property: new Et(t, this.superClass ? new ji(this.superClass, "prototype") : St)
    }), this.objectEntity = new Et(e, this.superClass || St)
  }
}
class Gi extends Ui {
  initialise() {
  ...
  render(e, t) {
    ...
    "system" === s && this.id && i.has(this.id.variable) && e.appendLeft(this.end, `${n}${Si([this.id.variable],t)};`), super.render(e, t)
  }
}
class Hi extends K {
  constructor(e) {
  ...
  getReturnExpressionWhenCalledAtPath(e, t, i, s) {
    return new Hi(this.expressions.map((n => n.getReturnExpressionWhenCalledAtPath(e, t, i, s))))
  }
  hasEffectsOnInteractionAtPath(e, t, i) {
...
class Ki extends ut {
  ...
  render(e, t, i) {
    const {
      ...
      return ui(e, hi(e, "default", t) + 7)
    }(e.original, this.start);
    if (this.declaration instanceof qi) this.renderNamedDeclaration(e, r, "function", "(", null === this.declaration.id, t);
    else if (this.declaration instanceof Gi) this.renderNamedDeclaration(e, r, "class", "{", null === this.declaration.id, t);
    else {
      if (this.variable.getOriginalVariable() !== this.variable) return void ai(this, e, s, n);
  ...
  renderNamedDeclaration(e, t, i, s, n, r) {
    ...
    e.remove(this.start, t), n && e.appendLeft(function(e, t, i, s) {
      const n = hi(e, t, s) + t.length;
      e = e.slice(n, hi(e, i, n));
      const r = hi(e, "*");
      return -1 === r ? n : n + r + 1
    }(e.original, i, s, t), ` ${h}`), "system" === o && this.declaration instanceof Gi && a.has(this.variable) && e.appendLeft(this.end, ` ${Si([this.variable],r)};`)
  }
...
Ki.prototype.needsBoundaries = !0;
class Xi extends ut {
  bind() {
    var e;
...
Xi.prototype.needsBoundaries = !0;
class Yi extends gi {
  constructor() {
...
class Ji extends ut {
  ...
  hasEffects(e) {
    ...
    if ("symbol" == typeof i) {
      ...
      return e.brokenFlow = t, null === this.alternate ? !1 : !!this.alternate.hasEffects(e) || (e.brokenFlow = e.brokenFlow < i ? e.brokenFlow : i, !1)
    }
  ...
  shouldKeepAlternateBranch() {
    let e = this.parent;
    do {
      if (e instanceof Ji && e.alternate) return !0;
      if (e instanceof xi) return !1;
      e = e.parent
    } while (e);
    return !1
  }
...
Zi.prototype.needsBoundaries = !0;
const es = {
  ...
  ns = (e, t, i, s, n, r, a) => {
    const o = new Set(e);
    for (const e of ys) t.has(e) && o.add(e);
    return ys.map((e => o.has(e) ? rs[e](i, s, n, r, a, o) : "")).join("")
  },
  rs = {
    _interopDefaultLegacy(e, t, i) {
      ...
      return `${a}e${s}&&${s}typeof e${s}===${s}'object'${s}&&${s}'default'${s}in e${s}?${s}${i?as(t):os(t)}${o}${r}${r}`
    },
    _interopDefault(e, t, i) {
      ...
      return `${a}e${s}&&${s}e.__esModule${s}?${s}${i?as(t):os(t)}${o}${r}${r}`
    },
    _interopNamespaceDefaultOnly(e, t, i, s, n) {
      ...
      return `${l}${ms(s,gs(n,a([["__proto__","null"],["default","e"]],{lineBreakIndent:null}),t))}${h}${o}${o}`
    },
    _interopNamespaceDefault(e, t, i, s, n) {
      ...
      return `function _interopNamespaceDefault(e)${r}{${a}` + ls(e, e, t, i, s, n) + `}${a}${a}`
    },
    _interopNamespace(e, t, i, s, n, r) {
      ...
      return `function _interopNamespace(e)${a}{${l}${e}if${a}(e${a}&&${a}e.__esModule)${a}return e;${l}` + ls(e, e, t, i, s, n) + `}${l}${l}`
    },
    _mergeNamespaces(e, t, i, s, n) {
      ...
      return `function _mergeNamespaces(n, m)${r}{${o}${e}${cs(`{${o}${e}${e}${e}if${r}(k${r}!==${r}'default'${r}&&${r}!(k in n))${r}{${o}`+(i?l?ds:ps:fs)(e,e+e+e+e,t)+`${e}${e}${e}}${o}`+`${e}${e}}`,l,e,t)}${o}${e}return ${ms(s,gs(n,"n",t))};${o}}${o}${o}`
    }
  },
  as = ({
    _: e,
  ...
  ls = (e, t, i, s, n, r) => {
    const {
      ...
      n: c,
      s: u
    } = i, d = `{${c}` + (s ? us : fs)(e, t + e + e, i) + `${t}${e}}`;
    return `${t}${o} n${a}=${a}Object.create(null${r?`,${a}{${a}[Symbol.toStringTag]:${a}${xs(l)}${a}}`:""});${c}${t}if${a}(e)${a}{${c}${t}${e}${hs(d,!s,i)}${c}${t}}${c}${t}n${h("default")}${a}=${a}e;${c}${t}return ${ms(n,"n")}${u}${c}`
  },
  hs = (e, t, {
    _: i,
    cnst: s,
  ...
  us = (e, t, i) => {
    ...
    return `${t}if${s}(k${s}!==${s}'default')${s}{${n}` + ds(e, t + e, i) + `${t}}${n}`
  },
  ds = (e, t, {
    _: i,
    cnst: s,
  ...
  gs = (e, t, {
    _: i,
    getObject: s
  }) => e ? `Object.defineProperty(${t},${i}Symbol.toStringTag,${i}${xs(s)})` : t,
  ys = Object.keys(rs);
...
const As = {
  ...
  ks = (e, t = !1) => Ps(`'${e}', ${t?"typeof document === 'undefined' ? location.href : ":""}document.currentScript && document.currentScript.src || document.baseURI`),
  ws = e => (t, {
    chunkId: i
  }) => {
    const s = e(i);
  ...
  Cs = (e, t = !1) => `${t?"typeof document === 'undefined' ? location.href : ":""}(document.currentScript && document.currentScript.src || new URL('${e}', document.baseURI).href)`,
  _s = {
    amd: e => ("." !== e[0] && (e = "./" + e), Ps(`require.toUrl('${e}'), document.baseURI`)),
    cjs: e => `(typeof document === 'undefined' ? ${Ps(`'file:' + __dirname + '/${e}'`,"(require('u' + 'rl').URL)")} : ${ks(e)})`,
    es: e => Ps(`'${e}', import.meta.url`),
    iife: e => ks(e),
    system: e => Ps(`'${e}', module.meta.url`),
    umd: e => `(typeof document === 'undefined' && typeof location === 'undefined' ? ${Ps(`'file:' + __dirname + '/${e}'`,"(require('u' + 'rl').URL)")} : ${ks(e,!0)})`
  },
  Ns = {
    amd: ws((() => Ps("module.uri, document.baseURI"))),
    cjs: ws((e => `(typeof document === 'undefined' ? ${Ps("'file:' + __filename","(require('u' + 'rl').URL)")} : ${Cs(e)})`)),
    iife: ws((e => Cs(e))),
    system: (e, {
      snippets: {
        getPropertyAccess: t
    ...
    umd: ws((e => `(typeof document === 'undefined' && typeof location === 'undefined' ? ${Ps("'file:' + __filename","(require('u' + 'rl').URL)")} : ${Cs(e,!0)})`))
  };
class $s extends ut {
  constructor() {
...
class Ts extends ut {
  ...
  render(e, t, i) {
    if (this.consequent.length) {
      ...
      const s = this.test ? this.test.end : hi(e.original, "default", this.start) + 7,
        n = hi(e.original, ":", s) + 1;
      pi(this.consequent, e, n, i.end, t)
...
class Ms extends Dt {
  constructor(e, t, i) {
    ...
    (s instanceof qi || s instanceof Gi) && s.id ? (this.hasId = !0, this.originalId = s.id) : s instanceof ni && (this.originalId = s)
  }
  addReference(e) {
...
class Bs extends ut {
  deoptimizePath() {
    for (const e of this.declarations) e.deoptimizePath(V)
  }
  ...
  renderReplacedDeclarations(e, t) {
    ...
    let s, n;
    n = ui(e.original, this.start + this.kind.length);
    let r = n - 1;
      ...
      d = function(e, t, i) {
        ...
        if ("system" === t.format) {
          for (const {
            ...
            of e) r.id instanceof ni && r.init && 0 === i.length && 1 === (null === (s = t.exportNamesByVariable.get(r.id.variable)) || void 0 === s ? void 0 : s.length) ? (n = r.id.variable, i.push(n)) : r.id.addExportedVariables(i, t.exportNamesByVariable);
    ...
    for (const {
      ...
      of i)
      if (u.included) {
        if (u.render(e, t), a = "", o = "", !u.id.included || u.id instanceof ni && Vs(u.id.variable, t.exportNamesByVariable)) h && (c += ";"), l = !1;
        else {
          if (d && d === u.id.variable) {
            const i = hi(e.original, "=", u.id.end);
            Ai(d, ui(e.original, i + 1), null === f ? m : f, e, t)
          }
...
const Fs = {
  ArrayExpression: class extends ut {
    constructor() {
      super(...arguments), this.objectEntity = null
    }
    deoptimizePath(e) {
    ...
    applyDeoptimizations() {
      ...
      for (let t = 0; t < this.elements.length; t++) {
        ...
        i && (e || i instanceof dt) && (e = !0, i.deoptimizePath(B))
      }
      this.context.requestTreeshakingPass()
    }
    getObjectEntity() {
      ...
      for (let i = 0; i < this.elements.length; i++) {
        ...
        t || s instanceof dt ? s && (t = !0, e.unshift({
          key: L,
          kind: "init",
          property: s
        })) : s ? e.push({
  ...
  ArrayPattern: class extends ut {
    ...
    declare(e) {
      const t = [];
      for (const i of this.elements) null !== i && t.push(...i.declare(e, X));
      return t
    }
    deoptimizePath() {
      for (const e of this.elements) null == e || e.deoptimizePath(V)
    }
    hasEffectsOnInteractionAtPath(e, t, i) {
      for (const e of this.elements)
        if (null == e ? void 0 : e.hasEffectsOnInteractionAtPath(V, t, i)) return !0;
      return !1
    }
    markDeclarationReached() {
  ...
  AssignmentExpression: class extends ut {
    hasEffects(e) {
      const {
        deoptimized: t,
        left: i,
    ...
    include(e, t) {
      ...
      i || this.applyDeoptimizations(), this.included = !0, (t || "=" !== r || s.included || s.hasEffectsAsAssignmentTarget(Me(), !1)) && s.includeAsAssignmentTarget(e, t, "=" !== r), n.include(e, t)
    }
    initialise() {
    ...
    render(e, t, {
      ...
      if (r.included) r.render(e, t), a.render(e, t);
        ...
        const l = ui(e.original, hi(e.original, "=", r.end) + 1);
        e.remove(o, l), i && mi(e, l, a.start), a.render(e, t, {
      ...
      if ("system" === t.format)
        if (r instanceof ni) {
          ...
          if (s) return void(1 === s.length ? Ai(i, o, l, e, t) : Ii(i, o, l, "ExpressionStatement" !== h.type, e, t))
        } else {
          const i = [];
          ...
          function(e, t, i, s, n, r) {
            ...
            n.prependRight(t, o(["v"], `${Si(e,r)},${a}v`, {
              needsArrowReturnParens: !0,
              needsWrappedFunction: s
            })), n.appendLeft(i, ")")
          }(i, o, l, "ExpressionStatement" === n, e, t)
        } r.included && r instanceof Pi && ("ExpressionStatement" === n || "ArrowFunctionExpression" === n) && (e.appendRight(o, "("), e.prependLeft(l, ")"))
    }
    applyDeoptimizations() {
      this.deoptimized = !0, this.left.deoptimizePath(V), this.right.deoptimizePath(B), this.context.requestTreeshakingPass()
    }
  },
    ...
    include(e, t) {
      if (this.deoptimized || this.applyDeoptimizations(), !this.included) {
        ...
        e: if (!this.context.usesTopLevelAwait) {
          let e = this.parent;
          do {
            if (e instanceof _i || e instanceof vi) break e
          } while (e = e.parent);
  ...
  BinaryExpression: class extends ut {
    ...
    getLiteralValueAtPath(e, t, i) {
      ...
      if ("symbol" == typeof s) return W;
      const n = this.right.getLiteralValueAtPath(V, t, i);
      if ("symbol" == typeof n) return W;
      const r = Ni[this.operator];
      return r ? r(s, n) : W
    }
    hasEffects(e) {
  ...
  BlockStatement: xi,
  BreakStatement: class extends ut {
    hasEffects(e) {
      if (this.label) {
  ...
  CallExpression: class extends Li {
    bind() {
      ...
      this.interaction = {
        args: this.arguments,
        thisArg: this.callee instanceof Mi && !this.callee.variable ? this.callee.object : null,
        type: 2,
        withNew: !1
      }
    }
    ...
    include(e, t) {
      this.deoptimized || this.applyDeoptimizations(), t ? (super.include(e, t), "variables" === t && this.callee instanceof ni && this.callee.variable && this.callee.variable.markCalledFromTryStatement()) : (this.included = !0, this.callee.include(e, !1)), this.callee.includeCallArguments(e, this.arguments)
    }
    render(e, t, {
      renderedSurroundingElement: i
    } = ie) {
    ...
    applyDeoptimizations() {
      this.deoptimized = !0, this.interaction.thisArg && this.callee.deoptimizeThisOnInteractionAtPath(this.interaction, V, G);
      for (const e of this.arguments) e.deoptimizePath(B);
      this.context.requestTreeshakingPass()
    }
  ...
  ClassDeclaration: Gi,
  ClassExpression: class extends Ui {
    render(e, t, {
      renderedSurroundingElement: i
    } = ie) {
  ...
  ConditionalExpression: class extends ut {
    ...
    getReturnExpressionWhenCalledAtPath(e, t, i, s) {
      ...
      return n ? (this.expressionsToBeDeoptimized.push(s), n.getReturnExpressionWhenCalledAtPath(e, t, i, s)) : new Hi([this.consequent.getReturnExpressionWhenCalledAtPath(e, t, i, s), this.alternate.getReturnExpressionWhenCalledAtPath(e, t, i, s)])
    }
    hasEffects(e) {
      if (this.test.hasEffects(e)) return !0;
      const t = this.getUsedBranch();
    ...
    render(e, t, {
      ...
      if (this.test.included) this.test.render(e, t, {
        ...
        const o = hi(e.original, ":", this.consequent.end),
          l = ui(e.original, (this.consequent.included ? hi(e.original, "?", this.test.end) : o) + 1);
        s && mi(e, l, a.start), e.remove(this.start, l), this.consequent.included && e.remove(o, this.end), oi(this, e), a.render(e, t, {
          isCalleeOfRenderedParent: i,
          preventASI: !0,
  ...
  ExportAllDeclaration: Wi,
  ExportDefaultDeclaration: Ki,
  ExportNamedDeclaration: Xi,
  ExportSpecifier: class extends ut {
    applyDeoptimizations() {}
  },
  ExpressionStatement: yi,
  ForInStatement: class extends ut {
    createScope(e) {
      this.scope = new gi(e)
    }
    hasEffects(e) {
    ...
    applyDeoptimizations() {
      this.deoptimized = !0, this.left.deoptimizePath(V), this.context.requestTreeshakingPass()
    }
  },
  ...
  ForStatement: class extends ut {
    ...
    render(e, t) {
      var i, s, n;
      null === (i = this.init) || void 0 === i || i.render(e, t, li), null === (s = this.test) || void 0 === s || s.render(e, t, li), null === (n = this.update) || void 0 === n || n.render(e, t, li), this.body.render(e, t)
    }
  },
  FunctionDeclaration: qi,
  FunctionExpression: class extends _i {
    render(e, t, {
      renderedSurroundingElement: i
    } = ie) {
      super.render(e, t), "ExpressionStatement" === i && (e.appendRight(this.start, "("), e.prependLeft(this.end, ")"))
  ...
  Identifier: ni,
  IfStatement: Ji,
  ImportDeclaration: Zi,
  ImportDefaultSpecifier: class extends ut {
    applyDeoptimizations() {}
  },
  ImportExpression: class extends ut {
    ...
    render(e, t) {
      ...
      } else this.mechanism && (e.overwrite(this.start, hi(e.original, "(", this.start + 6) + 1, this.mechanism.left, {
        contentOnly: !0
  ...
  Literal: Ti,
  LogicalExpression: class extends ut {
    constructor() {
      super(...arguments), this.expressionsToBeDeoptimized = [], this.isBranchResolutionAnalysed = !1, this.usedBranch = null
    }
    deoptimizeCache() {
    ...
    getReturnExpressionWhenCalledAtPath(e, t, i, s) {
      const n = this.getUsedBranch();
      return n ? (this.expressionsToBeDeoptimized.push(s), n.getReturnExpressionWhenCalledAtPath(e, t, i, s)) : new Hi([this.left.getReturnExpressionWhenCalledAtPath(e, t, i, s), this.right.getReturnExpressionWhenCalledAtPath(e, t, i, s)])
    }
    hasEffects(e) {
    ...
    render(e, t, {
      ...
      if (this.left.included && this.right.included) this.left.render(e, t, {
        ...
        const a = hi(e.original, this.operator, this.left.end);
        if (this.right.included) {
          const t = ui(e.original, a + 2);
          e.remove(this.start, t), s && mi(e, t, this.right.start)
        } else e.remove(a, this.end);
        oi(this, e), this.getUsedBranch().render(e, t, {
          isCalleeOfRenderedParent: i,
          preventASI: s,
          renderedParentType: n || this.parent.type,
          renderedSurroundingElement: r || this.parent.type
  ...
  MemberExpression: Mi,
  MetaProperty: class extends ut {
    addAccessedGlobals(e, t) {
      const i = this.metaProperty,
        s = (i && (i.startsWith(Ss) || i.startsWith(vs) || i.startsWith("ROLLUP_CHUNK_URL_")) ? Is : As)[e];
    ...
    renderFinalMechanism(e, t, i, s, n) {
      ...
      const a = this.parent,
        o = this.metaProperty;
      if (o && (o.startsWith(Ss) || o.startsWith(vs) || o.startsWith("ROLLUP_CHUNK_URL_"))) {
        let s, r = null,
          l = null,
          h = null;
        o.startsWith(Ss) ? (r = o.substring(Ss.length), s = n.getFileName(r)) : o.startsWith(vs) ? (Pe(`Using the "${vs}" prefix to reference files is deprecated. Use the "${Ss}" prefix instead.`, !0, this.context.options), l = o.substring(vs.length), s = n.getFileName(l)) : (Pe(`Using the "ROLLUP_CHUNK_URL_" prefix to reference files is deprecated. Use the "${Ss}" prefix instead.`, !0, this.context.options), h = o.substring("ROLLUP_CHUNK_URL_".length), s = n.getFileName(h));
        const c = C(T(N(t), s));
        let u;
        return null !== l && (u = n.hookFirstSync("resolveAssetUrl", [{
          ...
          referenceId: r || l || h,
          relativePath: c
        }]) || _s[i](c)), void e.overwrite(a.start, a.end, u, {
          contentOnly: !0
        })
      }
      const l = n.hookFirstSync("resolveImportMeta", [o, {
        ...
        format: i,
        moduleId: this.context.module.id
      }]) || (null === (r = Ns[i]) || void 0 === r ? void 0 : r.call(Ns, o, {
        chunkId: t,
        snippets: s
      }));
      "string" == typeof l && (a instanceof Mi ? e.overwrite(a.start, a.end, l, {
        contentOnly: !0
  ...
  MethodDefinition: zi,
  NewExpression: class extends ut {
    hasEffects(e) {
      try {
        for (const t of this.arguments)
          if (t.hasEffects(e)) return !0;
  ...
  ObjectPattern: Pi,
  PrivateIdentifier: class extends ut {},
  Program: $s,
  Property: class extends Fi {
    constructor() {
      super(...arguments), this.declarationInit = null
    }
    declare(e, t) {
  ...
  RestElement: Ei,
  ReturnStatement: class extends ut {
    hasEffects(e) {
      var t;
  ...
  SequenceExpression: class extends ut {
    ...
    include(e, t) {
      ...
      for (const s of this.expressions)(t || s === i && !(this.parent instanceof yi) || s.shouldBeIncluded(e)) && s.include(e, t)
    }
    render(e, t, {
      renderedParentType: i,
      isCalleeOfRenderedParent: s,
      ...
      for (const {
        ...
        of fi(this.expressions, e, this.start, this.end))
        if (l.included)
          if (r++, a = h, 1 === r && n && mi(e, c, l.start), 1 === r) {
  ...
  SwitchCase: Ts,
  SwitchStatement: class extends ut {
    createScope(e) {
      this.scope = new gi(e)
    }
    hasEffects(e) {
  ...
  TaggedTemplateExpression: class extends Li {
    ...
    initialise() {
      this.interaction = {
        args: [X, ...this.quasi.expressions],
        thisArg: this.tag instanceof Mi && !this.tag.variable ? this.tag.object : null,
        type: 2,
        withNew: !1
      }
    }
    ...
    applyDeoptimizations() {
      this.deoptimized = !0, this.interaction.thisArg && this.tag.deoptimizeThisOnInteractionAtPath(this.interaction, V, G);
      for (const e of this.quasi.expressions) e.deoptimizePath(B);
      this.context.requestTreeshakingPass()
    }
    getReturnExpression(e = G) {
  ...
  TemplateLiteral: Os,
  ThisExpression: class extends ut {
    bind() {
      this.variable = this.scope.findVariable("this")
    }
    deoptimizePath(e) {
    ...
    initialise() {
      this.alias = this.scope.findLexicalBoundary() instanceof Ds ? this.context.moduleContext : null, "undefined" === this.alias && this.context.warn({
  ...
  TryStatement: class extends ut {
    ...
    include(e, t) {
      ...
      } else this.included = !0, this.directlyIncluded = !0, this.block.include(e, n ? "variables" : t), e.includedLabels.size > 0 && (this.includedLabelsAfterBlock = [...e.includedLabels]), e.brokenFlow = r;
  ...
  UnaryExpression: class extends ut {
    ...
    applyDeoptimizations() {
      this.deoptimized = !0, "delete" === this.operator && (this.argument.deoptimizePath(V), this.context.requestTreeshakingPass())
    }
  },
    ...
    render(e, t) {
      ...
      if (this.argument.render(e, t), "system" === s) {
        const s = this.argument.variable,
          r = i.get(s);
        if (r)
          if (this.prefix) 1 === r.length ? Ai(s, this.start, this.end, e, t) : Ii(s, this.start, this.end, "ExpressionStatement" !== this.parent.type, e, t);
          else {
            ...
            ! function(e, t, i, s, n, r, a) {
              ...
              n.prependRight(t, `${Si([e],r,a)},${o}`), s && (n.prependRight(t, "("), n.appendLeft(i, ")"))
            }(s, this.start, this.end, "ExpressionStatement" !== this.parent.type, e, t, `${n}${i}${n}1`)
          }
      }
    }
    applyDeoptimizations() {
      if (this.deoptimized = !0, this.argument.deoptimizePath(V), this.argument instanceof ni) {
  ...
  VariableDeclarator: class extends ut {
    declareDeclarator(e) {
    ...
    render(e, t) {
      ...
      if (n) this.id.render(e, t);
        ...
        const t = hi(e.original, "=", this.id.end);
        e.remove(this.start, ui(e.original, t + 1))
      }
      this.init ? this.init.render(e, t, n ? ie : {
        renderedSurroundingElement: "ExpressionStatement"
      }) : this.id instanceof ni && Vs(this.id.variable, i) && e.appendLeft(this.end, `${s}=${s}void 0`)
    }
    applyDeoptimizations() {}
  },
...
class js extends ee {
  ...
  renderBlock(e) {
    ...
    } else r && (f = `/*#__PURE__*/Object.defineProperty(${f},${a}Symbol.toStringTag,${a}${xs(l)})`), s && (f = `/*#__PURE__*/Object.freeze(${f})`);
    return f = `${o} ${this.getName(h)}${a}=${a}${f};`, "system" === i && t.has(this) && (f += `${c}${Si([this],e)};`), f
  }
  renderFirst() {
...
var Ws = "performance" in ("undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : {}) ? performance : {
    now: () => 0
  },
  qs = {
    memoryUsage: () => ({
...
function Qs(e, t = 3) {
  e = Ys(e, t);
  const i = qs.memoryUsage().heapUsed,
    s = Ws.now(),
    n = Xs.get(e);
  void 0 === n ? Xs.set(e, {
    memory: 0,
...
function Js(e, t = 3) {
  ...
  const i = Xs.get(e);
  if (void 0 !== i) {
    const e = qs.memoryUsage().heapUsed;
    i.memory += e - i.startMemory, i.time += Ws.now() - i.startTime, i.totalMemory = Math.max(i.totalMemory, e)
  }
}
  ...
  for (const i of sn)
    if (i in e) {
      ...
      e[i] = function(...e) {
        ...
        return tn(s, 4), t && "function" == typeof t.then ? (en(`${s} (async)`, 4), t.then((e => (tn(`${s} (async)`, 4), e)))) : t
      }
    } return e
}
...
function rn(e) {
  ...
  const t = [e],
    i = new Set;
  for (const e of t)
    for (const s of [...e.dependencies, ...e.implicitlyLoadedBefore]) s instanceof $e || s.isExecuted || !s.info.moduleSideEffects && !e.implicitlyLoadedBefore.has(s) || i.has(s.id) || (s.isExecuted = !0, i.add(s.id), t.push(s))
}
const an = {
  identifier: null,
...
function on(e, t, i, s, n = new Map) {
  const r = n.get(t);
  if (r) {
    if (r.has(e)) return s ? [null] : pe((a = t, o = e.id, {
      code: me.CIRCULAR_REEXPORT,
      id: o,
...
class ln {
  constructor(e, t, i, s, n, r, a) {
    ...
    this.info = {
      ...
      get hasModuleSideEffects() {
        return Pe("Accessing ModuleInfo.hasModuleSideEffects from plugins is deprecated. Please use ModuleInfo.moduleSideEffects instead.", !1, i), this.moduleSideEffects
      },
      id: t,
      get implicitlyLoadedAfterOneOf() {
        return Array.from(c, Hs).sort()
      },
      get implicitlyLoadedBefore() {
        return Array.from(u, Hs).sort()
      },
      ...
      isExternal: !1,
      get isIncluded() {
        return e.phase !== Gs.GENERATE ? null : o.isIncluded()
      },
      meta: {
        ...a
      },
  ...
  getAllExportNames() {
    ...
    for (const e of this.exportAllModules)
      if (e instanceof $e) this.allExportNames.add(`*${e.id}`);
      else
  ...
  getExportNamesByVariable() {
    ...
    for (const t of this.getAllExportNames()) {
      ...
      if (i instanceof Ms && (i = i.getOriginalVariable()), !i || !(i.included || i instanceof te)) continue;
      const s = e.get(i);
  ...
  getSyntheticNamespace() {
    return null === this.syntheticNamespace && (this.syntheticNamespace = void 0, [this.syntheticNamespace] = this.getVariableForExportName("string" == typeof this.info.syntheticNamedExports ? this.info.syntheticNamedExports : "default", {
      onlyExplicit: !0
    })), this.syntheticNamespace ? this.syntheticNamespace : pe((e = this.id, t = this.info.syntheticNamedExports, {
      code: me.SYNTHETIC_NAMED_EXPORTS_NEED_NAMESPACE_EXPORT,
      id: e,
  ...
  getVariableForExportName(e, {
    ...
    if (a) {
      const [e] = on(a.module, a.localName, t, !1, n);
      return e ? (t && hn(e, t, this), [e]) : this.error(Ee(a.localName, this.id, a.module.id), a.start)
    }
    const o = this.exports.get(e);
    if (o) {
      if (o === an) return [this.exportShimVariable];
      const e = o.localName,
        i = this.traceVariable(e, {
          importerForSideEffects: t,
          searchedNamesAndModules: n
        });
      return t && (R(t.sideEffectDependenciesByVariable, i, (() => new Set)).add(this), hn(i, t, this)), [i]
    }
    if (s) return [null];
    if ("default" !== e) {
  ...
  includeAllExports(e) {
    this.isExecuted || (rn(this), this.graph.needsTreeshakingPass = !0);
    for (const t of this.exports.keys())
      if (e || t !== this.info.syntheticNamedExports) {
        const e = this.getVariableForExportName(t)[0];
        e.deoptimizePath(B), e.included || this.includeVariable(e)
      } for (const e of this.getReexports()) {
      const [t] = this.getVariableForExportName(e);
      t && (t.deoptimizePath(B), t.included || this.includeVariable(t), t instanceof te && (t.module.reexported = !0))
    }
  ...
  setSource({
    ...
    this.info.code = t, this.originalCode = s, this.originalSourcemap = n, this.sourcemapChain = a, l && (this.transformFiles = l), this.transformDependencies = o, this.customTransformCache = i, this.updateOptions(h), en("generate ast", 3), e || (e = this.tryParse()), tn("generate ast", 3), this.resolvedIds = r || Object.create(null);
    const c = this.id;
    this.magicString = new x(t, {
      ...
      getNodeConstructor: e => Fs[e] || Fs.UnknownNode,
    ...
    }, this.scope = new Ds(this.graph.scope, this.astContext), this.namespace = new js(this.astContext), this.ast = new $s(e, {
      context: this.astContext,
      type: "Module"
    }, this.scope), this.info.ast = e, tn("analyse ast", 3)
  }
  toJSON() {
    return {
      ...
      dependencies: Array.from(this.dependencies, Hs),
      id: this.id,
      meta: this.info.meta,
  ...
  traceVariable(e, {
    ...
    if (r) {
      const e = r.module;
      if (e instanceof ln && "*" === r.name) return e.namespace;
      const [n] = on(e, r.name, t || this, i, s);
      return n || this.error(Ee(r.name, this.id, e.id), r.start)
    }
    return null
  }
  tryParse() {
  ...
  addDynamicImport(e) {
    let t = e.source;
    t instanceof Os ? 1 === t.quasis.length && t.quasis[0].value.cooked && (t = t.quasis[0].value.cooked) : t instanceof Ti && "string" == typeof t.value && (t = t.value), this.dynamicImports.push({
      argument: t,
      id: null,
      node: e,
      resolution: null
  ...
  addExport(e) {
    if (e instanceof Ki) this.exports.set("default", {
      ...
      if (t instanceof Bs)
        for (const e of t.declarations)
          for (const t of Oe(e.id)) this.exports.set(t, {
            identifier: null,
            localName: t
          });
      else {
  ...
  addRelevantSideEffectDependencies(e, t, i) {
    const s = new Set,
      n = r => {
        for (const a of r) s.has(a) || (s.add(a), t.has(a) ? e.add(a) : (a.info.moduleSideEffects || i.has(a)) && (a instanceof $e || a.hasEffects() ? e.add(a) : n(a.dependencies)))
      };
  ...
  getVariableFromNamespaceReexports(e, t, i) {
    ...
    for (const a of this.exportAllModules) {
      ...
      const [o, l] = on(a, e, t, !0, cn(i));
      a instanceof $e || l ? r.add(o) : o instanceof Us ? s || (s = o) : o && n.set(o, a)
    }
    if (n.size > 0) {
      const t = [...n],
        i = t[0][0];
      return 1 === t.length ? [i] : (this.options.onwarn(function(e, t, i) {
        return {
          code: me.NAMESPACE_CONFLICT,
          message: `Conflicting namespaces: "${he(t)}" re-exports "${e}" from one of the modules ${oe(i.map((e=>he(e))))} (will be ignored)`,
          name: e,
          reexporter: t,
          sources: i
        }
    ...
    if (r.size > 0) {
      ...
      return t.length > 1 && this.options.onwarn(function(e, t, i, s) {
        return {
          code: me.AMBIGUOUS_EXTERNAL_NAMESPACES,
          message: `Ambiguous external namespace resolution: "${he(t)}" re-exports "${e}" from one of the external modules ${oe(s.map((e=>he(e))))}, guessing "${he(i)}".`,
          name: e,
          reexporter: t,
          sources: s
        }
  ...
  includeDynamicImport(e) {
    ...
    t instanceof ln && (t.includedDynamicImporters.push(this), t.includeAllExports(!0))
  }
  includeVariable(e) {
    if (!e.included) {
      ...
      if (t instanceof ln && (t.isExecuted || rn(t), t !== this)) {
        const t = function(e, t) {
          ...
          for (;;) {
            const e = s.module;
            if (s = s instanceof Ms ? s.getDirectOriginalVariable() : s instanceof Us ? s.syntheticNamespace : null, !s || n.has(s)) break;
            n.add(s), i.add(e);
        ...
        for (const e of t) e.isExecuted || rn(e)
      }
    }
  }
...
function pn(e, t, i, s, n, r, a, o = "return ") {
  const {
    _: l,
    cnst: h,
  ...
  if (!i) return `${p}${p}${o}${function(e,t,i,s,n){if(e.length>0)return e[0].local;for(const{defaultVariableName:e,id:r,isChunk:a,name:o,namedExportsMode:l,namespaceVariableName:h,reexports:c}of t)if(c)return fn(o,c[0].imported,l,a,e,h,i,r,s,n)}(e,t,s,a,d)};`;
  let m = "";
  for (const {
    ...
    if (g && i)
      for (const t of g)
        if ("*" !== t.reexported) {
          const i = fn(h, t.imported, u, o, e, f, s, n, a, d);
  ...
  for (const {
    ...
    if (s && i)
      for (const t of s)
        if ("*" === t.reexported) {
          m && (m += p);
          const i = `{${p}${r}if${l}(k${l}!==${l}'default'${l}&&${l}!exports.hasOwnProperty(k))${l}${yn(e,t.needsLiveBinding,r,n)}${f}${p}}`;
          m += "var" === h && t.needsLiveBinding ? `Object.keys(${e}).forEach(${u(["k"],{isAsync:!1,name:null})}${i});` : `for${l}(${h} k in ${e})${l}${i}`
        } return m ? `${p}${p}${m}` : ""
}

function fn(e, t, i, s, n, r, a, o, l, h) {
  if ("default" === t) {
    if (!s) {
      const t = String(a(o)),
        i = es[t] ? n : e;
      return ts(t, l) ? `${i}${h("default")}` : i
    }
    return i ? `${e}${h("default")}` : e
  }
  return "*" === t ? (s ? !i : is[String(a(o))]) ? r : e : `${e}${h(t)}`
}
...
function gn(e, t, i, {
  ...
  if (e) {
    if (t) return i ? `Object.defineProperties(exports,${s}${n([["__esModule",mn(n)],[null,`[Symbol.toStringTag]:${s}${xs(n)}`]],{lineBreakIndent:null})});` : `Object.defineProperty(exports,${s}'__esModule',${s}${mn(n)});`;
    if (i) return `Object.defineProperty(exports,${s}Symbol.toStringTag,${s}${xs(n)});`
  }
  return ""
}
const yn = (e, t, i, {
  ...
  for (const {
    ...
    if (r) {
      for (const {
        ...
        of [...s || [], ...h || []])
        if ("*" === e && "*" !== t) {
          o || p(l, "_interopNamespaceDefaultOnly", a);
          break
        }
    } else {
      const e = String(t(n));
      ...
      for (const {
        ...
        of [...s || [], ...h || []]) {
        let s, h;
        "default" === t ? r || (r = !0, i !== l && (h = i, s = es[e])) : "*" === t && "*" !== n && (o || (o = !0, s = is[e], h = l)), s && p(h, s, a)
      }
    } return `${ns(u,r,a,o,i,s,n)}${d.length>0?`${d.join(c)}${c}${c}`:""}`
}
...
function vn(e, t) {
  ...
  i.length && e({
    ...
    message: `Creating a browser bundle that depends on Node.js built-in modules (${oe(i)}). You might need to include https://github.com/FredKSchott/rollup-plugin-polyfill-node`,
    modules: i
  })
}
...
const Pn = ({
  ...
  Cn = (e, t, i) => _n(e.filter((e => e.hoisted)).map((e => ({
    name: e.exported,
    value: e.local
  }))), t, i);
...
const Nn = (e, t, i) => _n(e.filter((e => e.expression)).map((e => ({
    name: e.exported,
    value: e.local
  }))), t, i),
  $n = (e, t, i) => _n(e.filter((e => "_missingExportShim" === e.local)).map((e => ({
    name: e.exported,
...
var On = {
  amd: function(e, {
    ...
    vn(p, i);
    const v = i.map((e => `'${En(e.id,f.forceJsExtensionForImports)}'`)),
      S = i.map((e => e.name)),
      {
        n: A,
    ...
    const k = dn(f, r),
      ...
      C = b ? `${P}'use strict';` : "";
    e.prepend(`${o}${xn(i,x,g,y,E,t,a,d)}`);
    const _ = pn(s, i, c, x, d, a, g);
    let N = gn(c && n, l && m, h && E, d);
    return N && (N = A + A + N), e.append(`${_}${N}${u}`), e.indent(a).prepend(`${f.define}(${w}(${I(S,{isAsync:!1,name:null})}{${C}${A}${A}`).append(`${A}${A}}));`)
  },
  cjs: function(e, {
    accessedGlobals: t,
    dependencies: i,
    ...
    const A = function(e, {
      ...
      I = xn(i, g, f, m, y, t, r, u);
    e.prepend(`${v}${a}${S}${A}${I}`);
    const P = pn(s, i, h, g, u, r, f, `module.exports${E}=${E}`);
    return e.append(`${P}${c}`)
  },
  es: function(e, {
    accessedGlobals: t,
    ...
    p.length > 0 && (s += p.join(d) + d + d), (s += ns(null, t, i, o, l, h, c)) && e.prepend(s);
    const f = function(e, {
      _: t,
      cnst: i
    }) {
  ...
  iife: function(e, {
    ...
    if (x && k && (_e(w = x) || Ce.test(w))) return pe({
    ...
    vn(c, i);
    const C = In(i),
      _ = C.map((e => e.globalName || "null")),
      N = C.map((e => e.name));
    n && !x && c({
      code: "MISSING_NAME_OPTION_FOR_IIFE_EXPORT",
      message: 'If you do not supply "output.name", you may not be able to access the exports of an IIFE bundle.'
    }), o && n && (p ? (_.unshift(`this${Sn(x,A)}${v}=${v}this${Sn(x,A)}${v}||${v}{}`), N.unshift("exports")) : (_.unshift("{}"), N.unshift("exports")));
    const $ = b ? `${r}'use strict';${I}` : "",
      T = xn(i, y, m, f, E, t, r, h);
    e.prepend(`${a}${T}`);
    let O = `(${S(N,{isAsync:!1,name:null})}{${I}${$}${I}`;
    n && (!x || p && o || (O = (k ? `var ${x}` : `this${Sn(x,A)}`) + `${v}=${v}${O}`), P && (O = function(e, t, i, {
      _: s,
      getPropertyAccess: n,
      s: r
    }, a) {
    ...
    let R = `${I}${I}})(${_.join(`,${v}`)});`;
    n && !p && o && (R = `${I}${I}${r}return exports;${R}`);
    const M = pn(s, i, o, y, h, r, m);
    let D = gn(o && n, d, E, h);
    return D && (D = I + I + D), e.append(`${M}${D}${l}`), e.indent(r).prepend(O).append(R)
  },
  system: function(e, {
    accessedGlobals: t,
    dependencies: i,
    ...
    let k = `System.register(${I}[` + i.map((({
      id: e
    }) => `'${e}'`)).join(`,${g}`) + `],${g}(${x(P,{isAsync:!1,name:null})}{${E}${r}${f?"'use strict';":""}` + kn(A, r, o) + wn(v, r, o) + `${E}${r}return${g}{${S.length?`${E}${r}${r}setters:${g}[${S.map((e=>e?`${y(["module"],{isAsync:!1,name:null})}{${E}${r}${r}${r}${e}${E}${r}${r}}`:m?"null":`${y([],{isAsync:!1,name:null})}{}`)).join(`,${g}`)}],`:""}${E}`;
    k += `${r}${r}execute:${g}(${x([],{isAsync:h,name:null})}{${E}${E}`;
    const w = `${r}${r}})${E}${r}}${b}${E}}));`;
    return e.prepend(a + ns(null, t, r, o, c, u, p) + Cn(s, r, o)), e.append(`${l}${E}${E}` + Nn(s, r, o) + $n(s, r, o)), e.indent(`${r}${r}${r}`).append(w).prepend(k)
  },
  umd: function(e, {
    accessedGlobals: t,
    dependencies: i,
    ...
    vn(u, i);
    const O = i.map((e => `'${En(e.id,d.forceJsExtensionForImports)}'`)),
      R = i.map((e => `require('${e.id}')`)),
      M = In(i),
      D = M.map((e => Tn(e.globalName, T, C))),
      L = M.map((e => e.name));
    l && (n || S) && (O.unshift("'exports'"), R.unshift("exports"), D.unshift(An(E, T, v, (m ? `${Tn(E,T,C)}${I}||${I}` : "") + "{}", c)), L.unshift("exports"));
    const V = dn(d, r),
    ...
    if (S) {
      const e = p ? "e" : "exports";
      let t;
      if (!l && n) t = `${P} ${e}${I}=${I}${An(E,T,v,`${$}(${D.join(`,${I}`)})`,c)};`;
      else {
        t = `${P} ${e}${I}=${I}${D.shift()};${_}${a}${a}${$}(${[e].concat(D).join(`,${I}`)});`
      }
      U = `(${k([],{isAsync:!1,name:null})}{${_}${a}${a}${P} current${I}=${I}${function(e,t,{_:i,getPropertyAccess:s}){let n=t;return e.split(".").map((e=>n+=s(e))).join(`
      $ {
        i
      } && $ {
        i
      }
      `)}(E,T,c)};${_}${a}${a}${t}${_}${a}${a}${e}.noConflict${I}=${I}${k([],{isAsync:!1,name:null})}{${I}${Tn(E,T,C)}${I}=${I}current;${I}return ${e}${N}${I}};${_}${a}})()`
    } else U = `${$}(${D.join(`,${I}`)})`, !l && n && (U = An(E, T, v, U, c));
    ...
    const W = G ? `this,${I}` : "",
      ...
      K = G ? ")" : "",
      X = G ? `${a}typeof exports${I}===${I}'object'${I}&&${I}typeof module${I}!==${I}'undefined'${I}?${I}${z}${$}(${R.join(`,${I}`)})${I}:${_}` : "",
      Y = `(${w(H,{isAsync:!1,name:null})}{${_}` + X + `${a}typeof ${F}${I}===${I}'function'${I}&&${I}${F}.amd${I}?${I}${F}(${B}${$})${I}:${_}` + `${a}${q}${U}${K};${_}` + `})(${W}(${w(L,{isAsync:!1,name:null})}{${j}${_}`,
      Q = _ + _ + "}));";
    e.prepend(`${o}${xn(i,x,g,y,b,t,a,c)}`);
    const J = pn(s, i, l, x, c, a, g);
    let Z = gn(l && n, f, b, c);
    return Z && (Z = _ + _ + Z), e.append(`${J}${Z}${h}`), e.trim().indent(a).append(Q).prepend(Y)
  }
};
class Rn {
  constructor(e, t) {
    ...
    for (const a of this.mappings) {
      ...
      for (const r of a) {
        ...
        if (l) {
          ...
          else if (null != u && i[p] !== u) return pe({
...
function Dn(e) {
  return function(t, i) {
    return i.mappings ? new Mn(i, [t]) : (e({
...
function Ln(e, t, i, s, n) {
  ...
  if (i) {
    const t = i.sources,
      ...
      n = N(e) || ".",
      a = i.sourceRoot || ".",
      o = t.map(((e, t) => new Rn(O(n, a, e), s[t])));
    r = new Mn(i, o)
  } else r = new Rn(e, t);
  return s.reduce(n, r)
}
...
Vn.inherits = Un, Vn.toArray = function(e, t) {
  ...
  if ("string" == typeof e)
    if (t) {
      ...
      for (var s = 0, n = 0; n < e.length; n++) {
        ...
        r < 128 ? i[s++] = r : r < 2048 ? (i[s++] = r >> 6 | 192, i[s++] = 63 & r | 128) : Gn(e, n) ? (r = 65536 + ((1023 & r) << 10) + (1023 & e.charCodeAt(++n)), i[s++] = r >> 18 | 240, i[s++] = r >> 12 & 63 | 128, i[s++] = r >> 6 & 63 | 128, i[s++] = 63 & r | 128) : (i[s++] = r >> 12 | 224, i[s++] = r >> 6 & 63 | 128, i[s++] = 63 & r | 128)
      } else
        for (n = 0; n < e.length; n++) i[n] = 0 | e[n];
  return i
}, Vn.toHex = function(e) {
  for (var t = "", i = 0; i < e.length; i++) t += Wn(e[i].toString(16));
  return t
}, Vn.htonl = Hn, Vn.toHex32 = function(e, t) {
  for (var i = "", s = 0; s < e.length; s++) {
    var n = e[s];
    "little" === t && (n = Hn(n)), i += qn(n.toString(16))
  }
  return i
  ...
  return t + s >>> 0
}, Vn.sum64_4_hi = function(e, t, i, s, n, r, a, o) {
  var l = 0,
    h = t;
  return l += (h = h + s >>> 0) < t ? 1 : 0, l += (h = h + r >>> 0) < r ? 1 : 0, e + i + n + a + (l += (h = h + o >>> 0) < o ? 1 : 0) >>> 0
}, Vn.sum64_4_lo = function(e, t, i, s, n, r, a, o) {
  return t + s + r + o >>> 0
}, Vn.sum64_5_hi = function(e, t, i, s, n, r, a, o, l, h) {
  var c = 0,
    u = t;
  return c += (u = u + s >>> 0) < t ? 1 : 0, c += (u = u + r >>> 0) < r ? 1 : 0, c += (u = u + o >>> 0) < o ? 1 : 0, e + i + n + a + l + (c += (u = u + h >>> 0) < h ? 1 : 0) >>> 0
}, Vn.sum64_5_lo = function(e, t, i, s, n, r, a, o, l, h) {
  return t + s + r + o + h >>> 0
...
xr.blockSize = 512, xr.outSize = 256, xr.hmacStrength = 192, xr.padLength = 64, xr.prototype._update = function(e, t) {
  ...
  for (; s < i.length; s++) i[s] = lr(mr(i[s - 2]), i[s - 7], fr(i[s - 15]), i[s - 16]);
  var n = this.h[0],
    r = this.h[1],
    a = this.h[2],
    o = this.h[3],
  ...
  for (ar(this.k.length === i.length), s = 0; s < i.length; s++) {
    var d = hr(u, pr(l), cr(l, h, c), this.k[s], i[s]),
      p = or(dr(n), ur(n, r, a));
    u = c, c = h, h = l, l = or(o, d), o = a, a = r, r = n, n = or(d, p)
  }
  this.h[0] = or(this.h[0], n), this.h[1] = or(this.h[1], r), this.h[2] = or(this.h[2], a), this.h[3] = or(this.h[3], o), this.h[4] = or(this.h[4], l), this.h[5] = or(this.h[5], h), this.h[6] = or(this.h[6], c), this.h[7] = or(this.h[7], u)
...
function Ar(e, t, i, s, n, r, a, o, l, h, c, u, d) {
  const p = e.slice().reverse();
  for (const e of p) e.scope.addUsedOutsideNames(s, n, c, u);
  ! function(e, t, i) {
    for (const s of t) {
      for (const t of s.scope.variables.values()) t.included && !(t.renderBaseName || t instanceof Ms && t.getOriginalVariable() !== t) && t.setRenderNames(null, Vt(t.name, e));
      if (i.has(s)) {
        const t = s.namespace;
        t.setRenderNames(null, Vt(t.name, e))
      }
    }
  }(s, p, d), Sr[n](s, i, t, r, a, o, l, h);
  for (const e of p) e.scope.deconflict(n, c, u)
}

function Ir(e, t, i, s, n, r, a, o) {
  for (const t of i.dependencies)(n || t instanceof $e) && (t.variableName = Vt(t.suggestedVariableName, e));
  for (const i of t) {
    const t = i.module,
      s = i.name;
    i.isNamespace && (n || t instanceof $e) ? i.setRenderNames(null, (t instanceof $e ? t : a.get(t)).variableName) : t instanceof $e && "default" === s ? i.setRenderNames(null, Vt([...t.exportedVariables].some((([e, t]) => "*" === t && e.included)) ? t.suggestedVariableName + "__default" : t.suggestedVariableName, e)) : i.setRenderNames(null, Vt(s, e))
  }
  for (const t of o) t.setRenderNames(null, Vt(t.name, e))
}
...
function Pr(e, t, {
  ...
  for (const t of n) t.variableName = Vt(t.suggestedVariableName, e);
  for (const t of s) t.namespaceVariableName = Vt(`${t.suggestedVariableName}__namespace`, e);
  for (const t of i) s.has(t) && ss(String(r(t.id)), o) ? t.defaultVariableName = t.namespaceVariableName : t.defaultVariableName = Vt(`${t.suggestedVariableName}__default`, e);
  for (const e of t) {
    const t = e.module;
    if (t instanceof $e) {
      const i = e.name;
      if ("default" === i) {
        const i = String(r(t.id)),
          s = es[i] ? t.defaultVariableName : t.variableName;
        ts(i, o) ? e.setRenderNames(s, "default") : e.setRenderNames(null, s)
      } else "*" === i ? e.setRenderNames(null, is[String(r(t.id))] ? t.namespaceVariableName : t.variableName) : e.setRenderNames(t.variableName, null)
    } else {
      const i = l.get(t);
...
function Nr(e, {
  ...
  if ("default" === t) {
    if (1 !== o.length || "default" !== o[0]) return pe(ye("default", o, r))
  } else if ("none" === t && o.length) return pe(ye("none", o, r));
  return "auto" === t && (0 === o.length ? t = "none" : 1 === o.length && "default" === o[0] ? ("cjs" === s && n.has("exports") && a(function(e) {
    const t = he(e);
    return {
      code: me.PREFER_NAMED_EXPORTS,
      id: e,
...
function Tr(e, t, i, s, n) {
  ...
  for (const e of r) {
    ...
    const r = n.get(e);
    r === s ? i.has(e) || (i.add(e), Tr(e, t, i, s, n)) : t.push(r)
  }
}
...
function Or(e) {
  ...
  const i = "string" == typeof e.mappings ? function(e) {
    for (var i = [], s = [], r = [0, 0, 0, 0, 0], a = 0, o = 0, l = 0, h = 0; o < e.length; o++) {
      var c = e.charCodeAt(o);
      if (44 === c) n(s, r, a), a = 0;
      else if (59 === c) n(s, r, a), a = 0, i.push(s), s = [], r[0] = 0;
      else {
        var u = t[c];
        ...
        if (h += (u &= 31) << l, d) l += 5;
          ...
          var p = 1 & h;
          h >>>= 1, p && (h = 0 === h ? -2147483648 : -h), r[a] += h, a++, h = l = 0
        }
      }
    }
    return n(s, r, a), i.push(s), i
...
const Rr = Symbol("bundleKeys"),
  Mr = {
    type: "placeholder"
  };

function Dr(e, t, i) {
  return ce(e) ? pe(Ae(`Invalid pattern "${e}" for "${t}", patterns can be neither absolute nor relative paths. If you want your files to be stored in a subdirectory, write its name without a leading slash like this: subdirectory/pattern.`)) : e.replace(/\[(\w+)\]/g, ((e, s) => {
    if (!i.hasOwnProperty(s)) return pe(Ae(`"[${s}]" is not a valid placeholder in "${t}" pattern.`));
    const n = i[s]();
    return ce(n) ? pe(Ae(`Invalid substitution "${n}" for placeholder "[${s}]" in "${t}" pattern, can be neither absolute nor relative path.`)) : n
  }))
}
...
class Fr {
  ...
  static generateFacade(e, t, i, s, n, r, a, o, l, h) {
    const c = new Fr([], e, t, i, s, n, r, a, o, null);
    c.assignFacadeName(h, l), a.has(l) || a.set(l, c);
    for (const e of l.getDependenciesToBeIncluded()) c.dependencies.add(e instanceof ln ? r.get(e) : e);
  ...
  generateExports() {
    ...
    this.outputOptions.minifyInternalExports ? function(e, t, i) {
      ...
      for (const n of e) {
        ...
        if (t.has(e))
          do {
            e = Lt(++s), 49 === e.charCodeAt(0) && (s += 9 * 64 ** (e.length - 1), e = Lt(s))
  ...
  generateFacades() {
    ...
    for (const e of i) {
      ...
      for (const s of i) t.push(Fr.generateFacade(this.inputOptions, this.outputOptions, this.unsetOptions, this.pluginDriver, this.modulesById, this.chunkByModule, this.facadeChunkByModule, this.includedNamespaces, e, s))
    }
    for (const t of this.dynamicEntryModules) t.info.syntheticNamedExports || (!this.facadeModule && this.canModuleBeFacade(t, s) ? (this.facadeModule = t, this.facadeChunkByModule.set(t, this), this.strictFacade = !0, this.dynamicName = zr(t)) : this.facadeModule === t && !this.strictFacade && this.canModuleBeFacade(t, s) ? this.strictFacade = !0 : (null === (e = this.facadeChunkByModule.get(t)) || void 0 === e ? void 0 : e.strictFacade) || (this.includedNamespaces.add(t), this.exports.add(t.namespace)));
  ...
  generateId(e, t, i, s) {
    ...
    return Lr(Dr("function" == typeof n ? n(this.getChunkInfo()) : n, r, {
      format: () => t.format,
  ...
  generateIdPreserveModules(e, t, i, s) {
    const [{
      id: n
    }] = this.orderedModules, r = this.outputOptions.sanitizeFileName(n.split(jr, 1)[0]);
    let a;
    ...
    if (k(r)) {
      const i = N(r),
        s = $(r),
        n = `${i}/${Dr(l,"output.entryFileNames",{assetExtname:()=>Vr.includes(s)?"":s,ext:()=>s.substring(1),extname:()=>s,format:()=>t.format,name:()=>this.getChunkName()})}`,
        {
          preserveModulesRoot: o
        } = t;
      a = o && O(n).startsWith(o) ? n.slice(o.length).replace(/^[\\/]/, "") : T(e, n)
    } else {
      const e = $(r);
      a = `_virtual/${Dr(l,"output.entryFileNames",{assetExtname:()=>Vr.includes(e)?"":e,ext:()=>e.substring(1),extname:()=>e,format:()=>t.format,name:()=>le(r)})}`
    }
    return Lr(C(a), i)
  }
  getChunkInfo() {
  ...
  getChunkInfoWithFileNames() {
    return Object.assign(this.getChunkInfo(), {
      code: void 0,
      dynamicImports: Array.from(this.dynamicDependencies, Hs),
      fileName: this.id,
      implicitlyLoadedBefore: Array.from(this.implicitlyLoadedBefore, Hs),
      importedBindings: this.getImportedBindingsPerDependency(),
      imports: Array.from(this.dependencies, Hs),
      map: void 0,
  ...
  preRender(e, t, i) {
    ...
    if (e.hoistTransitiveImports && !this.outputOptions.preserveModules && null !== this.facadeModule)
      for (const e of this.dependencies) e instanceof Fr && this.inlineChunkDependencies(e);
    ...
    for (const t of this.orderedModules) {
      ...
      if (t.isIncluded() || this.includedNamespaces.has(t)) {
        ...
        if (this.includedNamespaces.has(t) && !this.outputOptions.preserveModules) {
          ...
          n.renderFirst() ? l += r + e : a.addSource(new x(e))
        }
      }
      const {
        renderedExports: s,
  ...
  async render(e, t, i, s) {
    ...
    const n = e.format,
      r = On[n];
    e.dynamicImportFunction && "es" !== n && this.inputOptions.onwarn(xe("output.dynamicImportFunction", "outputdynamicImportFunction", 'this option is ignored for formats other than "es"'));
    for (const e of this.dependencies) {
      const t = this.renderedDependencies.get(e);
      if (e instanceof $e) {
        const i = e.renderPath;
        t.id = _r(e.renormalizeRenderPath ? de(this.id, i, !1, !1) : i)
      } else t.namedExportsMode = "default" !== e.exportMode, t.id = _r(de(this.id, e.id, !1, !0))
    }
    ...
    if (null !== o && "es" !== n && "system" !== n) return pe({
    ...
    if (e.sourcemap) {
      let t;
      en("sourcemap", 2), t = e.file ? O(e.sourcemapFile || e.file) : e.dir ? O(e.dir, this.id) : O(this.id);
      const i = c.generateDecodedMap({});
      d = function(e, t, i, s, n, r) {
        const a = Dn(r),
          o = i.filter((e => !e.excludeFromSourcemap)).map((e => Ln(e.id, e.originalCode, e.originalSourcemap, e.sourcemapChain, a))),
          l = new Mn(t, o),
          c = s.reduce(a, l);
        let {
          sources: u,
        ...
        if (e) {
          const t = N(e);
          u = u.map((e => T(t, e))), e = _(e)
        }
        return d = n ? null : d, new h({
          file: e,
          mappings: f,
          names: p,
          sources: u,
        ...
        if (s) {
          const e = s(i, `${t}.map`);
          return "string" != typeof e && pe(Ae("sourcemapPathTransform function must return a string.")), e
        }
        return i
      ...
      do {
        if (l = t.alternativeReexportModules.get(e), l) {
          ...
          h && h !== o && this.inputOptions.onwarn((s = i.getExportNamesByVariable().get(e)[0], n = i.id, r = l.id, a = t.id, {
            code: me.CYCLIC_CROSS_CHUNK_REEXPORT,
            exporter: n,
            importer: a,
  ...
  computeContentHashWithDependencies(e, t, i) {
    ...
    for (const r of n)
      if (r instanceof $e ? s.update(`:${r.renderPath}`) : (s.update(r.getRenderedHash()), s.update(r.generateId(e, t, i, !1))), !(r instanceof $e))
  ...
  ensureReexportsAreAvailableForModule(e) {
    ...
    for (const s of i.keys()) {
      const i = s instanceof Us,
        n = i ? s.getBaseVariable() : s;
      if (!(n instanceof js && this.outputOptions.preserveModules)) {
  ...
  finaliseDynamicImports(e, t) {
    ...
    for (const [e, s] of this.renderedModuleSources)
      for (const {
        ...
        const o = r instanceof ln ? `'${_r(de(this.id,(a||e).id,i,!0))}'` : r instanceof $e ? `'${_r(r.renormalizeRenderPath?de(this.id,r.renderPath,i,!1):r.renderPath)}'` : r;
        n.renderFinalResolution(s, o, r instanceof ln && !(null == a ? void 0 : a.strictFacade) && e.exportNamesByVariable.get(r.namespace)[0], t)
      }
  }
  ...
  getChunkDependencyDeclarations(e, t) {
    ...
    for (const t of this.dependencies) {
      const r = i.get(t) || null,
        a = s.get(t) || null,
        o = t instanceof $e || "default" !== t.exportMode;
      n.set(t, {
        defaultVariableName: t.defaultVariableName,
        globalName: t instanceof $e && ("umd" === e.format || "iife" === e.format) && Br(t, e.globals, null !== (r || a), this.inputOptions.onwarn),
        id: void 0,
        imports: r,
        isChunk: t instanceof Fr,
        name: t.variableName,
        namedExportsMode: o,
    ...
    for (const s of this.getExportNames()) {
      ...
      if (n instanceof Dt) {
        for (const e of n.declarations)
          if (e.parent instanceof qi || e instanceof Ki && e.declaration instanceof qi) {
            a = !0;
            break
          }
      } else n instanceof Us && (r = o, "es" === e && (o = n.renderName));
      i.push({
        exported: s,
        expression: r,
        hoisted: a,
  ...
  getDependenciesToBeDeconflicted(e, t, i) {
    ...
    for (const t of [...this.exportNamesByVariable.keys(), ...this.imports])
      if (e || t.isNamespace) {
        const a = t.module;
        if (a instanceof $e) s.add(a), e && ("default" === t.name ? es[String(i(a.id))] && n.add(a) : "*" === t.name && is[String(i(a.id))] && r.add(a));
        else {
  ...
  getImportSpecifiers(e) {
    ...
    for (const s of this.imports) {
      ...
      let r, a;
      if (n instanceof $e) {
        if (r = n, a = s.name, "default" !== a && "*" !== a && "defaultOnly" === t(n.id)) return pe(ve(n.id, a, !1))
  ...
  getReexportSpecifiers() {
    ...
    for (let s of this.getExportNames()) {
      ...
      if ("*" === s[0]) {
        ...
        "defaultOnly" === t(i) && this.inputOptions.onwarn(Se(i)), a = e, n = this.modulesById.get(i), r = s = "*"
      } else {
        const i = this.exportsByName.get(s);
        if (i instanceof Us) continue;
        const o = i.module;
        if (o instanceof ln) {
          if (n = this.chunkByModule.get(o), n === this) continue;
          r = n.getVariableExportName(i), a = i.isReassigned
        } else {
          if (n = o, r = i.name, "default" !== r && "*" !== r && "defaultOnly" === t(o.id)) return pe(ve(o.id, r, !0));
          a = e && ("default" !== r || ts(String(t(o.id)), !0))
        }
      }
      R(i, n, (() => [])).push({
        imported: r,
  ...
  inlineChunkDependencies(e) {
    for (const t of e.dependencies) this.dependencies.has(t) || (this.dependencies.add(t), t instanceof Fr && this.inlineChunkDependencies(t))
  }
  ...
  setExternalRenderPaths(e, t) {
    for (const i of [...this.dependencies, ...this.dynamicDependencies]) i instanceof $e && i.setRenderPath(e, t)
  }
  setIdentifierRenderResolutions({
    ...
    for (const t of this.getExportNames()) {
      ...
      "es" !== e && "system" !== e && i.isReassigned && !i.isId ? i.setRenderNames("exports", t) : i instanceof Us ? s.add(i) : i.setRenderNames(null, null)
    }
    for (const e of this.orderedModules)
    ...
    switch (this.needsExportsShim && n.add("_missingExportShim"), i && n.add("Symbol"), e) {
      case "system":
      ...
      default:
        n.add("exports");
        for (const e of ys) n.add(e)
    }
    Ar(this.orderedModules, this.getDependenciesToBeDeconflicted("es" !== e && "system" !== e, "amd" === e || "umd" === e || "iife" === e, t), this.imports, n, e, t, this.outputOptions.preserveModules, this.outputOptions.externalLiveBindings, this.chunkByModule, s, this.exportNamesByVariable, this.accessedGlobalsByScope, this.includedNamespaces)
  }
  setUpChunkImportsAndExportsForModule(e) {
    ...
    for (let i of t) {
      ...
      t !== this && (this.imports.add(i), !(i instanceof js && this.outputOptions.preserveModules) && i.module instanceof ln && (t.exports.add(i), this.checkCircularDependencyImport(i, e)))
    ...
    for (const {
      ...
      of e.dynamicImports) t.included && i instanceof ln && this.chunkByModule.get(i) === this && !this.includedNamespaces.has(i) && (this.includedNamespaces.add(i), this.ensureReexportsAreAvailableForModule(i))
  }
}
...
function zr(e) {
  ...
  return null !== (n = null !== (i = null === (t = e.chunkNames.find((({
    isUserDefined: e
  }) => e))) || void 0 === t ? void 0 : t.name) && void 0 !== i ? i : null === (s = e.chunkNames[0]) || void 0 === s ? void 0 : s.name) && void 0 !== n ? n : le(e.id)
}
const jr = /[?#]/,
  Ur = (e, t) => t ? `${e}\n${t}` : e,
  Gr = (e, t) => t ? `${e}\n\n${t}` : e;
...
function Hr(e, t) {
  ...
  const r = new Map,
    {
      ...
      for (const e of s) {
        ...
        for (const r of n) {
          R(i, r, (() => new Set)).add(e);
          for (const e of r.getDependenciesToBeIncluded()) e instanceof $e || n.add(e);
          for (const {
              resolution: e
            }
            of r.dynamicImports) e instanceof ln && e.includedDynamicImporters.length > 0 && (t.add(e), s.add(e));
  ...
  function c(e, t) {
    ...
    for (const n of i) {
      ...
      if (!t || !u(t, a.get(n))) {
        o.add(e);
        for (const e of n.getDependenciesToBeIncluded()) e instanceof $e || s.has(e) || i.add(e)
      }
    }
  }
...
function Wr(e, t, i) {
  ...
  for (const e of s) {
    i.add(e), t.push(e);
    for (const t of e.dependencies) t instanceof $e || i.has(t) || s.add(t)
  }
}
...
function Kr(e, t, i) {
  const s = Symbol(e.id),
    n = [he(e.id)];
  let r = t;
  for (e.cycles.add(s); r !== e;) r.cycles.add(s), n.push(he(r.id)), r = i.get(r);
...
class Qr {
  ...
  async generate(e) {
    ...
    const t = Object.create(null),
      i = (e => {
        ...
        return new Proxy(e, {
          ...
          get: (e, i) => i === Rr ? t : Reflect.get(e, i),
    ...
    try {
      ...
      e.length > 1 && function(e, t) {
        if ("umd" === e.format || "iife" === e.format) return pe(xe("output.format", "outputformat", "UMD and IIFE output formats are not supported for code-splitting builds", e.format));
        if ("string" == typeof e.file) return pe(xe("output.file", "outputdir", 'when building multiple chunks, the "output.dir" option must be used, not "output.file". To inline dynamic imports, set the "inlineDynamicImports" option'));
        if (e.sourcemapFile) return pe(xe("output.sourcemapFile", "outputsourcemapfile", '"output.sourcemapFile" is only supported for single-file builds'));
        !e.amd.autoId && e.amd.id && t(xe("output.amd.id", "outputamd", 'this option is only properly supported for single-file builds. Use "output.amd.autoId" and "output.amd.basePath" instead'))
      ...
      const t = function(e) {
        ...
        const t = [];
        for (const i of e)
          for (const e of i.entryModules) k(e.id) && t.push(e.id);
        return t
      }(e));
      tn("generate chunks", 2), en("render modules", 2);
      const s = await async function(e, t) {
        try {
          let [i, s, n, r] = await Promise.all([t.hookReduceValue("banner", e.banner(), [], Ur), t.hookReduceValue("footer", e.footer(), [], Ur), t.hookReduceValue("intro", e.intro(), [], Gr), t.hookReduceValue("outro", e.outro(), [], Gr)]);
          return n && (n += "\n\n"), r && (r = `\n\n${r}`), i.length && (i += "\n"), s.length && (s = "\n" + s), {
            banner: i,
            footer: s,
            intro: n,
      ...
      }(this.outputOptions, this.pluginDriver), n = function({
        compact: e,
        generatedCode: {
          arrowFunctions: t,
          constBindings: i,
        ...
        const {
          ...
          lineBreakIndent: s,
          name: n
        }) => [`${c(e,{isAsync:!1,name:n})}${t?s?`${a}${s.base}${s.t}`:"":`{${s?`${a}${s.base}${s.t}`:r}${i?"return ":""}`}`, t ? `${n?";":""}${s?`${a}${s.base}`:""}` : `${o}${s?`${a}${s.base}`:r}}`], d = n ? e => Yr.test(e) : e => !we.has(e) && Yr.test(e);
        return {
          _: r,
          cnst: l,
      ...
      this.prerenderChunks(e, t, n), tn("render modules", 2), await this.addFinalizedChunksToBundle(e, t, s, i, n)
    } catch (e) {
  ...
  assignChunkIds(e, t, i, s) {
    ...
    const a = n.concat(r);
    for (const e of a) this.outputOptions.file ? e.id = _(this.outputOptions.file) : this.outputOptions.preserveModules ? e.id = e.generateIdPreserveModules(t, this.outputOptions, s, this.unsetOptions) : e.id = e.generateId(i, this.outputOptions, s, !0), s[e.id] = Mr
  }
  assignManualChunks(e) {
    ...
    const s = new Map;
    for (const [e, i] of t) Zr(e, i, s);
    return s
  }
  finaliseAssets(e) {
    for (const t of Object.values(e))
      if (t.type || (Pe('A plugin is directly adding properties to the bundle object in the "generateBundle" hook. This is deprecated and will be removed in a future Rollup version, please use "this.emitFile" instead.', !0, this.inputOptions), t.type = "asset"), this.outputOptions.validate && "code" in t) try {
        this.graph.contextParse(t.code, {
          allowHashBang: !0,
          ecmaVersion: "latest"
        })
      } catch (e) {
        this.inputOptions.onwarn(ge(t, e))
      }
  ...
  async generateChunks() {
    ...
    for (const {
      ...
      of this.outputOptions.inlineDynamicImports ? [{
        alias: null,
        modules: Jr(this.graph.modulesById)
      }] : this.outputOptions.preserveModules ? Jr(this.graph.modulesById).map((e => ({
        alias: null,
        modules: [e]
      }))) : Hr(this.graph.entryModules, t)) {
      n.sort(qr);
      const t = new Fr(n, this.inputOptions, this.outputOptions, this.unsetOptions, this.pluginDriver, this.graph.modulesById, s, this.facadeChunkByModule, this.includedNamespaces, e);
      i.push(t);
...
function Jr(e) {
  return [...e.values()].filter((e => e instanceof ln && (e.isIncluded() || e.info.isEntry || e.includedDynamicImporters.length > 0)))
}

function Zr(e, t, i) {
  const s = i.get(t);
  if ("string" == typeof s && s !== e) return pe((n = t.id, r = e, a = s, {
    code: me.INVALID_CHUNK,
...
var ea = [509, 0, 227, 0, 150, 4, 294, 9, 1368, 2, 2, 1, 6, 3, 41, 2, 5, 0, 166, 1, 574, 3, 9, 9, 370, 1, 154, 10, 50, 3, 123, 2, 54, 14, 32, 10, 3, 1, 11, 3, 46, 10, 8, 0, 46, 9, 7, 2, 37, 13, 2, 9, 6, 1, 45, 0, 13, 2, 49, 13, 9, 3, 2, 11, 83, 11, 7, 0, 161, 11, 6, 9, 7, 3, 56, 1, 2, 6, 3, 1, 3, 2, 10, 0, 11, 1, 3, 6, 4, 4, 193, 17, 10, 9, 5, 0, 82, 19, 13, 9, 214, 6, 3, 8, 28, 1, 83, 16, 16, 9, 82, 12, 9, 9, 84, 14, 5, 9, 243, 14, 166, 9, 71, 5, 2, 1, 3, 3, 2, 0, 2, 1, 13, 9, 120, 6, 3, 6, 4, 0, 29, 9, 41, 6, 2, 3, 9, 0, 10, 10, 47, 15, 406, 7, 2, 7, 17, 9, 57, 21, 2, 13, 123, 5, 4, 0, 2, 1, 2, 6, 2, 0, 9, 9, 49, 4, 2, 1, 2, 4, 9, 9, 330, 3, 19306, 9, 87, 9, 39, 4, 60, 6, 26, 9, 1014, 0, 2, 54, 8, 3, 82, 0, 12, 1, 19628, 1, 4706, 45, 3, 22, 543, 4, 4, 5, 9, 7, 3, 6, 31, 3, 149, 2, 1418, 49, 513, 54, 5, 49, 9, 0, 15, 0, 23, 4, 2, 14, 1361, 6, 2, 16, 3, 6, 2, 1, 2, 4, 262, 6, 10, 9, 357, 0, 62, 13, 1495, 6, 110, 6, 6, 9, 4759, 9, 787719, 239],
  ...
  ia = "ªµºÀ-ÖØ-öø-ˁˆ-ˑˠ-ˤˬˮͰ-ʹͶͷͺ-ͽͿΆΈ-ΊΌΎ-ΡΣ-ϵϷ-ҁҊ-ԯԱ-Ֆՙՠ-ֈא-תׯ-ײؠ-يٮٯٱ-ۓەۥۦۮۯۺ-ۼۿܐܒ-ܯݍ-ޥޱߊ-ߪߴߵߺࠀ-ࠕࠚࠤࠨࡀ-ࡘࡠ-ࡪࡰ-ࢇࢉ-ࢎࢠ-ࣉऄ-हऽॐक़-ॡॱ-ঀঅ-ঌএঐও-নপ-রলশ-হঽৎড়ঢ়য়-ৡৰৱৼਅ-ਊਏਐਓ-ਨਪ-ਰਲਲ਼ਵਸ਼ਸਹਖ਼-ੜਫ਼ੲ-ੴઅ-ઍએ-ઑઓ-નપ-રલળવ-હઽૐૠૡૹଅ-ଌଏଐଓ-ନପ-ରଲଳଵ-ହଽଡ଼ଢ଼ୟ-ୡୱஃஅ-ஊஎ-ஐஒ-கஙசஜஞடணதந-பம-ஹௐఅ-ఌఎ-ఐఒ-నప-హఽౘ-ౚౝౠౡಀಅ-ಌಎ-ಐಒ-ನಪ-ಳವ-ಹಽೝೞೠೡೱೲഄ-ഌഎ-ഐഒ-ഺഽൎൔ-ൖൟ-ൡൺ-ൿඅ-ඖක-නඳ-රලව-ෆก-ะาำเ-ๆກຂຄຆ-ຊຌ-ຣລວ-ະາຳຽເ-ໄໆໜ-ໟༀཀ-ཇཉ-ཬྈ-ྌက-ဪဿၐ-ၕၚ-ၝၡၥၦၮ-ၰၵ-ႁႎႠ-ჅჇჍა-ჺჼ-ቈቊ-ቍቐ-ቖቘቚ-ቝበ-ኈኊ-ኍነ-ኰኲ-ኵኸ-ኾዀዂ-ዅወ-ዖዘ-ጐጒ-ጕጘ-ፚᎀ-ᎏᎠ-Ᏽᏸ-ᏽᐁ-ᙬᙯ-ᙿᚁ-ᚚᚠ-ᛪᛮ-ᛸᜀ-ᜑᜟ-ᜱᝀ-ᝑᝠ-ᝬᝮ-ᝰក-ឳៗៜᠠ-ᡸᢀ-ᢨᢪᢰ-ᣵᤀ-ᤞᥐ-ᥭᥰ-ᥴᦀ-ᦫᦰ-ᧉᨀ-ᨖᨠ-ᩔᪧᬅ-ᬳᭅ-ᭌᮃ-ᮠᮮᮯᮺ-ᯥᰀ-ᰣᱍ-ᱏᱚ-ᱽᲀ-ᲈᲐ-ᲺᲽ-Ჿᳩ-ᳬᳮ-ᳳᳵᳶᳺᴀ-ᶿḀ-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼⁱⁿₐ-ₜℂℇℊ-ℓℕ℘-ℝℤΩℨK-ℹℼ-ℿⅅ-ⅉⅎⅠ-ↈⰀ-ⳤⳫ-ⳮⳲⳳⴀ-ⴥⴧⴭⴰ-ⵧⵯⶀ-ⶖⶠ-ⶦⶨ-ⶮⶰ-ⶶⶸ-ⶾⷀ-ⷆⷈ-ⷎⷐ-ⷖⷘ-ⷞ々-〇〡-〩〱-〵〸-〼ぁ-ゖ゛-ゟァ-ヺー-ヿㄅ-ㄯㄱ-ㆎㆠ-ㆿㇰ-ㇿ㐀-䶿一-ꒌꓐ-ꓽꔀ-ꘌꘐ-ꘟꘪꘫꙀ-ꙮꙿ-ꚝꚠ-ꛯꜗ-ꜟꜢ-ꞈꞋ-ꟊꟐꟑꟓꟕ-ꟙꟲ-ꠁꠃ-ꠅꠇ-ꠊꠌ-ꠢꡀ-ꡳꢂ-ꢳꣲ-ꣷꣻꣽꣾꤊ-ꤥꤰ-ꥆꥠ-ꥼꦄ-ꦲꧏꧠ-ꧤꧦ-ꧯꧺ-ꧾꨀ-ꨨꩀ-ꩂꩄ-ꩋꩠ-ꩶꩺꩾ-ꪯꪱꪵꪶꪹ-ꪽꫀꫂꫛ-ꫝꫠ-ꫪꫲ-ꫴꬁ-ꬆꬉ-ꬎꬑ-ꬖꬠ-ꬦꬨ-ꬮꬰ-ꭚꭜ-ꭩꭰ-ꯢ가-힣ힰ-ퟆퟋ-ퟻ豈-舘並-龎ﬀ-ﬆﬓ-ﬗיִײַ-ﬨשׁ-זּטּ-לּמּנּסּףּפּצּ-ﮱﯓ-ﴽﵐ-ﶏﶒ-ﷇﷰ-ﷻﹰ-ﹴﹶ-ﻼＡ-Ｚａ-ｚｦ-ﾾￂ-ￇￊ-ￏￒ-ￗￚ-ￜ",
  sa = {
  ...
  ra = {
    5: na,
    "5module": na + " export import",
    6: na + " const class extends export import super"
  },
  aa = /^in(stanceof)?$/,
  oa = new RegExp("[" + ia + "]"),
  la = new RegExp("[" + ia + "‌‍·̀-ͯ·҃-֑҇-ׇֽֿׁׂׅׄؐ-ًؚ-٩ٰۖ-ۜ۟-۪ۤۧۨ-ۭ۰-۹ܑܰ-݊ަ-ް߀-߉߫-߽߳ࠖ-࠙ࠛ-ࠣࠥ-ࠧࠩ-࡙࠭-࡛࢘-࢟࣊-ࣣ࣡-ःऺ-़ा-ॏ॑-ॗॢॣ०-९ঁ-ঃ়া-ৄেৈো-্ৗৢৣ০-৯৾ਁ-ਃ਼ਾ-ੂੇੈੋ-੍ੑ੦-ੱੵઁ-ઃ઼ા-ૅે-ૉો-્ૢૣ૦-૯ૺ-૿ଁ-ଃ଼ା-ୄେୈୋ-୍୕-ୗୢୣ୦-୯ஂா-ூெ-ைொ-்ௗ௦-௯ఀ-ఄ఼ా-ౄె-ైొ-్ౕౖౢౣ౦-౯ಁ-ಃ಼ಾ-ೄೆ-ೈೊ-್ೕೖೢೣ೦-೯ഀ-ഃ഻഼ാ-ൄെ-ൈൊ-്ൗൢൣ൦-൯ඁ-ඃ්ා-ුූෘ-ෟ෦-෯ෲෳัิ-ฺ็-๎๐-๙ັິ-ຼ່-ໍ໐-໙༘༙༠-༩༹༵༷༾༿ཱ-྄྆྇ྍ-ྗྙ-ྼ࿆ါ-ှ၀-၉ၖ-ၙၞ-ၠၢ-ၤၧ-ၭၱ-ၴႂ-ႍႏ-ႝ፝-፟፩-፱ᜒ-᜕ᜲ-᜴ᝒᝓᝲᝳ឴-៓៝០-៩᠋-᠍᠏-᠙ᢩᤠ-ᤫᤰ-᤻᥆-᥏᧐-᧚ᨗ-ᨛᩕ-ᩞ᩠-᩿᩼-᪉᪐-᪙᪰-᪽ᪿ-ᫎᬀ-ᬄ᬴-᭄᭐-᭙᭫-᭳ᮀ-ᮂᮡ-ᮭ᮰-᮹᯦-᯳ᰤ-᰷᱀-᱉᱐-᱙᳐-᳔᳒-᳨᳭᳴᳷-᳹᷀-᷿‿⁀⁔⃐-⃥⃜⃡-⃰⳯-⵿⳱ⷠ-〪ⷿ-゙゚〯꘠-꘩꙯ꙴ-꙽ꚞꚟ꛰꛱ꠂ꠆ꠋꠣ-ꠧ꠬ꢀꢁꢴ-ꣅ꣐-꣙꣠-꣱ꣿ-꤉ꤦ-꤭ꥇ-꥓ꦀ-ꦃ꦳-꧀꧐-꧙ꧥ꧰-꧹ꨩ-ꨶꩃꩌꩍ꩐-꩙ꩻ-ꩽꪰꪲ-ꪴꪷꪸꪾ꪿꫁ꫫ-ꫯꫵ꫶ꯣ-ꯪ꯬꯭꯰-꯹ﬞ︀-️︠-︯︳︴﹍-﹏０-９＿]");
...
function ca(e, t) {
  return e < 65 ? 36 === e : e < 91 || (e < 97 ? 95 === e : e < 123 || (e <= 65535 ? e >= 170 && oa.test(String.fromCharCode(e)) : !1 !== t && ha(e, ta)))
}

function ua(e, t) {
  return e < 48 ? 36 === e : e < 58 || !(e < 65) && (e < 91 || (e < 97 ? 95 === e : e < 123 || (e <= 65535 ? e >= 170 && la.test(String.fromCharCode(e)) : !1 !== t && (ha(e, ta) || ha(e, ea)))))
}
var da = function(e, t) {
...
var xa = {
    num: new da("num", ma),
    regexp: new da("regexp", ma),
    string: new da("string", ma),
    name: new da("name", ma),
    privateId: new da("privateId", ma),
    eof: new da("eof"),
    bracketL: new da("[", {
      beforeExpr: !0,
      startsExpr: !0
    ...
    questionDot: new da("?."),
    arrow: new da("=>", fa),
    template: new da("template"),
    invalidTemplate: new da("invalidTemplate"),
    ellipsis: new da("...", fa),
    backQuote: new da("`", ma),
    dollarBraceL: new da("${", {
      beforeExpr: !0,
    ...
    _case: ya("case", fa),
    _catch: ya("catch"),
    _continue: ya("continue"),
    _debugger: ya("debugger"),
    _default: ya("default", fa),
    _do: ya("do", {
      isLoop: !0,
      beforeExpr: !0
    }),
    ...
    _function: ya("function", ma),
    _if: ya("if"),
    _return: ya("return", fa),
    _switch: ya("switch"),
    _throw: ya("throw", fa),
    _try: ya("try"),
    _var: ya("var"),
    ...
    _super: ya("super", ma),
    _class: ya("class", ma),
    _extends: ya("extends", fa),
    _export: ya("export"),
    _import: ya("import", ma),
    _null: ya("null", ma),
    _true: ya("true", ma),
    _false: ya("false", ma),
    _in: ya("in", {
...
function Sa(e, t, i) {
  ...
  for (var s = t; s < i; s++) {
    ...
    if (va(n)) return s < i - 1 && 13 === n && 10 === e.charCodeAt(s + 1) ? s + 2 : s + 1
  }
  return -1
}
var Aa = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/,
...
function Va(e) {
  var t = {};
  for (var i in Da) t[i] = e && Ca(e, i) ? e[i] : Da[i];
  if ("latest" === t.ecmaVersion ? t.ecmaVersion = 1e8 : null == t.ecmaVersion ? (!La && "object" == typeof console && console.warn && (La = !0, console.warn("Since Acorn 8.0.0, options.ecmaVersion is required.\nDefaulting to 2020, but this will stop working in the future.")), t.ecmaVersion = 11) : t.ecmaVersion >= 2015 && (t.ecmaVersion -= 2009), null == t.allowReserved && (t.allowReserved = t.ecmaVersion < 5), _a(t.onToken)) {
    var s = t.onToken;
    t.onToken = function(e) {
      return s.push(e)
    }
  }
  return _a(t.onComment) && (t.onComment = function(e, t) {
    return function(i, s, n, r, a, o) {
      ...
      e.locations && (l.loc = new Ra(this, a, o)), e.ranges && (l.range = [n, r]), t.push(l)
    }
  }(t, t.onComment)), t
}
...
ja.strictDirective = function(e) {
  ...
  for (;;) {
    ...
    if ("use strict" === (t[1] || t[2])) {
      ...
      var i = Ia.exec(this.input),
        s = i.index + i[0].length,
        n = this.input.charAt(s);
      return ";" === n || "}" === n || Ea.test(i[0]) && !(/[(`.[+\-/*%<>=,?^&]/.test(n) || "!" === n && "=" === this.input.charAt(s + 1))
    }
...
Ha.isLet = function(e) {
  ...
  var s, n = this.type,
    r = this.startNode();
  switch (this.isLet(e) && (n = xa._var, s = "let"), n) {
    case xa._break:
    case xa._continue:
    ...
    case xa._export:
    case xa._import:
      if (this.options.ecmaVersion > 10 && n === xa._import) {
        Ia.lastIndex = this.pos;
        var a = Ia.exec(this.input),
          o = this.pos + a[0].length,
          l = this.input.charCodeAt(o);
        if (40 === l || 46 === l) return this.parseExpressionStatement(r, this.parseExpression())
      }
      return this.options.allowImportExportEverywhere || (t || this.raise(this.start, "'import' and 'export' may only appear at the top level"), this.inModule || this.raise(this.start, "'import' and 'export' may appear only with 'sourceType: module'")), n === xa._import ? this.parseImport(r) : this.parseExport(r, i);
    default:
      if (this.isAsyncFunction()) return e && this.unexpected(), this.next(), this.parseFunctionStatement(r, !0, !e);
      var h = this.value,
        c = this.parseExpression();
      return n === xa.name && "Identifier" === c.type && this.eat(xa.colon) ? this.parseLabeledStatement(r, h, c, e) : this.parseExpressionStatement(r, c)
  }
  ...
  if (this.labels.push(Wa), this.enterScope(0), this.expect(xa.parenL), this.type === xa.semi) return t > -1 && this.unexpected(t), this.parseFor(e, null);
  var i = this.isLet();
  ...
  for (var i = !1; this.type !== xa.braceR;)
    if (this.type === xa._case || this.type === xa._default) {
      var s = this.type === xa._case;
      t && this.finishNode(t, "SwitchCase"), e.cases.push(t = this.startNode()), t.consequent = [], this.next(), s ? t.test = this.parseExpression() : (i && this.raiseRecoverable(this.lastTokStart, "Multiple default clauses"), i = !0, t.test = null), this.expect(xa.colon)
...
Ha.parseTryStatement = function(e) {
  ...
  for (var a = this.type.isLoop ? "loop" : this.type === xa._switch ? "switch" : null, o = this.labels.length - 1; o >= 0; o--) {
    var l = this.labels[o];
  ...
  for (void 0 === e && (e = !0), void 0 === t && (t = this.startNode()), t.body = [], this.expect(xa.braceL), e && this.enterScope(0); this.type !== xa.braceR;) {
...
Ha.parseFunction = function(e, t, i, s, n) {
  ...
  return this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, this.enterScope(Ba(e.async, e.generator)), t & Xa || (e.id = this.type === xa.name ? this.parseIdent() : null), this.parseFunctionParams(e), this.parseFunctionBody(e, i, !1, n), this.yieldPos = r, this.awaitPos = a, this.awaitIdentPos = o, this.finishNode(e, t & Xa ? "FunctionDeclaration" : "FunctionExpression")
}, Ha.parseFunctionParams = function(e) {
  this.expect(xa.parenL), e.params = this.parseBindingList(xa.parenR, !1, this.options.ecmaVersion >= 8), this.checkYieldAwaitInDefaultParams()
  ...
  var s = this.enterClassBody(),
    n = this.startNode(),
    r = !1;
  for (n.body = [], this.expect(xa.braceL); this.type !== xa.braceR;) {
    var a = this.parseClassElement(null !== e.superClass);
    a && (n.body.push(a), "MethodDefinition" === a.type && "constructor" === a.kind ? (r && this.raise(a.start, "Duplicate constructor in the same class"), r = !0) : a.key && "PrivateIdentifier" === a.key.type && Qa(s, a) && this.raiseRecoverable(a.key.start, "Identifier '#" + a.key.name + "' has already been declared"))
  }
  ...
  if (this.eat(xa.semi)) return null;
  ...
  if (this.eatContextual("static")) {
    if (t >= 13 && this.eat(xa.braceL)) return this.parseClassStaticBlock(i), i;
    this.isClassElementNameStart() || this.type === xa.star ? o = !0 : s = "static"
  }
  if (i.static = o, !s && t >= 8 && this.eatContextual("async") && (!this.isClassElementNameStart() && this.type !== xa.star || this.canInsertSemicolon() ? s = "async" : r = !0), !s && (t >= 9 || !r) && this.eat(xa.star) && (n = !0), !s && !r && !n) {
    var l = this.value;
    (this.eatContextual("get") || this.eatContextual("set")) && (this.isClassElementNameStart() ? a = l : s = l)
  }
  if (s ? (i.computed = !1, i.key = this.startNodeAt(this.lastTokStart, this.lastTokStartLoc), i.key.name = s, this.finishNode(i.key, "Identifier")) : this.parseClassElementName(i), t < 13 || this.type === xa.parenL || "method" !== a || n || r) {
    var h = !i.static && Ja(i, "constructor"),
      c = h && e;
  ...
  this.type === xa.privateId ? ("constructor" === this.value && this.raise(this.start, "Classes can't have an element named '#constructor'"), e.computed = !1, e.key = this.parsePrivateIdent()) : this.parsePropertyName(e)
}, Ha.parseClassMethod = function(e, t, i, s) {
  var n = e.key;
  "constructor" === e.kind ? (t && this.raise(n.start, "Constructor can't be a generator"), i && this.raise(n.start, "Constructor can't be an async method")) : e.static && Ja(e, "prototype") && this.raise(n.start, "Classes may not have a static property named prototype");
  ...
  this.type === xa.name ? (e.id = this.parseIdent(), t && this.checkLValSimple(e.id, 2, !1)) : (!0 === t && this.unexpected(), e.id = null)
}, Ha.parseClassSuper = function(e) {
  e.superClass = this.eat(xa._extends) ? this.parseExprSubscripts(!1) : null
  ...
  if (this.shouldParseExportStatement()) e.declaration = this.parseStatement(null), "VariableDeclaration" === e.declaration.type ? this.checkVariableExport(t, e.declaration.declarations) : this.checkExport(t, e.declaration.id, e.declaration.id.start), e.specifiers = [], e.source = null;
    ...
    if (e.declaration = null, e.specifiers = this.parseExportSpecifiers(t), this.eatContextual("from")) this.type !== xa.string && this.unexpected(), e.source = this.parseExprAtom();
    else {
  ...
  e && ("string" != typeof t && (t = "Identifier" === t.type ? t.name : t.value), Ca(e, t) && this.raiseRecoverable(i, "Duplicate export '" + t + "'"), e[t] = !0)
  ...
  for (this.expect(xa.braceL); !this.eat(xa.braceR);) {
    if (i) i = !1;
    else if (this.expect(xa.comma), this.afterTrailingComma(xa.braceR)) break;
    var s = this.startNode();
  ...
  if (this.type === xa.name) {
    ...
    if (i.local = this.parseIdent(), this.checkLValSimple(i.local, 2), e.push(this.finishNode(i, "ImportDefaultSpecifier")), !this.eat(xa.comma)) return e
  }
...
Za.toAssignable = function(e, t, i) {
  ...
  if (this.options.ecmaVersion >= 6) switch (this.type) {
    case xa.bracketL:
      var e = this.startNode();
      return this.next(), e.elements = this.parseBindingList(xa.bracketR, !0, !0), this.finishNode(e, "ArrayPattern");
    case xa.braceL:
  ...
  for (var s = [], n = !0; !this.eat(e);)
    if (n ? n = !1 : this.expect(xa.comma), t && this.type === xa.comma) s.push(null);
    else {
      if (i && this.afterTrailingComma(e)) break;
      if (this.type === xa.ellipsis) {
        var r = this.parseRestBinding();
        this.parseBindingListItem(r), s.push(r), this.type === xa.comma && this.raise(this.start, "Comma is not permitted after the rest element"), this.expect(e);
        break
      }
  ...
  if (i = i || this.parseBindingAtom(), this.options.ecmaVersion < 6 || !this.eat(xa.eq)) return i;
...
var eo = function(e, t, i, s, n) {
  ...
  to = {
    ...
    p_stat: new eo("(", !1),
    p_expr: new eo("(", !0),
    q_tmpl: new eo("`", !0, !0, (function(e) {
      return e.tryReadTemplateToken()
    })),
    f_stat: new eo("function", !1),
    f_expr: new eo("function", !0),
    f_expr_gen: new eo("function", !0, !1, null, !0),
    f_gen: new eo("function", !1, !1, null, !0)
  },
  io = Fa.prototype;
io.initialContext = function() {
  ...
  var t, i = this.type;
  i.keyword && e === xa.dot ? this.exprAllowed = !1 : (t = i.updateContext) ? t.call(this, e) : this.exprAllowed = i.beforeExpr
  ...
  this.context.push(this.braceIsBlock(e) ? to.b_stat : to.b_expr), this.exprAllowed = !0
}, xa.dollarBraceL.updateContext = function() {
  this.context.push(to.b_tmpl), this.exprAllowed = !0
}, xa.parenL.updateContext = function(e) {
  var t = e === xa._if || e === xa._for || e === xa._with || e === xa._while;
  this.context.push(t ? to.p_stat : to.p_expr), this.exprAllowed = !0
}, xa.incDec.updateContext = function() {}, xa._function.updateContext = xa._class.updateContext = function(e) {
  !e.beforeExpr || e === xa._else || e === xa.semi && this.curContext() !== to.p_stat || e === xa._return && Ea.test(this.input.slice(this.lastTokEnd, this.start)) || (e === xa.colon || e === xa.braceL) && this.curContext() === to.b_stat ? this.context.push(to.f_stat) : this.context.push(to.f_expr), this.exprAllowed = !1
}, xa.backQuote.updateContext = function() {
  this.curContext() === to.q_tmpl ? this.context.pop() : this.context.push(to.q_tmpl), this.exprAllowed = !1
  ...
  var t = !1;
  this.options.ecmaVersion >= 6 && e !== xa.dot && ("of" === this.value && !this.exprAllowed || "yield" === this.value && this.inGeneratorContext()) && (t = !0), this.exprAllowed = t
};
var so = Fa.prototype;
...
so.checkPropClash = function(e, t, i) {
  if (!(this.options.ecmaVersion >= 9 && "SpreadElement" === e.type || this.options.ecmaVersion >= 6 && (e.computed || e.method || e.shorthand))) {
    ...
    if (this.options.ecmaVersion >= 6) "__proto__" === s && "init" === r && (t.proto && (i ? i.doubleProto < 0 && (i.doubleProto = n.start) : this.raiseRecoverable(n.start, "Redefinition of __proto__ property")), t.proto = !0);
      ...
      var a = t[s = "$" + s];
      if (a)("init" === r ? this.strict && a.init || a.get || a.set : a.init || a[r]) && this.raiseRecoverable(n.start, "Redefinition of property");
      else a = t[s] = {
        init: !1,
        get: !1,
        set: !1
  ...
  if (this.type === xa.comma) {
    ...
    for (r.expressions = [n]; this.eat(xa.comma);) r.expressions.push(this.parseMaybeAssign(e, t));
  ...
  var s = !1,
    ...
    r = -1,
    a = -1;
  t ? (n = t.parenthesizedAssign, r = t.trailingComma, a = t.doubleProto, t.parenthesizedAssign = t.trailingComma = -1) : (t = new Ga, s = !0);
  var o = this.start,
    l = this.startLoc;
  ...
  if (i && (h = i.call(this, h, o, l)), this.type.isAssign) {
    ...
    return c.operator = this.value, this.type === xa.eq && (h = this.toAssignable(h, !1, t)), s || (t.parenthesizedAssign = t.trailingComma = t.doubleProto = -1), t.shorthandAssign >= h.start && (t.shorthandAssign = -1), this.type === xa.eq ? this.checkLValPattern(h) : this.checkLValSimple(h), c.left = h, this.next(), c.right = this.parseMaybeAssign(e), a > -1 && (t.doubleProto = a), this.finishNode(c, "AssignmentExpression")
  }
  ...
  if (this.eat(xa.question)) {
    var r = this.startNodeAt(i, s);
    return r.test = n, r.consequent = this.parseMaybeAssign(), this.expect(xa.colon), r.alternate = this.parseMaybeAssign(e), this.finishNode(r, "ConditionalExpression")
  }
  return n
...
}, so.parseExprOp = function(e, t, i, s, n) {
  var r = this.type.binop;
  if (null != r && (!n || this.type !== xa._in) && r > s) {
    var a = this.type === xa.logicalOR || this.type === xa.logicalAND,
      o = this.type === xa.coalesce;
    o && (r = xa.logicalAND.binop);
    var l = this.value;
    this.next();
    var h = this.start,
      c = this.startLoc,
    ...
    return (a && this.type === xa.coalesce || o && (this.type === xa.logicalOR || this.type === xa.logicalAND)) && this.raiseRecoverable(this.start, "Logical expressions and coalesce expressions cannot be mixed. Wrap either by parentheses"), this.parseExprOp(d, t, i, s, n)
  }
  return e
}, so.buildBinary = function(e, t, i, s, n, r) {
  ...
  } else(s || 0 === this.privateNameStack.length) && this.unexpected(), n = this.parsePrivateIdent(), this.type !== xa._in && this.unexpected();
  return i || !this.eat(xa.starstar) ? n : t ? void this.unexpected(this.lastTokStart) : this.buildBinary(r, a, n, this.parseMaybeUnary(null, !1, !1, s), "**", !1)
...
}, so.parseSubscripts = function(e, t, i, s, n) {
...
}, so.parseSubscript = function(e, t, i, s, n, r, a) {
  var o = this.options.ecmaVersion >= 11,
    l = o && this.eat(xa.questionDot);
  s && l && this.raise(this.lastTokStart, "Optional chaining cannot appear in the callee of new expressions");
  var h = this.eat(xa.bracketL);
  if (h || l && this.type !== xa.parenL && this.type !== xa.backQuote || this.eat(xa.dot)) {
    var c = this.startNodeAt(t, i);
    c.object = e, h ? (c.property = this.parseExpression(), this.expect(xa.bracketR)) : this.type === xa.privateId && "Super" !== e.type ? c.property = this.parsePrivateIdent() : c.property = this.parseIdent("never" !== this.options.allowReserved), c.computed = !!h, o && (c.optional = l), e = this.finishNode(c, "MemberExpression")
    ...
    var m = this.parseExprList(xa.parenR, this.options.ecmaVersion >= 8, !1, u);
    if (n && !l && !this.canInsertSemicolon() && this.eat(xa.arrow)) return this.checkPatternErrors(u, !1), this.checkYieldAwaitInDefaultParams(), this.awaitIdentPos > 0 && this.raise(this.awaitIdentPos, "Cannot use 'await' as identifier inside an async function"), this.yieldPos = d, this.awaitPos = p, this.awaitIdentPos = f, this.parseArrowExpression(this.startNodeAt(t, i), m, !0, a);
  ...
  switch (this.type) {
    ...
    case xa.name:
      var n = this.start,
        ...
        a = this.containsEsc,
        o = this.parseIdent(!1);
      if (this.options.ecmaVersion >= 8 && !a && "async" === o.name && !this.canInsertSemicolon() && this.eat(xa._function)) return this.overrideContext(to.f_expr), this.parseFunction(this.startNodeAt(n, r), 0, !1, !0, t);
      if (s && !this.canInsertSemicolon()) {
        if (this.eat(xa.arrow)) return this.parseArrowExpression(this.startNodeAt(n, r), [o], !1, t);
        if (this.options.ecmaVersion >= 8 && "async" === o.name && this.type === xa.name && !a && (!this.potentialArrowInForAwait || "of" !== this.value || this.containsEsc)) return o = this.parseIdent(!1), !this.canInsertSemicolon() && this.eat(xa.arrow) || this.unexpected(), this.parseArrowExpression(this.startNodeAt(n, r), [o], !0, t)
      }
      return o;
    case xa.regexp:
      var l = this.value;
    ...
    case xa.bracketL:
      return i = this.startNode(), this.next(), i.elements = this.parseExprList(xa.bracketR, !0, !0, e), this.finishNode(i, "ArrayExpression");
    case xa.braceL:
      return this.overrideContext(to.b_expr), this.parseObj(!1, e);
    case xa._function:
  ...
  if (this.options.ecmaVersion >= 6) {
    ...
    for (this.yieldPos = 0, this.awaitPos = 0; this.type !== xa.parenR;) {
      if (c ? c = !1 : this.expect(xa.comma), r && this.afterTrailingComma(xa.parenR, !0)) {
        u = !0;
        break
      }
      if (this.type === xa.ellipsis) {
        a = this.start, h.push(this.parseParenItem(this.parseRestBinding())), this.type === xa.comma && this.raise(this.start, "Comma is not permitted after the rest element");
        break
      }
    ...
    if (this.expect(xa.parenR), e && !this.canInsertSemicolon() && this.eat(xa.arrow)) return this.checkPatternErrors(d, !1), this.checkYieldAwaitInDefaultParams(), this.yieldPos = p, this.awaitPos = f, this.parseParenArrowList(s, n, h, t);
...
so.parseNew = function() {
  ...
  var s = this.start,
    n = this.startLoc,
    r = this.type === xa._import;
  return e.callee = this.parseSubscripts(this.parseExprAtom(), s, n, !0, !1), r && "ImportExpression" === e.callee.type && this.raise(s, "Cannot use new with import()"), this.eat(xa.parenL) ? e.arguments = this.parseExprList(xa.parenR, this.options.ecmaVersion >= 8, !1) : e.arguments = ro, this.finishNode(e, "NewExpression")
}, so.parseTemplateElement = function(e) {
  var t = e.isTagged,
    i = this.startNode();
  return this.type === xa.invalidTemplate ? (t || this.raiseRecoverable(this.start, "Bad escape sequence in untagged template literal"), i.value = {
    raw: this.value,
    cooked: null
  }) : i.value = {
    raw: this.input.slice(this.start, this.end).replace(/\r\n?/g, "\n"),
    cooked: this.value
  }, this.next(), i.tail = this.type === xa.backQuote, this.finishNode(i, "TemplateElement")
  ...
  for (i.quasis = [s]; !s.tail;) this.type === xa.eof && this.raise(this.pos, "Unterminated template literal"), this.expect(xa.dollarBraceL), i.expressions.push(this.parseExpression()), this.expect(xa.braceR), i.quasis.push(s = this.parseTemplateElement({
    isTagged: t
  }));
  ...
  for (i.properties = [], this.next(); !this.eat(xa.braceR);) {
    if (s) s = !1;
    else if (this.expect(xa.comma), this.options.ecmaVersion >= 5 && this.afterTrailingComma(xa.braceR)) break;
  ...
  if (this.options.ecmaVersion >= 9 && this.eat(xa.ellipsis)) return e ? (a.argument = this.parseIdent(!1), this.type === xa.comma && this.raise(this.start, "Comma is not permitted after the rest element"), this.finishNode(a, "RestElement")) : (this.type === xa.parenL && t && (t.parenthesizedAssign < 0 && (t.parenthesizedAssign = this.start), t.parenthesizedBind < 0 && (t.parenthesizedBind = this.start)), a.argument = this.parseMaybeAssign(!1, t), this.type === xa.comma && t && t.trailingComma < 0 && (t.trailingComma = this.start), this.finishNode(a, "SpreadElement"));
  this.options.ecmaVersion >= 6 && (a.method = !1, a.shorthand = !1, (e || t) && (n = this.start, r = this.startLoc), e || (i = this.eat(xa.star)));
  var o = this.containsEsc;
  return this.parsePropertyName(a), !e && !o && this.options.ecmaVersion >= 8 && !i && this.isAsyncProp(a) ? (s = !0, i = this.options.ecmaVersion >= 9 && this.eat(xa.star), this.parsePropertyName(a, t)) : s = !1, this.parsePropertyValue(a, e, i, s, n, r, t, o), this.finishNode(a, "Property")
}, so.parsePropertyValue = function(e, t, i, s, n, r, a, o) {
  if ((i || s) && this.type === xa.colon && this.unexpected(), this.eat(xa.colon)) e.value = t ? this.parseMaybeDefault(this.start, this.startLoc) : this.parseMaybeAssign(!1, a), e.kind = "init";
  else if (this.options.ecmaVersion >= 6 && this.type === xa.parenL) t && this.unexpected(), e.kind = "init", e.method = !0, e.value = this.parseMethod(i, s);
  ...
  if (this.options.ecmaVersion >= 6) {
    if (this.eat(xa.bracketL)) return e.computed = !0, e.key = this.parseMaybeAssign(), this.expect(xa.bracketR), e.key;
    e.computed = !1
  }
  ...
  for (var n = [], r = !0; !this.eat(e);) {
    if (r) r = !1;
    else if (this.expect(xa.comma), t && this.afterTrailingComma(e)) break;
    var a = void 0;
    i && this.type === xa.comma ? a = null : this.type === xa.ellipsis ? (a = this.parseSpread(s), s && this.type === xa.comma && s.trailingComma < 0 && (s.trailingComma = this.start)) : a = this.parseMaybeAssign(!1, s), n.push(a)
  }
  return n
  ...
  var t = this.startNode();
  return this.next(), this.type === xa.semi || this.canInsertSemicolon() || this.type !== xa.star && !this.type.startsExpr ? (t.delegate = !1, t.argument = null) : (t.delegate = this.eat(xa.star), t.argument = this.parseMaybeAssign(e)), this.finishNode(t, "YieldExpression")
...
ao.raise = function(e, t) {
  ...
  if (this.options.locations) return new Oa(this.curLine, this.pos - this.lineStart)
};
var oo = Fa.prototype,
  lo = function(e) {
...
Co.prototype.reset = function(e, t, i) {
  ...
  var t = e.current();
  return !!_o(t) && (e.lastIntValue = t, e.advance(), !0)
}, wo.regexp_eatPatternCharacters = function(e) {
  for (var t = e.pos, i = 0; - 1 !== (i = e.current()) && !_o(i);) e.advance();
  return e.pos !== t
  ...
  return e.advance(i), 92 === s && this.regexp_eatRegExpUnicodeEscapeSequence(e, i) && (s = e.lastIntValue),
    function(e) {
      return ua(e, !0) || 36 === e || 95 === e || 8204 === e || 8205 === e
    }(s) ? (e.lastIntValue = s, !0) : (e.pos = t, !1)
  ...
  return 48 === e.current() && !Oo(e.lookahead()) && (e.lastIntValue = 0, e.advance(), !0)
  ...
  var t = e.current();
  return !!No(t) && (e.lastIntValue = t % 32, e.advance(), !0)
  ...
  var t = 0;
  for (e.lastStringValue = ""; $o(t = e.current());) e.lastStringValue += $a(t), e.advance();
  return "" !== e.lastStringValue
}, wo.regexp_eatUnicodePropertyValue = function(e) {
  var t = 0;
  for (e.lastStringValue = ""; To(t = e.current());) e.lastStringValue += $a(t), e.advance();
  return "" !== e.lastStringValue
  ...
  var t = e.current();
  return !(!Oo(t) && 95 !== t) && (e.lastIntValue = t % 32, e.advance(), !0)
  ...
  var t = e.pos,
    i = 0;
  for (e.lastIntValue = 0; Oo(i = e.current());) e.lastIntValue = 10 * e.lastIntValue + (i - 48), e.advance();
  return e.pos !== t
}, wo.regexp_eatHexDigits = function(e) {
  var t = e.pos,
    i = 0;
  for (e.lastIntValue = 0; Ro(i = e.current());) e.lastIntValue = 16 * e.lastIntValue + Mo(i), e.advance();
  return e.pos !== t
  ...
  var t = e.current();
  return Do(t) ? (e.lastIntValue = t - 48, e.advance(), !0) : (e.lastIntValue = 0, !1)
}, wo.regexp_eatFixedHexDigits = function(e, t) {
  var i = e.pos;
  e.lastIntValue = 0;
  for (var s = 0; s < t; ++s) {
    var n = e.current();
    if (!Ro(n)) return e.pos = i, !1;
    e.lastIntValue = 16 * e.lastIntValue + Mo(n), e.advance()
  }
  return !0
};
var Lo = function(e) {
...
Vo.next = function(e) {
  ...
  if (-1 === i && this.raise(this.pos - 2, "Unterminated comment"), this.pos = i + 2, this.options.locations)
    for (var s = void 0, n = t;
      (s = Sa(this.input, n, this.pos)) > -1;) ++this.curLine, n = this.lineStart = s;
  ...
  for (var t = this.pos, i = this.options.onComment && this.curPosition(), s = this.input.charCodeAt(this.pos += e); this.pos < this.input.length && !va(s);) s = this.input.charCodeAt(++this.pos);
  ...
  e: for (; this.pos < this.input.length;) {
    ...
    switch (e) {
      ...
      case 47:
        ...
        break;
      default:
        if (!(e > 8 && e < 14 || e >= 5760 && Aa.test(String.fromCharCode(e)))) break e;
        ++this.pos
    }
  }
  ...
  if (t === e) {
    if (this.options.ecmaVersion >= 12)
      if (61 === this.input.charCodeAt(this.pos + 2)) return this.finishOp(xa.assign, 3);
  ...
  if (e >= 11) {
    ...
    if (46 === t) {
      ...
      if (i < 48 || i > 57) return this.finishOp(xa.questionDot, 2)
    }
    if (63 === t) {
      if (e >= 12)
        if (61 === this.input.charCodeAt(this.pos + 2)) return this.finishOp(xa.assign, 3);
  ...
  var e = 35;
  if (this.options.ecmaVersion >= 13 && (++this.pos, ca(e = this.fullCharCodeAtPos(), !0) || 92 === e)) return this.finishToken(xa.privateId, this.readWord1());
  ...
  for (var e, t, i = this.pos;;) {
    ...
    if (Ea.test(s) && this.raise(i, "Unterminated regular expression"), e) e = !1;
    else {
      if ("[" === s) t = !0;
      else if ("]" === s && t) t = !1;
      else if ("/" === s && !t) break;
  ...
  var o = this.regexpState || (this.regexpState = new Co(this));
  o.reset(i, n, a), this.validateRegExpFlags(o), this.validateRegExpPattern(o);
  var l = null;
  try {
    l = new RegExp(n, a)
  } catch (e) {}
  return this.finishToken(xa.regexp, {
    pattern: n,
    flags: a,
    value: l
  })
  ...
  if (!i && !e && this.options.ecmaVersion >= 11 && 110 === s) {
    var n = Bo(this.input.slice(t, this.pos));
    return ++this.pos, ca(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number"), this.finishToken(xa.num, n)
  }
  ...
  return this.finishToken(xa.num, a)
  ...
  for (var t = "", i = ++this.pos;;) {
    ...
    var s = this.input.charCodeAt(this.pos);
    if (s === e) break;
    92 === s ? (t += this.input.slice(i, this.pos), t += this.readEscapedChar(!1), i = this.pos) : 8232 === s || 8233 === s ? (this.options.ecmaVersion < 10 && this.raise(this.start, "Unterminated string constant"), ++this.pos, this.options.locations && (this.curLine++, this.lineStart = this.pos)) : (va(s) && this.raise(this.start, "Unterminated string constant"), ++this.pos)
  }
...
Vo.tryReadTemplateToken = function() {
  ...
  if (this.inTemplateElement && this.options.ecmaVersion >= 9) throw Fo;
  this.raise(e, t)
}, Vo.readTmplToken = function() {
  for (var e = "", t = this.pos;;) {
    this.pos >= this.input.length && this.raise(this.start, "Unterminated template");
    var i = this.input.charCodeAt(this.pos);
    if (96 === i || 36 === i && 123 === this.input.charCodeAt(this.pos + 1)) return this.pos !== this.start || this.type !== xa.template && this.type !== xa.invalidTemplate ? (e += this.input.slice(t, this.pos), this.finishToken(xa.template, e)) : 36 === i ? (this.pos += 2, this.finishToken(xa.dollarBraceL)) : (++this.pos, this.finishToken(xa.backQuote));
  ...
  for (var e = "", t = !0, i = this.pos, s = this.options.ecmaVersion >= 6; this.pos < this.input.length;) {
    ...
    if (ua(n, s)) this.pos += n <= 65535 ? 1 : 2;
    else {
      if (92 !== n) break;
      ...
      (t ? ca : ua)(a, s) || this.invalidStringToken(r, "Invalid Unicode escape"), e += $a(a), i = this.pos
    }
    t = !1
  }
...
const zo = e => () => {
  ...
  jo = {
    mkdir: zo("fs.mkdir"),
    readFile: zo("fs.readFile"),
    writeFile: zo("fs.writeFile")
  };
async function Uo(e, t, i, s, n, r, a, o) {
  const l = await
  ...
  return null == l && zo("path.resolve"), l
}
...
function Go(e, t, {
  ...
  return "string" == typeof e && (e = {
    message: e
  }), e.code && e.code !== me.PLUGIN_ERROR && (e.pluginCode = e.code), e.code = me.PLUGIN_ERROR, e.plugin = t, i && (e.hook = i), s && (e.id = s), pe(e)
}
const Ho = [{
  active: !0,
...
function qo(e) {
  return e.startsWith("at position ") || e.startsWith("at output position ") ? pe({
...
async function Ko(e, t, i, s) {
  const n = t.id,
    r = [];
  let a = null === e.map ? null : Or(e.map);
  const o = e.code;
  let l = e.ast;
  const c = [],
    u = [];
    ...
    g = await i.hookReduceArg0("transform", [m, n], (function(e, i, n) {
      ...
      if ("string" == typeof i) a = i;
        ...
        if (t.updateOptions(i), null == i.code) return (i.map || i.ast) && s(function(e) {
          return {
            code: me.NO_TRANSFORM_MAP_OR_AST_WITHOUT_CODE,
      ...
      return null !== o && r.push(Or("string" == typeof o ? JSON.parse(o) : o) || {
        missing: !0,
        plugin: n.name
      }), a
    }), ((e, t) => {
      return f = t.name, {
        ...
        error: (t, i) => ("string" == typeof t && (t = {
          message: t
        }), i && fe(t, i, m, n), t.id = n, t.hook = "transform", e.error(t)),
        getCombinedSourcemap() {
          const e = function(e, t, i, s, n) {
            return s.length ? {
              version: 3,
              ...Ln(e, t, i, s, Dn(n)).traceMappings()
            } : i
          }(n, o, a, r, s);
          if (!e) {
            return new x(o).generateMap({
              hires: !0,
              includeContent: !0,
              source: n
            })
          }
          return a !== e && (a = e, r.length = 0), new h({
            ...e,
            file: null,
        ...
        warn(t, i) {
          "string" == typeof t && (t = {
            message: t
          }), i && fe(t, i, m, n), t.id = n, t.hook = "transform", e.warn(t)
        }
      };
      var l, g
    }))
...
class Xo {
  ...
  async addEntryModules(e, t) {
    ...
    const n = await this.extendLoadModulesPromise(Promise.all(e.map((({
      ...
      for (let r = 0; r < n.length; r++) {
        const a = n[r];
        a.isUserDefinedEntryPoint = a.isUserDefinedEntryPoint || t, Qo(a, e[r], t, s + r);
  ...
  async preloadModule(e) {
    return (await this.fetchModule(this.getResolvedIdWithDefaults(e), void 0, !1, !e.resolveDependencies || "resolveDependencies")).info
  }
  ...
  async addModuleSource(e, t, i) {
    ...
    try {
      s = await this.graph.fileOperationQueue.run((async () => {
        var t;
        return null !== (t = await this.pluginDriver.hookFirst("load", [e])) && void 0 !== t ? t : await jo.readFile(e, "utf8")
      }))
    } catch (i) {
      tn("load modules", 3);
      let s = `Could not load ${e}`;
      throw t && (s += ` (imported by ${he(t)})`), s += `: ${i.message}`, i.message = s, i
    }
    tn("load modules", 3);
    const n = "string" == typeof s ? {
        code: s
      } : null != s && "object" == typeof s && "string" == typeof s.code ? s : pe(function(e) {
        return {
          code: me.BAD_LOADER,
    ...
    if (!r || r.customTransformCache || r.originalCode !== n.code || await this.pluginDriver.hookFirst("shouldTransformCachedModule", [{
      ...
      }])) i.updateOptions(n), i.setSource(await Ko(n, i, this.pluginDriver, this.options.onwarn));
    else {
      if (r.transformFiles)
  ...
  async fetchDynamicDependencies(e, t) {
    const i = await Promise.all(t.map((t => t.then((async ([t, i]) => null === i ? null : "string" == typeof i ? (t.resolution = i, null) : t.resolution = await this.fetchResolvedDependency(he(i.id), e.id, i))))));
  ...
  async fetchModule({
    ...
    if (o instanceof ln) return await this.handleExistingModule(o, r, a), o;
    const l = new ln(this.graph, e, this.options, r, i, s, t);
    ...
    const h = this.addModuleSource(e, n, l).then((() => [this.getResolveStaticDependencyPromises(l), this.getResolveDynamicImportPromises(l), c])),
      c = Zo(h).then((() => this.pluginDriver.hookParallel("moduleParsed", [l.info])));
    c.catch((() => {})), this.moduleLoadPromises.set(l, h);
    const u = await h;
    return a ? "resolveDependencies" === a && await c : await this.fetchModuleDependencies(l, ...u), l
  }
  ...
  fetchResolvedDependency(e, t, i) {
    if (i.external) {
      ...
      this.modulesById.has(n) || this.modulesById.set(n, new $e(this.options, n, r, a, "absolute" !== s && k(n)));
      const o = this.modulesById.get(n);
      return o instanceof $e ? Promise.resolve(o) : pe(function(e, t) {
        return {
          code: me.INVALID_EXTERNAL_ID,
  ...
  async fetchStaticDependencies(e, t) {
    ...
    if (!this.options.treeshake || "no-treeshake" === e.info.moduleSideEffects)
      for (const t of e.dependencies) t instanceof ln && (t.importedFromNotTreeshaken = !0)
  }
  getNormalizedResolvedIdWithoutDefaults(e, t, i) {
    ...
    if (e) {
      if ("object" == typeof e) {
        ...
        return {
          ...e,
          external: n && ("relative" === n || !k(e.id) || !0 === n && Jo(e.id, i, s) || "absolute")
        }
      }
      const n = this.options.external(e, t, !0);
      return {
        external: n && (Jo(e, i, s) || "absolute"),
        id: n && s ? Yo(e, t) : e
      }
    }
    const n = s ? Yo(i, t) : i;
    return !1 === e || this.options.external(n, t, !0) ? {
      external: Jo(n, i, s) || "absolute",
      id: n
    } : null
  }
  ...
  getResolveStaticDependencyPromises(e) {
    return Array.from(e.sources, (async t => [t, e.resolvedIds[t] = e.resolvedIds[t] || this.handleResolveId(await this.resolveId(t, e.id, se, !1), t, e.id)]))
  }
  ...
  async handleExistingModule(e, t, i) {
    ...
    if (i) return "resolveDependencies" === i ? Zo(s) : s;
    if (t) {
  ...
  handleResolveId(e, t, i) {
    return null === e ? w(t) ? pe(function(e, t) {
      return {
        code: me.UNRESOLVED_IMPORT,
      ...
      return {
        code: me.EXTERNAL_SYNTHETIC_EXPORTS,
        importer: he(t),
  ...
  async loadEntryModule(e, t, i, s) {
    const n = await Uo(e, i, this.options.preserveSymlinks, this.pluginDriver, this.resolveId, null, se, !0);
    return null == n ? pe(null === s ? function(e) {
      return {
        code: me.UNRESOLVED_ENTRY,
    ...
    }(e, s)) : !1 === n || "object" == typeof n && n.external ? pe(null === s ? function(e) {
      return {
        code: me.UNRESOLVED_ENTRY,
  ...
  async resolveDynamicImport(e, t, i) {
    ...
    return "string" != typeof t ? "string" == typeof r ? r : r ? {
      ...
      moduleSideEffects: !0,
      ...r
    } : null : null == r ? null !== (s = (n = e.resolvedIds)[t]) && void 0 !== s ? s : n[t] = this.handleResolveId(await this.resolveId(t, e.id, se, !1), t, e.id) : this.handleResolveId(this.getResolvedIdWithDefaults(this.getNormalizedResolvedIdWithoutDefaults(r, i, t)), t, i)
  }
}
...
function Jo(e, t, i) {
  return !0 === i || "ifRelativeSource" === i && w(t) || !k(e)
}
async function Zo(e) {
  const [t, i] = await e;
...
function tl(e, t, i) {
  ...
  t[Rr].has(s) ? i(function(e) {
    return {
      code: me.FILE_NAME_CONFLICT,
...
function il(e, t, i) {
  if (!("string" == typeof e || e instanceof Uint8Array)) {
    ...
    return pe(Ae(`Could not set source for ${"string"==typeof e?`asset "${e}"`:"unnamed asset"}, asset source needs to be a string, Uint8Array or Buffer.`))
  }
  return e
}

function sl(e, t) {
  return "string" != typeof e.fileName ? pe((i = e.name || t, {
    code: me.ASSET_NOT_FINALISED,
...
function nl(e, t) {
  ...
  return s || pe((n = e.fileName || e.name, {
    code: me.CHUNK_NOT_GENERATED,
...
class rl {
  constructor(e, t, i) {
    this.graph = e, this.options = t, this.bundle = null, this.facadeChunkByModule = null, this.outputOptions = null, this.assertAssetsFinalized = () => {
      for (const [t, i] of this.filesByReferenceId)
        if ("asset" === i.type && "string" != typeof i.fileName) return pe((e = i.name || t, {
          code: me.ASSET_SOURCE_MISSING,
      ...
      return !t || "string" == typeof t && !ce(t)
    }(e) ? "chunk" === e.type ? this.emitChunk(e) : this.emitAsset(e) : pe(Ae(`The "fileName" or "name" properties of emitted files must be strings that are neither absolute nor relative paths, received "${e.fileName||e.name}".`)) : pe(Ae(`Emitted files must be of type "asset" or "chunk", received "${e&&e.type}".`)), this.getFileName = e => {
      const t = this.filesByReferenceId.get(e);
      return t ? "chunk" === t.type ? nl(t, this.facadeChunkByModule) : sl(t, e) : pe((i = e, {
        code: me.FILE_NOT_FOUND,
      ...
      if (!i) return pe((s = e, {
        code: me.ASSET_NOT_FOUND,
        message: `Plugin error - Unable to set the source for unknown asset "${s}".`
      }));
      var s, n;
      if ("asset" !== i.type) return pe(Ae(`Asset sources can only be set for emitted assets but "${e}" is an emitted chunk.`));
      if (void 0 !== i.source) return pe((n = i.name || e, {
        code: me.ASSET_SOURCE_ALREADY_SET,
      ...
      for (const {
        ...
        of this.filesByReferenceId.values()) t && tl(t, e, this.options.onwarn);
  ...
  emitChunk(e) {
    if (this.graph.phase > Gs.LOAD_AND_PARSE) return pe({
      code: me.INVALID_ROLLUP_PHASE,
      message: "Cannot emit chunks after module loading has finished."
    });
    if ("string" != typeof e.id) return pe(Ae(`Emitted chunks need to have a valid string id, received "${e.id}"`));
    const t = {
      fileName: e.fileName,
      module: null,
      name: e.name || e.id,
  ...
  finalizeAsset(e, t, i, s) {
    const n = e.fileName || function(e, t) {
        for (const [i, s] of Object.entries(e))
          if ("asset" === s.type && al(t, s.source)) return i;
        return null
      }(s, t) || function(e, t, i, s) {
        const n = i.sanitizeFileName(e || "asset");
        return Lr(Dr("function" == typeof i.assetFileNames ? i.assetFileNames({
          name: e,
          source: t,
          type: "asset"
          ...
          ext: () => $(n).substring(1),
          extname: () => $(n),
          hash: () => vr().update(n).update(":").update(t).digest("hex").substring(0, 8),
          name: () => n.substring(0, n.length - $(n).length)
        }), s)
    ...
    s[n] = {
      fileName: n,
      get isAsset() {
        return Pe('Accessing "isAsset" on files in the bundle is deprecated, please use "type === \'asset\'" instead', !0, a), !0
      },
      name: e.name,
      source: t,
      type: "asset"
...
function ll(e, t, i, s, n, r) {
  ...
  if ("string" != typeof e.cacheKey && (e.name.startsWith("at position ") || e.name.startsWith("at output position ") || r.has(e.name) ? o = !1 : r.add(e.name)), t)
    if (o) {
      ...
      h = t[i] || (t[i] = Object.create(null)), a = {
        delete: e => delete h[e],
        get(e) {
          const t = h[e];
  ...
  return {
    addWatchFile(e) {
      if (i.phase >= Gs.GENERATE) return this.error({
        code: me.INVALID_ROLLUP_PHASE,
    ...
    cache: a,
    emitAsset: ol(((e, t) => n.emitFile({
      name: e,
      source: t,
      type: "asset"
    })), "emitAsset", "emitFile", e.name, !0, s),
    emitChunk: ol(((e, t) => n.emitFile({
      id: e,
      name: t && t.name,
      type: "chunk"
    })), "emitChunk", "emitFile", e.name, !0, s),
    emitFile: n.emitFile.bind(n),
    error: t => Go(t, e.name),
    getAssetFileName: ol(n.getFileName, "getAssetFileName", "getFileName", e.name, !0, s),
    getChunkFileName: ol(n.getFileName, "getChunkFileName", "getFileName", e.name, !0, s),
    ...
    isExternal: ol(((e, t, i = !1) => s.external(e, t, i)), "isExternal", "resolve", e.name, !0, s),
    load: e => i.moduleLoader.preloadModule(e),
    meta: {
      rollupVersion: "2.79.1",
    ...
    resolve: (t, s, {
      ...
      isEntry: r,
      skipSelf: a
    } = ie) => i.moduleLoader.resolveId(t, s, n, r, a ? [{
      importer: s,
      plugin: e,
      source: t
    }] : null),
    resolveId: ol(((e, t) => i.moduleLoader.resolveId(e, t, ie, void 0).then((e => e && e.id))), "resolveId", "resolve", e.name, !0, s),
    setAssetSource: n.setAssetSource,
    warn(t) {
      "string" == typeof t && (t = {
        message: t
      }), t.code && (t.pluginCode = t.code), t.code = "PLUGIN_WARNING", t.plugin = e.name, s.onwarn(t)
    }
  }
}
const hl = Object.keys({
  buildEnd: 1,
  buildStart: 1,
  closeBundle: 1,
  closeWatcher: 1,
...
class cl {
  constructor(e, t, i, s, n) {
    ...
    const r = new Set;
    if (this.pluginContexts = new Map(this.plugins.map((i => [i, ll(i, s, e, t, this.fileEmitter, r)]))), n)
      for (const e of i)
        for (const i of hl) i in e && t.onwarn((a = e.name, o = i, {
          code: me.INPUT_HOOK_IN_OUTPUT_PLUGIN,
  ...
  async hookReduceValue(e, t, i, s) {
    const n = [],
      r = [];
    for (const t of this.getSortedPlugins(e, pl)) t[e].sequential ? (n.push(...await Promise.all(r)), r.length = 0, n.push(await this.runHook(e, i, t))) : r.push(this.runHook(e, i, t));
  ...
  runHook(e, t, i, s) {
    ...
    })).catch((t => (null !== o && this.unfulfilledActions.delete(o), Go(t, i.name, {
      hook: e
    }))))
  }
  runHookSync(e, t, i, s) {
...
function dl(e, t, i) {
  "function" != typeof e && pe(function(e, t) {
    return {
      code: me.INVALID_PLUGIN_HOOK,
      hook: e,
...
function pl(e, t, i) {
  if ("string" != typeof e && "function" != typeof e) return pe(function(e, t) {
    return {
      code: me.INVALID_PLUGIN_HOOK,
      hook: e,
...
class gl {
  ...
  contextParse(e, t = {}) {
    ...
    return "object" == typeof i && i.push(...s), t.onComment = i,
      function(e, t, i) {
        const s = [],
          n = [];
        for (const t of e) lt.test(t.value) ? s.push(t) : it.test(t.value) && n.push(t);
        for (const e of n) ht(t, e, !1);
        st(t, {
          annotationIndex: 0,
          annotations: s,
          code: i
  ...
  async generateModuleGraph() {
    ...
    for (const e of this.modulesById.values()) e instanceof ln ? this.modules.push(e) : this.externalModules.push(e)
  }
  includeStatements() {
    for (const e of [...this.entryModules, ...this.implicitEntryModules]) rn(e);
    ...
    for (const e of this.implicitEntryModules)
      for (const t of e.implicitlyLoadedAfter) t.info.isEntry || t.isIncluded() || pe(be(t))
  }
  sortModules() {
    const {
      orderedModules: e,
      ...
      const i = [],
        ...
        o = e => {
          if (e instanceof ln) {
            for (const t of e.dependencies) r.has(t) ? s.has(t) || i.push(Kr(t, e, r)) : (r.set(t, e), o(t));
            for (const t of e.implicitlyLoadedBefore) n.add(t);
            for (const {
                resolution: t
              }
              of e.dynamicImports) t instanceof ln && n.add(t);
            a.push(e)
          }
...
const El = e => console.warn(e.message || e);
...
const vl = {
  ...
  Al = (e, t, i, s) => {
    ...
    if (n) {
      ...
      pe(xe(`${i}.preset`, Il(i), `valid values are ${oe(Object.keys(t))}`, n))
    }
    return ((e, t, i) => s => {
      if ("string" == typeof s) {
        const n = e[s];
        if (n) return n;
        pe(xe(t, Il(t), `valid values are ${i}${oe(Object.keys(e))}. You can also supply an object for more fine-grained control`, s))
      }
...
const Pl = e => {
    ...
    return t ? e => {
      e.toString = () => {
        let t = "";
        return e.plugin && (t += `(${e.plugin} plugin) `), e.loc && (t += `${he(e.loc.file)} (${e.loc.line}:${e.loc.column}) `), t += e.message, t
      }, t(e, El)
    } : El
  },
  kl = e => ({
  ...
  _l = e => {
    ...
    if (e) {
      const t = new Set,
        i = [];
      for (const s of yl(e)) s instanceof RegExp ? i.push(s) : t.add(s);
  ...
  Nl = (e, t, i) => {
    ...
    return s && ke('The "inlineDynamicImports" option is deprecated. Use the "output.inlineDynamicImports" option instead.', !1, t, i), s
  },
  $l = e => {
    const t = e.input;
  ...
  Tl = (e, t, i) => {
    ...
    return s && ke('The "manualChunks" option is deprecated. Use the "output.manualChunks" option instead.', !1, t, i), s
  },
  Ol = (e, t, i) => {
    var s;
    const n = e.maxParallelFileReads;
    "number" == typeof n && ke('The "maxParallelFileReads" option is deprecated. Use the "maxParallelFileOps" option instead.', !1, t, i);
  ...
  Rl = (e, t) => {
    ...
    if (i) {
      const e = Object.create(null);
      for (const [t, s] of Object.entries(i)) e[O(t)] = s;
      return i => e[i] || t
    }
    return () => t
  },
  ...
  Dl = (e, t, i) => {
    ...
    return s && ke('The "preserveModules" option is deprecated. Use the "output.preserveModules" option instead.', !1, t, i), s
  },
  Ll = (e, t, i) => {
    const s = e.treeshake;
    if (!1 === s) return !1;
    const n = Al(e.treeshake, vl, "treeshake", "false, true, ");
    return void 0 !== n.pureExternalModules && ke('The "treeshake.pureExternalModules" option is deprecated. The "treeshake.moduleSideEffects" option should be used instead. "treeshake.pureExternalModules: true" is equivalent to "treeshake.moduleSideEffects: \'no-external\'"', !0, t, i), {
      annotations: !1 !== n.annotations,
      correctVarValueBeforeDeclaration: !0 === n.correctVarValueBeforeDeclaration,
      moduleSideEffects: "object" == typeof s && s.pureExternalModules ? Vl(s.moduleSideEffects, s.pureExternalModules) : Vl(n.moduleSideEffects, void 0),
...
const jl = (e, t, i) => {
    ...
    if ("string" == typeof s) {
      if (t) return pe(xe("output.file", "outputdir", 'you must set "output.dir" instead of "output.file" when using the "output.preserveModules" option'));
      if (!Array.isArray(i.input)) return pe(xe("output.file", "outputdir", 'you must set "output.dir" instead of "output.file" when providing named inputs'))
    }
    return s
  },
  Ul = e => {
  ...
  Gl = (e, t) => {
    ...
    return s && (Array.isArray(n) ? n : Object.keys(n)).length > 1 ? pe(xe("output.inlineDynamicImports", "outputinlinedynamicimports", 'multiple inputs are not supported when "output.inlineDynamicImports" is true')) : s
  },
  Hl = (e, t, i) => {
    var s;
    const n = (null !== (s = e.preserveModules) && void 0 !== s ? s : i.preserveModules) || !1;
    if (n) {
      if (t) return pe(xe("output.inlineDynamicImports", "outputinlinedynamicimports", 'this option is not supported for "output.preserveModules"'));
      if (!1 === i.preserveEntrySignatures) return pe(xe("preserveEntrySignatures", "preserveentrysignatures", 'setting this option to false is not supported for "output.preserveModules"'))
    }
    return n
  },
  Wl = (e, t) => {
    const i = e.preferConst;
    return null != i && Pe('The "output.preferConst" option is deprecated. Use the "output.generatedCode.constBindings" option instead.', !1, t), !!i
  },
  ql = e => {
    const {
  ...
  Kl = e => {
    ...
    if ((t.autoId || t.basePath) && t.id) return pe(xe("output.amd.id", "outputamd", 'this option cannot be used together with "output.amd.autoId"/"output.amd.basePath"'));
    if (t.basePath && !t.autoId) return pe(xe("output.amd.basePath", "outputamd", 'this option only works with "output.amd.autoId"'));
    let i;
    return i = t.autoId ? {
      autoId: !0,
      basePath: t.basePath,
  ...
  Ql = (e, t) => {
    ...
    return i && Pe('The "output.dynamicImportFunction" option is deprecated. Use the "renderDynamicImport" plugin hook instead.', !1, t), i
  },
  Jl = (e, t) => {
...
function Zl(e, t) {
  ...
  else if (!["default", "named", "none", "auto"].includes(i)) return pe((s = i, {
    code: me.INVALID_EXPORT_OPTION,
...
const eh = (e, t) => {
  ...
  sh = (e, t) => {
    const i = e.interop,
      ...
      n = e => {
        if (!s.has(e)) {
          if (s.add(e), !ih.has(e)) return pe(xe("output.interop", "outputinterop", `use one of ${Array.from(ih,(e=>JSON.stringify(e))).join(", ")}`, e));
          "boolean" == typeof e && Pe({
  ...
  nh = (e, t, i, s) => {
    ...
    if (n) {
      if (t) return pe(xe("output.manualChunks", "outputmanualchunks", 'this option is not supported for "output.inlineDynamicImports"'));
      if (i) return pe(xe("output.manualChunks", "outputmanualchunks", 'this option is not supported for "output.preserveModules"'))
    }
    return n || {}
  },
  rh = (e, t, i) => {
  ...
  ah = (e, t, i) => {
    ...
    return null != s ? (Pe('The "output.namespaceToStringTag" option is deprecated. Use the "output.generatedCode.symbols" option instead.', !1, i), s) : t.symbols || !1
  },
  oh = e => {
    const {
      sourcemapBaseUrl: t
...
function lh(e) {
  return async function(e, t) {
    const {
      ...
      const i = ul("options", yl(e.plugins)),
        {
          options: s,
          unsetOptions: n
        } = function(e) {
          ...
          const n = new Set,
            ...
            h = {
              acorn: kl(e),
              acornInjectPlugins: wl(e),
              cache: Cl(e),
              context: r,
              experimentalCacheExpiry: null !== (i = e.experimentalCacheExpiry) && void 0 !== i ? i : 10,
              external: _l(e.external),
              inlineDynamicImports: Nl(e, a, o),
              input: $l(e),
              makeAbsoluteExternalsRelative: null === (s = e.makeAbsoluteExternalsRelative) || void 0 === s || s,
              manualChunks: Tl(e, a, o),
              maxParallelFileOps: l,
              maxParallelFileReads: l,
              moduleContext: Rl(e, r),
              onwarn: a,
              perf: e.perf || !1,
              plugins: yl(e.plugins),
              preserveEntrySignatures: Ml(e, n),
              preserveModules: Dl(e, a, o),
              preserveSymlinks: e.preserveSymlinks || !1,
              shimMissingExports: e.shimMissingExports || !1,
              strictDeprecations: o,
              treeshake: Ll(e, a, o)
            };
          return bl(e, [...Object.keys(h), "watch"], "input options", h.onwarn, /^(output)$/), {
            options: h,
            unsetOptions: n
          }
        }(await i.reduce(function(e) {
          return async (t, i) => {
            const s = "handler" in i.options ? i.options.handler : i.options;
            return await s.call({
              meta: {
                rollupVersion: "2.79.1",
                watchMode: e
      ...
      return hh(s.plugins, "at position "), {
        options: s,
        unsetOptions: n
      }
    }(e, null !== t);
    ! function(e) {
      e.perf ? (Xs = new Map, en = Qs, tn = Js, e.plugins = e.plugins.map(nn)) : (en = Ks, tn = Ks)
    }(i);
    const n = new gl(i, t),
      r = !1 !== e.cache;
    delete i.cache, delete e.cache, en("BUILD", 1), await xl(n.pluginDriver, (async () => {
      try {
        await n.pluginDriver.hookParallel("buildStart", [i]), await n.build()
      } catch (e) {
    ...
    const a = {
      ...
      closed: !1,
      generate: async e => a.closed ? pe(Ie()) : ch(!1, i, s, e, n),
      watchFiles: Object.keys(n.watchFiles),
      write: async e => a.closed ? pe(Ie()) : ch(!0, i, s, e, n)
    };
    i.perf && (a.getTimings = Zs);
    return a
  }(e, null)
}
...
function ch(e, t, i, s, n) {
  const {
    ...
    const n = yl(e.plugins);
    hh(n, "at output position ");
      ...
      await Promise.all(Object.values(s).map((e => n.fileOperationQueue.run((() => async function(e, t) {
        ...
        if (await jo.mkdir(N(i), {
          ...
          if ("inline" === t.sourcemap) r = e.map.toUrl();
            ...
            r = n ? new URL(a, n).toString() : a, s = jo.writeFile(`${i}.map`, e.map.toString())
          }
          "hidden" !== t.sourcemap && (n += `//# sourceMappingURL=${r}\n`)
        }
        return Promise.all([jo.writeFile(i, n), s])
      }(e, r)))))), await a.hookParallel("writeBundle", [r, s])
    }
    return l = s, {
      output: Object.values(l).filter((e => Object.keys(e).length > 0)).sort(((e, t) => ph(e) - ph(t)))
    };
    var l
  }))
}
  ...
  return function(e, t, i) {
    ...
    const c = new Set(i),
      ...
      x = {
        ...
        compact: u,
        dir: Yl(e, m),
        dynamicImportFunction: Ql(e, t),
        entryFileNames: Jl(e, c),
        ...
        interop: sh(e, t),
        intro: Xl(e, "intro"),
        manualChunks: nh(e, p, f, t),
        minifyInternalExports: rh(e, d, u),
        name: e.name,
        namespaceToStringTag: ah(e, y, t),
        ...
        preferConst: g,
        preserveModules: f,
        preserveModulesRoot: ql(e),
        sanitizeFileName: "function" == typeof e.sanitizeFileName ? e.sanitizeFileName : !1 === e.sanitizeFileName ? e => e : zl,
    ...
    return bl(e, Object.keys(x), "output options", t.onwarn), {
      options: x,
      unsetOptions: c
    }
  }(s.hookReduceArg0Sync("outputOptions", [i.output || i], ((e, t) => t || e), (e => {
    const t = () => e.error({
      code: me.CANNOT_EMIT_FROM_OPTIONS_HOOK,
...
export {
  e as VERSION, fh as defineConfig, lh as rollup
};
