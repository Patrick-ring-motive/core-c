module.exports = function(e) {
  ...
  N || (I = function(e) {
    ...
    then: function(e, t) {
      var n = k(g(this, I));
      return n.ok = "function" != typeof e || e, n.fail = "function" == typeof t && t, n.domain = _ ? O.domain : void 0, this._c.push(n), this._a && this._a.push(n), this._s && C(this, !1), n.promise
    },
    catch: function(e) {
  ...
  n(28)("split", 2, function(e, t, r) {
    ...
    if ("c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length) {
      ...
      r = function(e, t) {
        ...
        for (a || (r = new RegExp("^" + g.source + "$(?!\\s)", h));
          (c = g.exec(n)) && !((u = c.index + c[0].length) > d && (p.push(n.slice(d, c.index)), !a && c.length > 1 && c[0].replace(r, function() {
  ...
  (t = e.exports = function(e, t, n, f, p) {
    ...
    if (i(v)) {
      for (h = a(e.length); h > b; b++)
        if ((g = t ? y(s(d = e[b])[0], d[1]) : y(e[b])) === u || g === l) return g
    } else
      for (m = v.call(e); !(d = m.next()).done;)
        if ((g = o(m, y, d.value, t)) === u || g === l) return g
  }).BREAK = u, t.RETURN = l
}, function(e, t) {
  e.exports = {}
}, function(e, t, n) {
  ...
  var r = n(5),
    ...
    f = n(99),
    p = n(69),
    h = (p.alphasort, p.alphasorti, p.setopts),
    d = p.ownProp,
    m = n(100),
  ...
  b.glob = b, b.hasMagic = function(e, t) {
    ...
    if (u(this instanceof x), u("function" == typeof r), !this.aborted)
  ...
  d.filter = function(e, t) {
    ...
    for (var x, S = 0, P = e.length; S < P && (x = e.charAt(S)); S++)
      if (this.debug("%s\t%s %s %j", e, S, i, x), l && f[x]) i += "\\" + x, l = !1;
      else switch (x) {
        case "/":
          return !1;
        case "\\":
    ...
    d && (j = e.substr(g + 1), E = this.parse(j, v), i = i.substr(0, m) + "\\[" + E[0], u = u || E[1]);
  ...
  e.exports = !c || n(10)(function() {
    ...
    for (var n = s(e), c = arguments.length, u = 1, l = o.f, f = i.f; c > u;)
      for (var p, h = a(arguments[u++]), d = l ? r(h).concat(l(h)) : r(h), m = d.length, g = 0; m > g;) f.call(h, p = d[g++]) && (n[p] = h[p]);
    return n
  } : c
}, function(e, t) {
    ...
    return function e(t, n) {
      ...
      if (f) {
        ...
        for (var _ = x; j(_, S); _ += O) {
          var A;
          if (u) "\\" === (A = String.fromCharCode(_)) && (A = "");
  ...
  var r = n(5),
    o = n(67),
    i = n(46),
    s = (i.Minimatch, n(45).Glob, n(30), n(0)),
    a = n(47),
    c = n(48),
    u = n(69),
  ...
  e.exports = function(e, t, n, d, m, g, v) {
    ...
    var y, b, w, x = function(e) {
      ...
      O = !1,
      j = e.prototype,
      E = j[f] || j["@@iterator"] || m && j[m],
      I = E || x(m),
      _ = m ? P ? x("entries") : I : void 0,
      A = "Array" == t && j.entries || E;
    if (A && (w = l(A.call(new e))) !== Object.prototype && w.next && (u(w, S, !0), r || "function" == typeof w[f] || s(w, f, h)), P && E && "values" !== E.name && (O = !0, I = function() {
        return E.call(this)
      }), r && !v || !p && !O && j[f] || s(j, f, I), a[t] = I, a[S] = h, m)
      if (y = {
          values: P ? I : x("values"),
          keys: g ? I : x("keys"),
          entries: _
  ...
  e.exports = function(e, t, n, m, g, v) {
    ...
    if ("function" == typeof b && (v || x.forEach && !f(function() {
      ...
      })).prototype = x, x.constructor = b), (E || _) && (P("delete"), P("has"), g && P("get")), (_ || j) && P(w), v && x.clear && delete x.clear
  ...
  o(o.S + o.F * !n(41)(function(e) {
    ...
    from: function(e) {
      var t, n, o, f, p = i(e),
        ...
        v = 0,
        y = l(p);
      if (g && (m = r(m, d > 2 ? arguments[2] : void 0, 2)), null == y || h == Array && a(y))
        for (n = new h(t = c(p.length)); t > v; v++) u(n, v, g ? m(p[v], v) : p[v]);
      else
        for (f = y.call(p), n = new h; !(o = f.next()).done; v++) u(n, v, g ? s(f, m, [o.value, v], !0) : o.value);
      return n.length = v, n
    }
  })
}, function(e, t, n) {
  ...
  r = "win32" === process.platform || global.TESTING_WINDOWS ? n(119) : n(120), e.exports = o, o.sync = function(e, t) {
    try {
      return r.sync(e, t || {})
    } catch (e) {
  ...
  e.exports = {
    ...
    getChromeInfo: function() {
      ...
      else if (i.isMacOS) e = i.getDarwinApplicationVersion(i.browserBundleIdentifiers.Chrome).then(i.findVersion);
      else if (i.isWindows) {
        var t;
        try {
  ...
  e.exports = ((e, t, n) => {
    ...
    return i._enoent.hookChildProcess(h, r.parsed),
      function(e, t) {
        null != t && (c(t) ? t.pipe(e.stdin) : e.stdin.end(t))
      }(h, r.opts.input), h.then = ((e, t) => j().then(e, t)), h.catch = (e => j().catch(e)), h
  ...
  function ue(e, t, r) {
    ...
    if (r || (r = {}), t.prerelease.length && !r.includePrerelease) {
      for (o = 0; o < e.length; o++)
        if (n(e[o].semver), e[o].semver !== ie && e[o].semver.prerelease.length > 0) {
          var i = e[o].semver;
  ...
  oe.prototype.parse = function(e) {
    var t = this.options.loose ? i[L] : i[$],
      n = e.match(t);
  ...
  var r = n(31),
    ...
    i = function(e, t, n) {
      ...
      return ! function(e) {
        ...
        }(e) ? u && !s && (e.on("end", l), e.on("close", l)) : (e.on("complete", f), e.on("abort", m), e.req ? g() : e.on("request", g)),
        function(e) {
          return e.stdio && Array.isArray(e.stdio) && 3 === e.stdio.length
        }(e) && e.on("exit", h), e.on("end", p), e.on("finish", f), !1 !== t.error && e.on("error", d), e.on("close", m),
        function() {
  ...
  function u(e) {
    return o.log("trace", "serializeArrays"),
      function e(t, n) {
