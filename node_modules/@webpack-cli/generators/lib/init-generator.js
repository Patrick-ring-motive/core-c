...
class InitGenerator extends types_1.CustomGenerator {
  ...
  async prompting() {
    ...
    try {
      ...
      const {
        installPrettier
      } = await Question.Confirm(this, "installPrettier", "Do you like to install prettier to format generated configuration?", true, false);
      if (installPrettier) {
  ...
  async installPlugins() {
    ...
    const opts = this.packageManager === "yarn" ? {
      dev: true
    } : {
      "save-dev": true
    };
  ...
  writing() {
    ...
    try {
      ...
      const source = (0, fs_1.readFileSync)(this.configurationPath, {
        encoding: "utf8"
      });
