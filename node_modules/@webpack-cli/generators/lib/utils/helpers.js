...
async function getInstaller() {
  ...
  const {
    packager
  } = await (0, scaffold_utils_1.List)(this, "packager", "Pick a package manager:", installers, defaultPackager, this.force);
  return packager;
}
...
async function getTemplate() {
  ...
  const {
    selectedTemplate
  } = await (0, scaffold_utils_1.List)(this, "selectedTemplate", "Select a valid template from below:", this.supportedTemplates, "default", false);
