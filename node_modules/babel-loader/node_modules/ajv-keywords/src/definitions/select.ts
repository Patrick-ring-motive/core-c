...
export type SelectError = ErrorObject < "select", {
    failingCase ? : string;failingDefault ? : true
  } >
  ...
  const error: KeywordErrorDefinition = {
    message: ({
      ...
      schemaProp ?
      str`should match case "${schemaProp}" schema` : str`should match default case schema`,
    params: ({
        params: {
          schemaProp
        }
