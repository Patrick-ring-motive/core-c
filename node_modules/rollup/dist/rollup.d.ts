...
export interface PluginContext extends MinimalPluginContext {
  ...
  resolve: (
    ...
    importer ? : string,
    options ? : {
      custom ? : CustomPluginOptions;isEntry ? : boolean;skipSelf ? : boolean
    }
...
export type ResolveIdHook = (
  ...
  options: {
    custom ? : CustomPluginOptions;isEntry: boolean
  }
) => ResolveIdResult;
...
export type ResolveImportMetaHook = (
  ...
  prop: string | null,
  options: {
    chunkId: string;format: InternalModuleFormat;moduleId: string
  }
) => string | null | void;
