! function(e, t) {
  ...
  function f(e) {
    return e !== IDBDatabase.prototype.transaction || "objectStoreNames" in IDBTransaction.prototype ? (r || (r = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])).includes(e) ? function(...t) {
      ...
      return i.set(r, t.sort ? t.sort() : [t]), p(r)
    }
  }
  ...
  const g = ["continue", "continuePrimaryKey", "advance"],
    ...
    w = {
      get(e, t) {
        ...
        let n = h[t];
        return n || (n = h[t] = function(...e) {
          v.set(this, m.get(this)[t](...e))
        }), n
      }
    };
  async function* E(...e) {
    ...
    for (m.set(n, t), c.set(n, D(t)); t;) yield n, t = await (v.get(n) || t.continue()), v.delete(n)
  }
  ...
  d((e => ({
    ...
    return r && i.addEventListener("upgradeneeded", (e => {
      r(p(i.result), e.oldVersion, e.newVersion, p(i.transaction), e)
