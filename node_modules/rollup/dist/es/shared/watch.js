...
function mergeOptions(config, rawCommandOptions = {
  external: [],
  globals: undefined
...
class Watcher {
  constructor(configs, emitter) {
    ...
    this.buildDelay = configs.reduce((buildDelay, {
        watch
  ...
  invalidate(file) {
    ...
    this.buildTimeout = setTimeout(async () => {
      this.buildTimeout = null;
      try {
        await Promise.all([...this.invalidatedIds].map(([id, event]) => this.emitter.emitAndAwait('change', id, {
          event
        })));
