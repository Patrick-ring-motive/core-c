...
export function parse(k, l = "@") {
        ...
        do {
          if ((f | 0) == 19) {
            ...
            if ((f | 0) == 36) {
              ...
              e = (s[293] | 0) == -1 & (s[292] | 0) == 0 & (i[588] | 0) == 0;
              break
            }
          }
        } while (0);
      ...
      function k() {
        ...
        e: do {
          switch ((w(1) | 0) << 16 >> 16) {
            ...
            case 46: {
              t[18] = (t[18] | 0) + 2;
              if (((w(1) | 0) << 16 >> 16 == 109 ? (e = t[18] | 0, K(e + 2 | 0, 101, 116, 97) | 0) : 0) ? (s[t[15] >> 1] | 0) != 46 : 0) v(c, c, e + 8 | 0, 2);
              break
            }
            case 42:
            case 39:
  ...
  const o = t.length + 1;
  e.ses(a), e.sa(o - 1), (s ? b : n)(t, new Uint16Array(r, a, o)), e.p() || (c = e.e(), h());
  const w = [],
    d = [];
  for (; e.ri();) {
    const r = e.is(),
      ...
      c = e.se();
    let n;
    e.ip() && (n = u(-1 === s ? r : r + 1, t.charCodeAt(-1 === s ? r - 1 : r))), w.push({
      n: n,
      s: r,
      e: a,
      ss: f,
...
function u(e, r) {
  ...
  for (;;) {
    c >= t.length && h();
    const e = t.charCodeAt(c);
    if (e === r) break;
    92 === e ? (a += t.slice(i, c), a += k(), i = c) : (8232 === e || 8233 === e || o(e) && h(), ++c)
  }
  return a += t.slice(i, c++), a
}
...
function k() {
  ...
  switch (++c, e) {
    ...
    case 117:
      return function() {
        let e;
        123 === t.charCodeAt(c) ? (++c, e = l(t.indexOf("}", c) - c), ++c, e > 1114111 && h()) : e = l(4);
    ...
    default:
      if (e >= 48 && e <= 55) {
        let r = t.substr(c - 1, 3).match(/^[0-7]+/)[0],
          a = parseInt(r, 8);
        return a > 255 && (r = r.slice(0, -1), a = parseInt(r, 8)), c += r.length - 1, e = t.charCodeAt(c), "0" === r && 56 !== e && 57 !== e || h(), String.fromCharCode(a)
      }
...
function h() {
  throw Object.assign(new Error(`Parse error ${f}:${t.slice(0,c).split("\n").length}:${c-t.lastIndexOf("\n",c-1)}`), {
    idx: c
  })
}
