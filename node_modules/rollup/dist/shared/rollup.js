...
async function loadFsEvents() {
  try {
    ({
      default: fsEvents
    } = await Promise.resolve().then(() => /*#__PURE__*/ _interopNamespaceDefault(require('fsevents'))));
  } catch (err) {
...
function renderSystemExportExpression(exportedVariable, expressionStart, expressionEnd, code, {
  exportNamesByVariable,
  snippets: {
    _
  }
...
class ExportDefaultDeclaration extends NodeBase {
  ...
  renderVariableDeclaration(code, declarationStart, {
    format,
    exportNamesByVariable,
    snippets: {
      cnst,
...
const getDefaultLiveBinding = ({
  _,
  getObject
}) => `e${_}:${_}${getObject([['default', 'e']], { lineBreakIndent: null })}`;
const getDefaultStatic = ({
  _,
  getPropertyAccess
...
const loopOverKeys = (body, allowVarLoopVariable, {
    _,
    cnst,
    getFunctionIntro,
    s
...
const loopOverNamespaces = (body, useForEach, t, {
  _,
  cnst,
  getDirectReturnFunction,
  getFunctionIntro,
...
const copyOwnPropertyLiveBinding = (t, i, {
  _,
  cnst,
  getDirectReturnFunction,
  n
...
const copyPropertyLiveBinding = (t, i, {
  _,
  cnst,
  getDirectReturnFunction,
  n
...
const copyPropertyStatic = (_t, i, {
  _,
  n
}) => `${i}n[k]${_}=${_}e[k];${n}`;
const getFrozen = (freeze, fragment) => freeze ? `Object.freeze(${fragment})` : fragment;
const getWithToStringTag = (namespaceToStringTag, fragment, {
    _,
    getObject
...
class ImportExpression extends NodeBase {
  ...
  renderFinalResolution(code, resolution, namespaceExportName, {
    getDirectReturnFunction
  }) {
  ...
  applyDeoptimizations() {}
  getDynamicImportMechanismAndHelper(resolution, exportMode, {
    compact,
...
class MetaProperty extends NodeBase {
  ...
  renderFinalMechanism(code, chunkId, format, snippets, outputPluginDriver) {
    ...
    ]) || ((_a = importMetaMechanisms[format]) === null || _a === void 0 ? void 0 : _a.call(importMetaMechanisms, metaProperty, {
      chunkId,
      snippets
    }));
    if (typeof replacement === 'string') {
...
const getGenericImportMetaMechanism = (getUrl) => (prop, {
  chunkId
}) => {
    ...
    this.info = {
      ...
      get importedIds() {
        ...
        return Array.from(sources, source => {
          var _a;
          return (_a = module.resolvedIds[source]) === null || _a === void 0 ? void 0 : _a.id;
        }).filter(Boolean);
      },
      get importers() {
        return importers.sort();
...
function getNamespaceMarkers(hasNamedExports, addEsModule, addNamespaceToStringTag, {
  _,
  getObject
}) {
  if (hasNamedExports) {
...
const getDefineProperty = (name, needsLiveBinding, t, {
  _,
  getDirectReturnFunction,
  n
}) => {
...
function getImportBlock$1(dependencies, {
  _,
  cnst,
  n
}, compact) {
...
function setupNamespace(name, root, globals, {
  _,
  getPropertyAccess,
  s
}, compact) {
...
function assignToDeepVariable(deepName, root, globals, assignment, {
  _,
  getPropertyAccess
}) {
...
function system(magicString, {
  ...
  const wrapperParams = accessedGlobals.has('module') ? ['exports', 'module'] :
    hasExports ? ['exports'] : [];
  // factory function should be wrapped by parentheses to avoid lazy parsing,
  // cf. https://v8.dev/blog/preparser#pife
...
function analyzeDependencies(dependencies, exports, t, {
  _,
  cnst,
  getObject,
  getPropertyAccess,
...
const getStarExcludesBlock = (starExcludes, t, {
    _,
    cnst,
    getObject,
    n
  ...
  '';
const getImportBindingsBlock = (importBindings, t, {
  _,
  n
...
function getExportsBlock(exports, t, {
  _,
  n
}) {
  if (exports.length === 0) {
...
function safeAccess(name, globalVar, {
  _,
  getPropertyAccess
}) {
...
function deconflictImportsOther(usedNames, imports, {
  deconflictedDefault,
...
function getExportMode(chunk, {
  ...
  name,
  format
}, unsetOptions, facadeModuleId, warn) {
...
class Chunk {
  ...
  generateFacades() {
    ...
    for (const module of entryModules) {
      const requiredFacades = Array.from(new Set(module.chunkNames.filter(({
          isUserDefined
        }) => isUserDefined).map(({
          name
        }) => name)),
  ...
  generateId(addons, options, bundle, includeHash) {
    ...
    return makeUnique(renderNamePattern(typeof pattern === 'function' ? pattern(this.getChunkInfo()) : pattern, patternName, {
      ...
      hash: () => includeHash ?
        this.computeContentHashWithDependencies(addons, options, bundle) : '[hash]',
...
function getChunkNameFromModule(module) {
  var _a, _b, _c, _d;
  return ((_d = (_b = (_a = module.chunkNames.find(({
    isUserDefined
  }) => isUserDefined)) === null || _a === void 0 ? void 0 : _a.name) !== null && _b !== void 0 ? _b : (_c = module.chunkNames[0]) === null || _c === void 0 ? void 0 : _c.name) !== null && _d !== void 0 ? _d : getAliasName(module.id));
}
...
function getGenerateCodeSnippets({
  ...
  const getNonArrowFunctionIntro = (params, {
    isAsync,
    name
  ...
  const getFunctionIntro = arrowFunctions ?
    ...
    getNonArrowFunctionIntro;
  const getDirectReturnFunction = (params, {
    functionReturn,
    lineBreakIndent,
    name
  }) => [
  ...
  return {
    ...
    cnst,
    getDirectReturnFunction,
    getDirectReturnIifeLeft: (params, returned, {
  ...
  async generateChunks() {
    ...
    for (const {
      ...
      of this.outputOptions.inlineDynamicImports ? [{
        alias: null,
        modules: getIncludedModules(this.graph.modulesById)
      }] :
      this.outputOptions.preserveModules ?
...
function resolveIdViaPlugins(source, importer, pluginDriver, moduleLoaderResolveId, skip, customOptions, isEntry) {
  ...
  if (skip) {
    ...
    replaceContext = (pluginContext, plugin) => ({
      ...
      resolve: (source, importer, {
        ...
        return moduleLoaderResolveId(source, importer, custom, isEntry, skipSelf ? [...skip, {
          importer,
          plugin,
          source
        }] : skip);
  ...
  return pluginDriver.hookFirst('resolveId', [source, importer, {
...
async function transform(source, module, pluginDriver, warn) {
  ...
  try {
    code = await pluginDriver.hookReduceArg0('transform', [curSource, id], transformReducer, (pluginContext, plugin) => {
      ...
      return {
        ...
        cache: customTransformCache ?
          pluginContext.cache : getTrackedPluginCache(pluginContext.cache, useCustomTransformCache),
    ...
    throwPluginError(err, pluginName, {
      hook: 'transform',
      id
    });
  }
...
class ModuleLoader {
  ...
  async addEntryModules(unresolvedEntryModules, isUserDefined) {
    ...
    const newEntryModules = await this.extendLoadModulesPromise(Promise.all(unresolvedEntryModules.map(({
      id,
      importer
    }) => this.loadEntryModule(id, true, importer, null))).then(entryModules => {
  ...
  async addModuleSource(id, importer, module) {
    ...
    try {
      source = await this.graph.fileOperationQueue.run(async () => {
        var _a;
        return (_a = (await this.pluginDriver.hookFirst('load', [id]))) !== null && _a !== void 0 ? _a : (await require$$0$1.promises.readFile(id, 'utf8'));
      });
    } catch (err) {
    ...
    if (resolveIdResult) {
      ...
      return {
        ...
        id: external && makeAbsoluteExternalsRelative ?
          normalizeRelativeExternalId(resolveIdResult, importer) : resolveIdResult
      };
    }
...
function addChunkNamesToModule(module, {
  fileName,
  name
}, isUserDefined, priority) {
  var _a;
  if (fileName !== null) {
  ...
  constructor(graph, options, baseFileEmitter) {
    ...
    this.setOutputBundle = (bundle, outputOptions, facadeChunkByModule) => {
      ...
      for (const {
        ...
        of this.filesByReferenceId.values()) {
        if (fileName) {
...
function getPluginContext(plugin, pluginCache, graph, options, fileEmitter, existingPluginNames) {
  ...
  return {
    ...
    emitAsset: getDeprecatedContextHandler((name, source) => fileEmitter.emitFile({
      ...
      source,
      type: 'asset'
    }), 'emitAsset', 'emitFile', plugin.name, true, options),
    emitChunk: getDeprecatedContextHandler((id, options) => fileEmitter.emitFile({
      id,
      name: options && options.name,
      type: 'chunk'
    }), 'emitChunk', 'emitFile', plugin.name, true, options),
    ...
    resolve(source, importer, {
      ...
      return graph.moduleLoader.resolveId(source, importer, custom, isEntry, skipSelf ? [{
        importer,
        plugin,
        source
      }] : null);
...
const getTreeshake = (config, warn, strictDeprecations) => {
  ...
  return {
    ...
    moduleSideEffects: typeof configTreeshake === 'object' && configTreeshake.pureExternalModules ?
      getHasModuleSideEffects(configTreeshake.moduleSideEffects, configTreeshake.pureExternalModules) : getHasModuleSideEffects(configWithPreset.moduleSideEffects, undefined),
    propertyReadSideEffects: configWithPreset.propertyReadSideEffects === 'always' ?
      'always' : configWithPreset.propertyReadSideEffects !== false,
...
function normalizeOutputOptions(config, inputOptions, unsetInputOptions) {
  ...
  const outputOptions = {
    ...
    sanitizeFileName: typeof config.sanitizeFileName === 'function' ?
      config.sanitizeFileName : config.sanitizeFileName === false ?
      id => id : sanitizeFileName,
...
async function getInputOptions(rawInputOptions, watchMode) {
  ...
  const {
    options,
    unsetOptions
  } = normalizeInputOptions(await rawPlugins.reduce(applyOptionHook(watchMode), Promise.resolve(rawInputOptions)));
...
function handleGenerateWrite(isWrite, inputOptions, unsetInputOptions, rawOutputOptions, graph) {
  const {
    ...
    outputPluginDriver,
    unsetOptions
  } = getOutputOptionsAndPluginDriver(rawOutputOptions, graph.pluginDriver, inputOptions, unsetInputOptions);
