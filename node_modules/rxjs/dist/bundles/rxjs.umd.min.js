...
*****************************************************************************/
(function(g, y) {
  "object" === typeof exports && "undefined" !== typeof module ? y(exports) : "function" === typeof define && define.amd ? define("rxjs", ["exports"], y) : y(g.rxjs = {})
})(this, function(g) {
  function y(b, a) {
    function c() {
      this.constructor = b
  ...
  function Da(b) {
    T.useDeprecatedSynchronousErrorHandling ? T.useDeprecatedSynchronousErrorHandling && V && (V.errorThrown = !0, V.error = b) : Jb(b)
  }
  ...
  function Tb(b, a) {
    return new t(function(c) {
      ...
      return function() {
        return p(null === d || void 0 === d ? void 0 : d.return) &&
          d.return()
      }
    })
  }
  ...
  function Vb(b, a) {
    if (null != b) {
      ...
      if (p(null === b || void 0 === b ? void 0 : b.getReader)) return Ub(Rb(b),
        a)
    }
    throw Pb(b);
  }
  ...
  function Yb(b) {
    if (1 === b.length) {
      ...
      if (a && "object" === typeof a && oe(a) === pe) return b = qe(a), {
  ...
  function gb(b, a, c, d, e, f, h, l) {
    var k = [],
      ...
      n = function(b) {
        ...
        g++;
        var l = !1;
        q(c(b, r++)).subscribe(m(a, function(c) {
  ...
  function hb(b, a, c, d) {
    ...
    d = x(re(b) ? se.map(function(d) {
      return function(e) {
        return b[d](a, e, c)
      }
    }) : te(b) ? ue.map(cc(b, a)) : ve(b) ? we.map(cc(b, a)) : [], 2);
    var e = d[0],
      f = d[1];
    if (!e && bb(b)) return H(function(b) {
      return hb(b, a, c)
    })(q(b));
  ...
  function dc(b, a, c) {
    return c ? dc(b, a).pipe(X(c)) : new t(function(c) {
      var d = function() {
  ...
  function hc(b) {
    return function(a) {
      for (var c = [], d = function(d) {
          c.push(q(b[d]).subscribe(m(a, function(b) {
            if (c) {
  ...
  function jb() {
    ...
    var c = pa(b),
      d = aa(b);
    return d.length ? new t(function(a) {
      ...
      for (var l = function(f) {
          q(d[f]).subscribe(m(a, function(d) {
            b[f].push(d);
            b.every(function(a) {
              return a.length
            }) && (d = b.map(function(a) {
              return a.shift()
            }), a.next(c ? c.apply(void 0, z([], x(d))) : d), b.some(function(a, c) {
              return !a.length && e[c]
            }) && a.complete())
          }, function() {
            e[f] = !0;
  ...
  function mc(b, a) {
    return n(function(c, d) {
      var e = [];
      q(b).subscribe(m(d, function(c) {
        var b = [];
        e.push(b);
        var f = new D;
        f.add(q(a(c)).subscribe(m(d, function() {
          M(e, b);
          d.next(b);
          f.unsubscribe()
        }, C)))
  ...
  function nb() {
    for (var b = [], a = 0; a < arguments.length; a++) b[a] = arguments[a];
    return (a = pa(b)) ? Xa(nb.apply(void 0, z([], x(b))), X(a)) : n(function(a, d) {
      ac(z([a], x(aa(b))))(d)
    })
  }
  ...
  function Bc(b, a) {
    ...
    return function(d) {
      return d.pipe(K(function(a, c) {
        return c === b
      }), ha(1), c ? va(a) : wa(function() {
        return new rb
      }))
    }
  }
  ...
  function Oa(b, a) {
    return a ? function(c) {
      return c.pipe(Oa(function(c, e) {
        return q(b(c, e)).pipe(Q(function(b, d) {
          return a(c, b, e, d)
        }))
      }))
    } : n(function(a, d) {
  ...
  function Jc(b, a) {
    var c = 2 <= arguments.length;
    return function(d) {
      return d.pipe(b ? K(function(a, c) {
        return b(a, c, d)
      }) : E, ha(1), c ? va(a) : wa(function() {
        return new ba
      }))
    }
  }
  ...
  function bd(b) {
    ...
    return 0 >= c ? function() {
      ...
      var e = 0,
        ...
        g = function() {
          var d = !1;
          f = a.subscribe(m(b, void 0, function() {
  ...
  function cd(b) {
    return n(function(a, c) {
      var d, e = !1,
        ...
        l = !1,
        k = function() {
          f || (f = new B, q(b(f)).subscribe(m(c, function() {
            d ? g() : e = !0
          }, function() {
            h = !0;
            l && h && c.complete()
  ...
  function id(b, a, c) {
    var d, e;
    d = !1;
    b && "object" === typeof b ? (d = b.bufferSize, e = void 0 === d ? Infinity : d, d = b.windowTime, a = void 0 === d ? Infinity : d, d = b.refCount, d = void 0 === d ? !1 : d, c = b.scheduler) :
  ...
  function ka(b, a) {
    return n(function(c, d) {
      ...
      c.subscribe(m(d, function(c) {
        ...
        var l = 0,
          g = f++;
        q(b(c, g)).subscribe(e = m(d, function(b) {
  ...
  function Ld(b, a) {
    for (var c = 0, d = a.length; c < d; c++)
      for (var e =
          a[c], f = Object.getOwnPropertyNames(e.prototype), h = 0, g = f.length; h < g; h++) {
        var k = f[h];
  ...
  function Oe(b) {
    return new t(function(a) {
      ...
      var A = e.xsrfCookieName,
        g = e.xsrfHeaderName;
      (e.withCredentials || !n) && A && g && (n = null !== (d = null === (c = null === document || void 0 === document ? void 0 : document.cookie.match(new RegExp("(^|;\\s*)(" + A + ")\x3d([^;]*)"))) ||
        void 0 === c ? void 0 : c.pop()) && void 0 !== d ? d : "") && (f[g] = n);
      c = Pe(h, f);
      var q = U(U({}, e), {
          url: k,
          headers: f,
      ...
      u.addEventListener("error", function(a) {
        var c;
        null === (c =
          null === p || void 0 === p ? void 0 : p.error) || void 0 === c ? void 0 : c.call(p, a);
        x()
      });
  ...
  function Pe(b, a) {
    var c;
    if (!b || "string" === typeof b || "undefined" !== typeof FormData && b instanceof FormData || "undefined" !== typeof URLSearchParams && b instanceof URLSearchParams || Bb(b, "ArrayBuffer") || Bb(b, "File") || Bb(b, "Blob") || "undefined" !== typeof ReadableStream && b instanceof ReadableStream) return b;
  ...
  var Ua = function(b, a) {
            ...
            try {
              for (var m = F(a), r = m.next(); !r.done; r = m.next()) {
                ...
                try {
                  ...
                  f = null !== f && void 0 !== f ? f : [], A instanceof Ta ? f = z(z([], x(f)), x(A.errors)) : f.push(A)
                }
              }
            } catch (A) {
              b = {
    ...
    ja = function(b) {
      function a(a, d, e) {
        ...
        p(a) || !a ? a = {
          ...
          } : c && T.useDeprecatedNextContext &&
          (d = Object.create(a), d.unsubscribe = function() {
    ...
    t = function() {
      ...
      b.prototype._subscribe = function(a) {
        var c;
        return null === (c =
          this.source) || void 0 === c ? void 0 : c.subscribe(a)
      };
    ...
    B = function(b) {
      ...
      Object.defineProperty(a.prototype, "observed", {
        get: function() {
          var a;
          return 0 < (null === (a = this.observers) || void 0 === a ?
            void 0 : a.length)
        },
        enumerable: !1,
        configurable: !0
    ...
    Db = function(b) {
      ...
      a.prototype.error = function(a) {
        var b, c;
        null === (c =
          null === (b = this.destination) || void 0 === b ? void 0 : b.error) || void 0 === c ? void 0 : c.call(b, a)
      };
      a.prototype.complete = function() {
        var a, b;
      ...
      a.prototype._subscribe = function(a) {
        var b, c;
        return null !== (c = null === (b = this.source) || void 0 === b ? void 0 : b.subscribe(a)) && void 0 !== c ? c : Qd
      };
      return a
    }(B),
    Zc = function(b) {
    ...
    fb = function(b) {
      ...
      a.prototype.complete = function() {
        var a = this._hasValue,
          d = this._value;
        this._isComplete || (this._isComplete = !0, a && b.prototype.next.call(this,
          d), b.prototype.complete.call(this))
      };
      return a
    }(B),
    ma = {
    ...
    za = function(b) {
      ...
      a.prototype.recycleAsyncId = function(a, b, e) {
        void 0 === e && (e = 0);
        if (null != e && this.delay ===
          e && !1 === this.pending) return b;
    ...
    Sd = new(function(b) {
      ...
      a.prototype.flush = function(a) {
        ...
        a = a || c.shift();
        do
          if (f = a.execute(a.state, a.delay)) break; while ((a = c[0]) && a.id === b && c.shift());
        this._active = !1;
        if (f) {
          for (;
    ...
    $e = function(b) {
      ...
      a.prototype.requestAsyncId = function(a, d, e) {
        ...
        if (null !== e && 0 < e) return b.prototype.requestAsyncId.call(this, a, d, e);
        a.actions.push(this);
        return a._scheduled || (a._scheduled = N.requestAnimationFrame(function() {
      ...
      a.prototype.recycleAsyncId = function(a, d, e) {
        var c;
        void 0 === e && (e = 0);
        if (null != e ? 0 < e : 0 < this.delay) return b.prototype.recycleAsyncId.call(this,
          a, d, e);
        e = a.actions;
        null != d && (null === (c = e[e.length - 1]) || void 0 === c ? void 0 : c.id) !== d && (N.cancelAnimationFrame(d), a._scheduled = void 0)
      };
      return a
    }(za),
    Ud = new(function(b) {
  ...
  var Qa = function() {
      ...
      b.prototype.do = function(a, b, d) {
        var c = this.kind,
          f = this.value,
          g = this.error;
        return "N" === c ? null === a || void 0 === a ? void 0 : a(f) : "E" === c ? null === b || void 0 === b ? void 0 : b(g) : null === d || void 0 === d ? void 0 : d()
      };
      b.prototype.accept = function(a, b, d) {
        return p(null === a || void 0 === a ? void 0 : a.next) ? this.observe(a) : this.do(a, b, d)
      };
      b.prototype.toObservable =
        function() {
          var a = this.kind,
            b = this.value,
            d = this.error,
            b = "N" === a ? cb(b) : "E" === a ? Wb(function() {
              return d
            }) : "C" === a ? L : 0;
  ...
  var cf = function(b) {
        ...
        var a = this,
          ...
          f = function() {
            ...
            if (0 < d.length) d = d[0], c = d.handle, d = d.handler, e.delete(c), d();
              ...
              }), 0 < c.length) d = c[0], c = d.handle, d = d.handler, e.delete(c), d();
      ...
      a.prototype.run = function(b) {
        ...
        try {
          ...
          a.frameTimeFactor = c, this.maxFrames = e, this.runMode = !1, N.delegate = void 0, la.delegate = void 0, na.delegate = void 0, ma.delegate = void 0, ea.delegate = void 0, Ea.delegate = void 0
        }
      };
      a.frameTimeFactor =
        10;
      ...
      fromFetch: function(b, a) {
        ...
        return new t(function(a) {
          ...
          fetch(b, p).then(function(b) {
            c ? q(c(b)).subscribe(m(a, void 0, function() {
              l = !1;
              a.complete()
            }, t)) : (l = !1, a.next(b),
              a.complete())
      ...
      b = new t(function(a) {
        ...
        if (b)
          for (var e = Array(b), g = b, k = b, n = function(b) {
              var f = !1;
              q(c[b]).subscribe(m(a, function(a) {
                  f || (f = !0, k--);
                  e[b] = a
                }, function() {
                  return g--
  ...
  g.generate = function(b, a, c, d, e) {
    ...
    var g, l, k;
    1 === arguments.length ? (k = b.initialState, a = b.condition, c = b.iterate, g = b.resultSelector, l = void 0 ===
      g ? E : g, e = b.scheduler) : (k = b, !d || Fa(d) ? (l = E, e = d) : l = d);
